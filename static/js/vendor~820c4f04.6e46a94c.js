/*! For license information please see vendor~820c4f04.6e46a94c.js.LICENSE.txt */
(self.webpackChunk_synfutures_v3_app =
  self.webpackChunk_synfutures_v3_app || []).push([
  [717],
  {
    90662: function (t, r, e) {
      var n;
      function o(t) {
        this.rand = t;
      }
      if (
        ((t.exports = function (t) {
          return n || (n = new o(null)), n.generate(t);
        }),
        (t.exports.Rand = o),
    ...
    18323: function (t, r, e) {
      var n = e(8901).Buffer;
      t.exports = function (t) {
        for (var r = new n(t.length), e = 0, o = t.length - 1; e <= o; ++e, --o)
          (r[e] = t[o]), (r[o] = t[e]);
        return r;
      };
    },
    8901: function (t, r, e) {
      ...
      function y(t, r, e) {
        ...
        if (null != n && n !== t) return l.from(n, r, e);
        var o = (function (t) {
          if (l.isBuffer(t)) {
            var r = 0 | b(t.length),
              e = c(r);
          ...
          if (void 0 !== t.length)
            return "number" !== typeof t.length || rt(t.length) ? c(0) : d(t);
        ...
        if (
          ...
          return l.from(t[Symbol.toPrimitive]("string"), r, e);
        throw new TypeError(
          "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
            typeof t
        );
      ...
      function w(t) {
        return g(t), c(t < 0 ? 0 : 0 | b(t));
      }
      function d(t) {
        for (
          var r = t.length < 0 ? 0 : 0 | b(t.length), e = c(r), n = 0;
          n < r;
          n += 1
        )
          e[n] = 255 & t[n];
      ...
      function I(t, r, e, n, o) {
        ...
        if (("string" === typeof r && (r = l.from(r, n)), l.isBuffer(r)))
          return 0 === r.length ? -1 : U(t, r, e, n, o);
        if ("number" === typeof r)
          return (
            (r &= 255),
      ...
      function M(t, r, e) {
        ...
        return (function (t) {
          ...
          var e = "",
            n = 0;
          for (; n < r; )
            e += String.fromCharCode.apply(String, t.slice(n, (n += S)));
          return e;
        })(n);
      }
      (r.kMaxLength = p),
        ...
        (l.poolSize = 8192),
        (l.from = function (t, r, e) {
          return y(t, r, e);
        }),
        Object.setPrototypeOf(l.prototype, Uint8Array.prototype),
        Object.setPrototypeOf(l, Uint8Array),
        (l.alloc = function (t, r, e) {
        ...
        (l.compare = function (t, r) {
          if (
            ...
            tt(r, Uint8Array) && (r = l.from(r, r.offset, r.byteLength)),
        ...
        (l.concat = function (t, r) {
          ...
          var n = l.allocUnsafe(r),
            o = 0;
          for (e = 0; e < t.length; ++e) {
            var i = t[e];
            if (tt(i, Uint8Array))
              o + i.length > n.length
                ? (l.isBuffer(i) || (i = l.from(i)), i.copy(n, o))
        ...
        h && (l.prototype[h] = l.prototype.inspect),
        (l.prototype.compare = function (t, r, e, n, o) {
          if (
            (tt(t, Uint8Array) && (t = l.from(t, t.offset, t.byteLength)),
            !l.isBuffer(t))
          )
        ...
        (l.prototype.includes = function (t, r, e) {
          return -1 !== this.indexOf(t, r, e);
        }),
        (l.prototype.indexOf = function (t, r, e) {
          return I(this, t, r, e, !0);
        }),
        (l.prototype.lastIndexOf = function (t, r, e) {
          return I(this, t, r, e, !1);
        }),
        (l.prototype.write = function (t, r, e, n) {
      ...
      (l.prototype.slice = function (t, r) {
        ...
        (l.prototype.readBigUInt64LE = nt(function (t) {
          ...
          var r = this[t],
            e = this[t + 7];
          (void 0 !== r && void 0 !== e) || Z(t, this.length - 8);
          var n =
              r +
              this[++t] * Math.pow(2, 8) +
        ...
        (l.prototype.readIntLE = function (t, r, e) {
          (t >>>= 0), (r >>>= 0), e || N(t, r, this.length);
          for (var n = this[t], o = 1, i = 0; ++i < r && (o *= 256); )
            n += this[t + i] * o;
          return n >= (o *= 128) && (n -= Math.pow(2, 8 * r)), n;
        }),
        (l.prototype.readIntBE = function (t, r, e) {
          (t >>>= 0), (r >>>= 0), e || N(t, r, this.length);
        ...
        (l.prototype.readFloatLE = function (t, r) {
          return (
            (t >>>= 0), r || N(t, 4, this.length), a.read(this, t, !0, 23, 4)
          );
        }),
        (l.prototype.readFloatBE = function (t, r) {
          return (
            (t >>>= 0), r || N(t, 4, this.length), a.read(this, t, !1, 23, 4)
          );
        }),
        (l.prototype.readDoubleLE = function (t, r) {
          return (
            (t >>>= 0), r || N(t, 8, this.length), a.read(this, t, !0, 52, 8)
          );
        }),
        (l.prototype.readDoubleBE = function (t, r) {
          return (
            (t >>>= 0), r || N(t, 8, this.length), a.read(this, t, !1, 52, 8)
          );
        }),
        (l.prototype.writeUintLE = l.prototype.writeUIntLE =
          function (t, r, e, n) {
            ((t = +t), (r >>>= 0), (e >>>= 0), n) ||
              j(this, t, r, e, Math.pow(2, 8 * e) - 1, 0);
            var o = 1,
              i = 0;
        ...
        (l.prototype.writeIntLE = function (t, r, e, n) {
          if (((t = +t), (r >>>= 0), !n)) {
        ...
        (l.prototype.writeIntBE = function (t, r, e, n) {
          if (((t = +t), (r >>>= 0), !n)) {
            var o = Math.pow(2, 8 * e - 1);
            j(this, t, r, e, o - 1, -o);
          }
        ...
        (l.prototype.writeInt8 = function (t, r, e) {
          return (
            (t = +t),
            (r >>>= 0),
            e || j(this, t, r, 1, 127, -128),
            t < 0 && (t = 255 + t + 1),
            (this[r] = 255 & t),
            r + 1
          );
        }),
        (l.prototype.writeInt16LE = function (t, r, e) {
          return (
            (t = +t),
            (r >>>= 0),
            e || j(this, t, r, 2, 32767, -32768),
            (this[r] = 255 & t),
            (this[r + 1] = t >>> 8),
            r + 2
          );
        }),
        (l.prototype.writeInt16BE = function (t, r, e) {
          return (
            (t = +t),
            (r >>>= 0),
            e || j(this, t, r, 2, 32767, -32768),
        ...
        (l.prototype.writeInt32LE = function (t, r, e) {
          return (
            (t = +t),
            (r >>>= 0),
            e || j(this, t, r, 4, 2147483647, -2147483648),
            (this[r] = 255 & t),
            (this[r + 1] = t >>> 8),
            (this[r + 2] = t >>> 16),
            (this[r + 3] = t >>> 24),
        ...
        (l.prototype.writeInt32BE = function (t, r, e) {
          return (
            (t = +t),
            (r >>>= 0),
            e || j(this, t, r, 4, 2147483647, -2147483648),
        ...
        (l.prototype.writeFloatLE = function (t, r, e) {
          return V(this, t, r, !0, e);
        }),
        (l.prototype.writeFloatBE = function (t, r, e) {
          return V(this, t, r, !1, e);
        }),
        (l.prototype.writeDoubleLE = function (t, r, e) {
          return Y(this, t, r, !0, e);
        }),
        (l.prototype.writeDoubleBE = function (t, r, e) {
          return Y(this, t, r, !1, e);
        }),
        (l.prototype.copy = function (t, r, e, n) {
          if (!l.isBuffer(t))
        ...
        (l.prototype.fill = function (t, r, e, n) {
          if ("string" === typeof t) {
            if (
              ("string" === typeof r
          ...
          if (
            ...
            var f = l.isBuffer(t) ? t : l.from(t, n),
              u = f.length;
            if (0 === u)
              throw new TypeError(
        ...
        G[t] = (function (e) {
          ...
          function a() {
            ...
            return (
              n(this, a),
              (e = s.call(this)),
              Object.defineProperty(i(e), "message", {
                value: r.apply(i(e), arguments),
                writable: !0,
                configurable: !0,
              }),
          ...
          throw (
            ((f =
              i > 3
                ...
                : ">= ".concat(r).concat(u, " and <= ").concat(e).concat(u)),
            new G.ERR_OUT_OF_RANGE("value", f, t))
          );
        }
        !(function (t, r, e) {
          J(r, "offset"),
      ...
      function J(t, r) {
        if ("number" !== typeof t)
          throw new G.ERR_INVALID_ARG_TYPE(r, "number", t);
      }
      function Z(t, r, e) {
        if (Math.floor(t) !== t)
          throw (
            (J(t, e), new G.ERR_OUT_OF_RANGE(e || "offset", "an integer", t))
          );
        if (r < 0) throw new G.ERR_BUFFER_OUT_OF_BOUNDS();
        throw new G.ERR_OUT_OF_RANGE(
          e || "offset",
          ">= ".concat(e ? 1 : 0, " and <= ").concat(r),
          t
        );
      }
      W(
        ...
        W(
          ...
          function (t, r, e) {
            var n = 'The value of "'.concat(t, '" is out of range.'),
              o = e;
            return (
              Number.isInteger(e) && Math.abs(e) > Math.pow(2, 32)
                ? (o = X(String(e)))
                : "bigint" === typeof e &&
                  ((o = String(e)),
                  (e > Math.pow(BigInt(2), BigInt(32)) ||
                    e < -Math.pow(BigInt(2), BigInt(32))) &&
                    (o = X(o)),
                  (o += "n")),
...
//# sourceMappingURL=vendor~820c4f04.6e46a94c.js.map
