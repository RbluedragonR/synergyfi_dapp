...
function getOffset(mode, isRootLevel, isRtl, which) {
  ...
  var horizontal = _defineProperty(
    _defineProperty(
      _defineProperty(
        _defineProperty({}, LEFT, isRtl ? next : prev),
        RIGHT,
        isRtl ? prev : next
      ),
      DOWN,
  ...
  var vertical = _defineProperty(
    _defineProperty(
      _defineProperty(
        _defineProperty(
          _defineProperty(_defineProperty({}, UP, prev), DOWN, next),
          ENTER,
          children
        ),
        ESC,
  ...
  var type =
    (_offsets = offsets["".concat(mode).concat(isRootLevel ? "" : "Sub")]) ===
      null || _offsets === void 0
      ? void 0
      : _offsets[which];
  switch (type) {
    case prev:
...
export function useAccessibility(
  ...
  return function (e) {
    ...
    if ([].concat(ArrowKeys, [ENTER, ESC, HOME, END]).includes(which)) {
      ...
      if (
        ...
        rafRef.current = raf(function () {
          ...
          var targetElement = getNextFocusElement(
            subQueryContainer,
    ...
    originOnKeyDown === null ||
      originOnKeyDown === void 0 ||
      originOnKeyDown(e);
  };
}
