...
var Menu = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var _ref = props,
    ...
    subMenuOpenDelay =
      _ref$subMenuOpenDelay === void 0 ? 0.1 : _ref$subMenuOpenDelay,
    _ref$subMenuCloseDela = _ref.subMenuCloseDelay,
    subMenuCloseDelay =
      _ref$subMenuCloseDela === void 0 ? 0.1 : _ref$subMenuCloseDela,
    ...
    triggerSubMenuAction =
      _ref$triggerSubMenuAc === void 0 ? "hover" : _ref$triggerSubMenuAc,
    builtinPlacements = _ref.builtinPlacements,
    itemIcon = _ref.itemIcon,
    expandIcon = _ref.expandIcon,
    _ref$overflowedIndica = _ref.overflowedIndicator,
    overflowedIndicator =
      _ref$overflowedIndica === void 0 ? "..." : _ref$overflowedIndica,
  ...
  var registerPathContext = React.useMemo(
    function () {
      return {
  ...
  var pathUserContext = React.useMemo(
    function () {
      return {
  ...
  var _useMergedState3 = useMergedState(
      activeKey ||
        (defaultActiveFirst &&
          ((_childList$ = childList[0]) === null || _childList$ === void 0
            ? void 0
            : _childList$.key)),
      {
        value: activeKey,
    ...
    return {
      ...
      focus: function focus(options) {
        ...
        if (shouldFocusKey && elementToFocus) {
          ...
          elementToFocus === null ||
            elementToFocus === void 0 ||
            (_elementToFocus$focus = elementToFocus.focus) === null ||
            _elementToFocus$focus === void 0 ||
            _elementToFocus$focus.call(elementToFocus, options);
        }
      },
    };
  });
  ...
  var triggerAccessibilityOpen = function triggerAccessibilityOpen(key, open) {
    var nextOpen =
      open !== null && open !== void 0 ? open : !mergedOpenKeys.includes(key);
    ...
    _extends(
      {
        ...
        className: classNames(
          ...
          "".concat(prefixCls, "-").concat(internalMode),
          className,
          _defineProperty(
            _defineProperty(
              {},
