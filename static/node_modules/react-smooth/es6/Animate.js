    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        if (!isActive) {
          var newState = {
            style: attributeName
              ? _defineProperty({}, attributeName, this.props.to)
              : this.props.to,
          };
        ...
        if (this.state && this.state.style) {
          var _newState = {
            style: attributeName
              ? _defineProperty({}, attributeName, from)
              : from,
          };
          if (
    ...
    },
    {
      ...
      value: function runStepAnimation(props) {
        ...
        var addStyle = function addStyle(sequence, nextItem, index) {
          ...
          return []
            .concat(_toConsumableArray(sequence), [
              newStyle,
              duration,
              onAnimationEnd,
            ])
    ...
    },
    {
      ...
      value: function runAnimation(props) {
        ...
        var to = attributeName
          ? _defineProperty({}, attributeName, propsTo)
          : propsTo;
