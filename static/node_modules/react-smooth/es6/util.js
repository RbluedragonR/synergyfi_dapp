  ...
  return PREFIX_LIST.reduce(function (result, property, i) {
    if (isTransition) {
      styleVal = value.replace(
        ...
        "".concat(IN_LINE_PREFIX_LIST[i], "$1")
      );
    }
    return _objectSpread(
      _objectSpread({}, result),
      {},
      _defineProperty({}, property + camelName, styleVal)
    );
  }, {});
};
...
export var debugf = function debugf(tag, f) {
  return function () {
    ...
    log(
      "".concat(name, ": ").concat(argNames, " => ").concat(JSON.stringify(res))
    );
    return res;
  };
};
...
export var getTransitionVal = function getTransitionVal(
  props,
  duration,
  easing
) {
