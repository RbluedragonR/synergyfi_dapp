...
class CoinbaseWalletProvider extends eventemitter3_1.default {
  constructor(_a) {
    ...
    this.handlers = {
      ...
      handshake: async (_) => {
        try {
          if (this.connected) {
            this.emit("connect", {
              chainId: (0, util_1.hexStringFromIntNumber)(
                (0, type_1.IntNumber)(this.chain.id)
              ),
            });
      ...
      state: (request) => {
        ...
        switch (request.method) {
          case "eth_chainId":
            return (0, util_1.hexStringFromIntNumber)(
              (0, type_1.IntNumber)(this.chain.id)
            );
          case "net_version":
      ...
      deprecated: ({ method }) => {
        throw error_1.standardErrors.rpc.methodNotSupported(
    ...
    this.updateListener = {
      ...
      onChainUpdate: ({ chain, source }) => {
        ...
        this.emit(
          "chainChanged",
          (0, util_1.hexStringFromIntNumber)((0, type_1.IntNumber)(chain.id))
        );
      },
    };
    ...
    this.chain = {
      id:
        (_c =
          (_b = metadata.appChainIds) === null || _b === void 0
            ? void 0
            : _b[0]) !== null && _c !== void 0
          ? _c
          : 1,
  ...
  async request(args) {
    var _a;
    try {
      const invalidArgsError = (0, provider_1.checkErrorForInvalidRequestArgs)(
        args
      );
      if (invalidArgsError) throw invalidArgsError;
      // unrecognized methods are treated as fetch requests
      const category =
        (_a = (0, method_1.determineMethodCategory)(args.method)) !== null &&
        _a !== void 0
          ? _a
          : "fetch";
      ...
      return Promise.reject(
        (0, serialize_1.serializeError)(error, args.method)
      );
    }
  }
  ...
  async disconnect() {
    ...
    this.emit(
      "disconnect",
      error_1.standardErrors.provider.disconnected(
