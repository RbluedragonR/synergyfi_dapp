...
class SCWSigner {
  ...
  async handshake() {
    ...
    const peerPublicKey = await (0, cipher_1.importKeyFromHexString)(
      "public",
      response.sender
    );
  ...
  tryLocalHandling(request) {
    ...
    switch (request.method) {
      case "wallet_switchEthereumChain": {
        ...
        if (
          !params ||
          !((_a = params[0]) === null || _a === void 0 ? void 0 : _a.chainId)
        ) {
  ...
  async createRequestMessage(content) {
    const publicKey = await (0, cipher_1.exportKeyToHexString)(
      "public",
  ...
  updateInternalState(request, response) {
    ...
    const availableChains =
      (_a = response.data) === null || _a === void 0 ? void 0 : _a.chains;
    if (availableChains) {
      this.stateManager.updateAvailableChains(availableChains);
    }
    const walletCapabilities =
      (_b = response.data) === null || _b === void 0 ? void 0 : _b.capabilities;
    if (walletCapabilities) {
