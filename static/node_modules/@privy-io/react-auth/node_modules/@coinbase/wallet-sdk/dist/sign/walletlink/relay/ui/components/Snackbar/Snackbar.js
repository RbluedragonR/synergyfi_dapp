...
exports.SnackbarInstance =
  exports.SnackbarContainer =
  exports.Snackbar =
    void 0;
      ...
      (0, preact_1.h)(
        ...
        (0, preact_1.h)(
          ...
          Array.from(this.items.entries()).map(([key, itemProps]) =>
            (0, preact_1.h)(
              exports.SnackbarInstance,
              Object.assign({}, itemProps, { key: key })
            )
          )
        )
      ),
...
const SnackbarInstance = ({ autoExpand, message, menuItems }) => {
  ...
  const [expanded, setExpanded] = (0, hooks_1.useState)(
    autoExpand !== null && autoExpand !== void 0 ? autoExpand : false
  );
  (0, hooks_1.useEffect)(() => {
    const timers = [
      window.setTimeout(() => {
