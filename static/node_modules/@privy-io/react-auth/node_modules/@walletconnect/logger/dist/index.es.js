...
class L {
  constructor(e, t = l) {
    (this.level = e ?? "error"),
      (this.levelValue = s.values[this.level]),
  ...
  appendToLogs(e) {
    this.logs.append(u({ timestamp: new Date().toISOString(), log: e }));
  ...
  logsToBlob(e) {
    ...
    return (
      t.push(u({ extraMetadata: e })), new Blob(t, { type: "application/json" })
    );
  }
}
class m {
...
function I(r) {
  ...
  return {
    logger: h(g(i({}, r.opts), { level: "trace" }), t),
...
export {
  l as MAX_LOG_SIZE_IN_BYTES_DEFAULT,
  n as PINO_CUSTOM_CONTEXT_KEY,
  c as PINO_LOGGER_DEFAULTS,
  w as formatChildLoggerContext,
  E as generateChildLogger,
  C as generateClientLogger,
  A as generatePlatformLogger,
  I as generateServerLogger,
  v as getBrowserLoggerContext,
  k as getDefaultLoggerOptions,
  y as getLoggerContext,
  U as pino,
  b as setBrowserLoggerContext,
};
