import {
  RELAYER_DEFAULT_PROTOCOL as st,
  RELAYER_EVENTS as Pe,
  VERIFY_SERVER as it,
  EXPIRER_EVENTS as rt,
  PAIRING_EVENTS as ve,
  Store as G,
  Core as nt,
} from "@walletconnect/core";
import {
  pino as ot,
  getDefaultLoggerOptions as at,
  generateChildLogger as ct,
  getLoggerContext as lt,
} from "@walletconnect/logger";
import { IEngine as ht, ISignClient as pt } from "@walletconnect/types";
import {
  getInternalError as l,
  calcExpiry as N,
  createDelayedPromise as k,
  engineEvent as g,
  getSdkError as I,
  getDeepLink as dt,
  handleDeeplinkRedirect as ut,
  isSessionCompatible as gt,
  hashKey as ue,
  parseChainId as ge,
  createEncodedRecap as wt,
  getRecapFromResources as we,
  mergeEncodedRecaps as yt,
  validateSignedCacao as Oe,
  getNamespacedDidChainId as Te,
  getDidAddress as Ae,
  getMethodsFromRecap as xe,
  getChainsFromRecap as De,
  buildNamespacesFromAuth as Ce,
  formatMessage as mt,
  isBrowser as Rt,
  hashMessage as te,
  isExpired as j,
  ...
  isValidRelays as Et,
  isValidObject as Ve,
  isValidRequiredNamespaces as St,
  isValidNamespaces as ye,
  isConformingNamespaces as be,
  isValidString as C,
  isValidErrorReason as _t,
  isValidRelay as ft,
  isValidController as It,
  isValidNamespacesChainId as Me,
  isValidRequest as qt,
  isValidNamespacesRequest as Nt,
  isValidRequestExpiry as Pt,
  isValidResponse as vt,
  isValidEvent as Ot,
  isValidNamespacesEvent as Tt,
  parseExpirerTarget as At,
  isValidId as xt,
  TYPE_1 as me,
  getAppMetadata as Dt,
} from "@walletconnect/utils";
import Ct, { EventEmitter as Vt } from "events";
import {
  THIRTY_DAYS as bt,
  SEVEN_DAYS as $e,
  FIVE_MINUTES as q,
...
import {
  ...
  isJsonRpcError as M,
  formatJsonRpcRequest as Re,
  formatJsonRpcResult as $t,
  formatJsonRpcError as Lt,
  isJsonRpcRequest as Kt,
  isJsonRpcResponse as Ut,
...
const Ee = "wc",
  ...
  R = {
    wc_sessionPropose: {
      req: { ttl: q, prompt: !0, tag: 1100 },
      res: { ttl: q, prompt: !1, tag: 1101 },
      reject: { ttl: q, prompt: !1, tag: 1120 },
      autoReject: { ttl: q, prompt: !1, tag: 1121 },
    },
    wc_sessionSettle: {
      req: { ttl: q, prompt: !1, tag: 1102 },
      res: { ttl: q, prompt: !1, tag: 1103 },
    },
    wc_sessionUpdate: {
      req: { ttl: V, prompt: !1, tag: 1104 },
      res: { ttl: V, prompt: !1, tag: 1105 },
    },
    wc_sessionExtend: {
      req: { ttl: V, prompt: !1, tag: 1106 },
      res: { ttl: V, prompt: !1, tag: 1107 },
    },
    wc_sessionRequest: {
      req: { ttl: q, prompt: !0, tag: 1108 },
      res: { ttl: q, prompt: !1, tag: 1109 },
    },
    wc_sessionEvent: {
      req: { ttl: q, prompt: !0, tag: 1110 },
      res: { ttl: q, prompt: !1, tag: 1111 },
    },
    wc_sessionDelete: {
      req: { ttl: V, prompt: !1, tag: 1112 },
      res: { ttl: V, prompt: !1, tag: 1113 },
    },
    wc_sessionPing: {
      req: { ttl: V, prompt: !1, tag: 1114 },
      res: { ttl: V, prompt: !1, tag: 1115 },
    },
    wc_sessionAuthenticate: {
      req: { ttl: Le, prompt: !0, tag: 1116 },
      res: { ttl: Le, prompt: !1, tag: 1117 },
      reject: { ttl: q, prompt: !1, tag: 1118 },
      autoReject: { ttl: q, prompt: !1, tag: 1119 },
    },
  },
  ne = { min: q, max: $e },
  D = { idle: "IDLE", active: "ACTIVE" },
  Fe = "request",
  Qe = [
    "wc_sessionPropose",
    "wc_sessionRequest",
...
var Yt = Object.defineProperty,
  ...
  We = (E, n, t) =>
    n in E
      ? Yt(E, n, { enumerable: !0, configurable: !0, writable: !0, value: t })
      : (E[n] = t),
  m = (E, n) => {
...
class Zt extends ht {
  constructor(n) {
    super(n),
      ...
      (this.events = new Ct()),
      (this.initialized = !1),
      (this.requestQueue = { state: D.idle, queue: [] }),
      (this.sessionRequestQueue = { state: D.idle, queue: [] }),
      (this.requestQueueDelay = Mt),
      ...
      (this.init = async () => {
        this.initialized ||
          ...
          this.client.core.pairing.register({ methods: Object.keys(R) }),
          (this.initialized = !0),
          setTimeout(() => {
      ...
      (this.connect = async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(`connect() -> pairing.get(${c}) failed`),
            v)
          );
        }
        if (!c || !d) {
        ...
        const u = await this.client.core.crypto.generateKeyPair(),
          ...
          { reject: S, resolve: T, done: _ } = k(p, Ge);
        this.events.once(
          g("session_connect"),
          async ({ error: v, session: O }) => {
            if (v) S(v);
            else if (O) {
              O.self.publicKey = u;
              const Q = L(m({}, O), {
              ...
              await this.client.session.set(O.topic, Q),
                await this.setExpiry(O.topic, O.expiry),
                c &&
        ...
        return (
          await this.setProposal(P, m({ id: P }, y)), { uri: h, approval: _ }
        );
      }),
      (this.pair = async (t) => {
        await this.isInitialized();
      ...
      (this.approve = async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(`approve() -> proposal.get(${e}) failed`),
            _)
          );
        }
        const {
          ...
          w = h.publicKey,
          y = await this.client.core.crypto.generateSharedKey(p, w),
          S = m(
            m(
              {
        ...
        await this.client.session.set(y, T);
        try {
          await this.sendResult({
            id: e,
            topic: c,
            result: { relay: { protocol: s ?? "irn" }, responderPublicKey: p },
            throwOnFailedPublish: !0,
          }),
          ...
          throw (
            ...
            this.client.session.delete(y, I("USER_DISCONNECTED")),
        ...
        return (
          ...
          await this.client.core.pairing.activate({ topic: c }),
          await this.setExpiry(y, N($)),
          {
            topic: y,
            acknowledged: () =>
              new Promise((_) =>
                setTimeout(() => _(this.client.session.get(y)), 500)
              ),
          }
        );
      }),
      (this.reject = async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error("reject() -> isValidReject() failed"), r)
          );
        }
        ...
        try {
          ...
          throw (
            (this.client.logger.error(`reject() -> proposal.get(${e}) failed`),
            r)
          );
        }
        i &&
      ...
      (this.update = async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error("update() -> isValidUpdate() failed"), d)
          );
        }
        const { topic: e, namespaces: s } = t,
          { done: i, resolve: r, reject: o } = k(),
          a = F(),
          c = se().toString(),
          h = this.client.session.get(e).namespaces;
        return (
          this.events.once(g("session_update", a), ({ error: d }) => {
            d ? o(d) : r();
          }),
          await this.client.session.update(e, { namespaces: s }),
          await this.sendRequest({
            topic: e,
            ...
            this.client.logger.error(d),
              this.client.session.update(e, { namespaces: h }),
              o(d);
          }),
          { acknowledged: i }
        );
      ...
      (this.extend = async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error("extend() -> isValidExtend() failed"), a)
          );
        }
        const { topic: e } = t,
          s = F(),
          { done: i, resolve: r, reject: o } = k();
        return (
          this.events.once(g("session_extend", s), ({ error: a }) => {
            a ? o(a) : r();
          }),
          await this.setExpiry(e, N($)),
          this.sendRequest({
            topic: e,
      ...
      (this.request = async (t) => {
        ...
        const {
          ...
          c = se().toString(),
          {
            ...
            resolve: d,
            reject: u,
          } = k(r, "Request expired. Please try again.");
        return (
          this.events.once(
            g("session_request", a),
            ({ error: p, result: w }) => {
          ...
          await Promise.all([
            new Promise(async (p) => {
              await this.sendRequest({
                ...
                params: {
                  request: L(m({}, s), { expiryTimestamp: N(r) }),
                  chainId: e,
                },
                expiry: r,
                throwOnFailedPublish: !0,
            ...
            new Promise(async (p) => {
              ...
              if (!((w = o.sessionConfig) != null && w.disableDeepLink)) {
                const y = await dt(this.client.core.storage, fe);
                ut({ id: a, topic: i, wcDeepLink: y });
              }
              p();
            }),
            h(),
      ...
      (this.respond = async (t) => {
        ...
        b(s)
          ...
          : M(s) && (await this.sendError({ id: i, topic: e, error: s.error })),
      ...
      (this.ping = async (t) => {
        ...
        if (this.client.session.keys.includes(e)) {
          const s = F(),
            i = se().toString(),
            { done: r, resolve: o, reject: a } = k();
          this.events.once(g("session_ping", s), ({ error: c }) => {
            c ? a(c) : o();
          }),
            await Promise.all([
              this.sendRequest({
      ...
      (this.disconnect = async (t) => {
        ...
        if (this.client.session.keys.includes(e))
          ...
          const { message: s } = l(
            "MISMATCHED_TOPIC",
            `Session or pairing topic not found: ${e}`
          );
          throw new Error(s);
        }
      }),
      (this.find = (t) => (
        this.isInitialized(),
        this.client.session.getAll().filter((e) => gt(e, t))
      )),
      ...
      (this.authenticate = async (t) => {
        ...
        const {
          ...
          p = [...(t.resources || [])],
          { topic: w, uri: y } = await this.client.core.pairing.create({
            methods: ["wc_sessionAuthenticate"],
          });
        this.client.logger.info({
          message: "Generated new pairing",
          pairing: { topic: w, uri: y },
        });
        ...
        if (
          ...
          const { namespace: A } = ge(e[0]);
          let f = wt(A, "request", d);
          we(p) && (f = yt(f, p.pop())), p.push(f);
        }
        const _ =
            u && u > R.wc_sessionAuthenticate.req.ttl
              ? u
              : R.wc_sessionAuthenticate.req.ttl,
          P = {
            authPayload: {
              type: a ?? "caip122",
              chains: e,
          ...
          { done: Q, resolve: Ie, reject: ae } = k(_, "Request expired"),
          W = async ({ error: A, session: f }) => {
            if ((this.events.off(g("session_request", K), ce), A)) ae(A);
            else if (f) {
              (f.self.publicKey = S),
              ...
              const U = this.client.session.get(f.topic);
              await this.deleteProposal(z), Ie({ session: U });
            }
          },
          ce = async (A) => {
            if (
              ...
              return A.error.code === H.code
                ? void 0
                : (this.events.off(g("session_connect"), W),
                  ae(A.error.message));
            }
            await this.deleteProposal(z),
              this.events.off(g("session_connect"), W);
            const { cacaos: f, responder: U } = A.result,
              le = [],
              qe = [];
            for (const H of f) {
              (await Oe({ cacao: H, projectId: this.client.core.projectId })) ||
                (this.client.logger.error(H, "Signature verification failed"),
                ae(
                  I(
            ...
            le.length > 0 &&
              ((ee = {
                ...
                relay: { protocol: "irn" },
                pairingTopic: w,
                namespaces: Ce([...new Set(le)], [...new Set(qe)]),
              }),
              await this.client.core.relayer.subscribe(Z),
              await this.client.session.set(Z, ee),
              w &&
                (await this.client.core.pairing.updateMetadata({
                  topic: w,
                  metadata: U.metadata,
                })),
              (ee = this.client.session.get(Z))),
              Ie({ auths: f, session: ee });
          },
          K = F(),
          z = F();
        this.events.once(g("session_connect"), W),
          this.events.once(g("session_request", K), ce);
        try {
          await Promise.all([
            this.sendRequest({
              topic: w,
          ...
          throw (
            (this.events.off(g("session_connect"), W),
            this.events.off(g("session_request", K), ce),
            A)
          );
        }
        return (
          await this.setProposal(z, m({ id: z }, O)),
          await this.setAuthRequest(K, {
            request: L(m({}, P), { verifyContext: {} }),
            pairingTopic: w,
          }),
          { uri: y, response: Q }
        );
      ...
      (this.approveSessionAuthenticate = async (t) => {
        ...
        const r = i.requester.publicKey,
          ...
          a = ue(r),
          c = { type: me, receiverPublicKey: r, senderPublicKey: o },
          h = [],
          d = [];
        for (const w of s) {
          if (
            !(await Oe({ cacao: w, projectId: this.client.core.projectId }))
          ) {
            const P = I(
              "SESSION_SETTLEMENT_FAILED",
              "Signature verification failed"
        ...
        return (
          h?.length > 0 &&
            ((p = {
              topic: u,
              acknowledged: !0,
              self: { publicKey: o, metadata: this.client.metadata },
              peer: { publicKey: r, metadata: i.requester.metadata },
              controller: r,
              expiry: N($),
              authentication: s,
              requiredNamespaces: {},
              ...
              namespaces: Ce([...new Set(h)], [...new Set(d)]),
            }),
            await this.client.core.relayer.subscribe(u),
            await this.client.session.set(u, p),
            await this.client.core.pairing.updateMetadata({
          ...
          await this.sendResult({
            ...
            result: {
              cacaos: s,
              responder: { publicKey: o, metadata: this.client.metadata },
            },
            encodeOpts: c,
            throwOnFailedPublish: !0,
          }),
          ...
          await this.client.core.pairing.activate({ topic: i.pairingTopic }),
          { session: p }
        );
      }),
      ...
      (this.deleteSession = async (t) => {
        ...
        await this.client.core.relayer.unsubscribe(s),
          await this.client.session.delete(s, I("USER_DISCONNECTED")),
          ...
          this.getPendingSessionRequests().forEach((c) => {
            c.topic === s &&
              this.deletePendingSessionRequest(c.id, I("USER_DISCONNECTED"));
          }),
          s ===
            ((e = this.sessionRequestQueue.queue[0]) == null
              ? void 0
              : e.topic) && (this.sessionRequestQueue.state = D.idle),
          r && this.client.events.emit("session_delete", { id: o, topic: s });
      }),
      (this.deleteProposal = async (t, e) => {
        await Promise.all([
          this.client.proposal.delete(t, I("USER_DISCONNECTED")),
      ...
      (this.deletePendingSessionRequest = async (t, e, s = !1) => {
        await Promise.all([
          ...
          s &&
            ((this.sessionRequestQueue.state = D.idle),
      ...
      (this.setProposal = async (t, e) => {
        this.client.core.expirer.set(t, N(R.wc_sessionPropose.req.ttl)),
      ...
      (this.setPendingSessionRequest = async (t) => {
        const { id: e, topic: s, params: i, verifyContext: r } = t,
          o = i.request.expiryTimestamp || N(R.wc_sessionRequest.req.ttl);
        this.client.core.expirer.set(e, o),
      ...
      (this.sendRequest = async (t) => {
        ...
        try {
          ...
          throw (
            ...
            this.client.logger.error(
              `sendRequest() -> core.crypto.encode() for topic ${e} failed`
            ),
            p)
          );
        }
        ...
        return (
          r && (u.ttl = r),
          o && (u.id = o),
          this.client.core.history.set(e, h),
          c
            ? ((u.internal = L(m({}, u.internal), {
                throwOnFailedPublish: !0,
              })),
              await this.client.core.relayer.publish(e, d, u))
      ...
      (this.sendResult = async (t) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(
              `sendResult() -> history.get(${s}, ${e}) failed`
            ),
            u)
          );
        }
        ...
        r
          ? ((d.internal = L(m({}, d.internal), { throwOnFailedPublish: !0 })),
            await this.client.core.relayer.publish(s, c, d))
          : this.client.core.relayer
              .publish(s, c, d)
      ...
      (this.sendError = async (t) => {
        const { id: e, topic: s, error: i, encodeOpts: r, rpcOpts: o } = t,
          a = Lt(e, i);
        let c;
        try {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(
              `sendError() -> history.get(${s}, ${e}) failed`
            ),
            u)
          );
        }
      ...
      (this.cleanup = async () => {
        ...
        this.client.session.getAll().forEach((s) => {
          ...
          this.client.proposal.getAll().forEach((s) => {
            j(s.expiryTimestamp) && e.push(s.id);
          }),
          await Promise.all([
      ...
      (this.processRequest = async (t) => {
        const { topic: e, payload: s } = t,
          i = s.method;
        if (!this.shouldIgnorePairingRequest({ topic: e, requestMethod: i }))
          switch (i) {
            case "wc_sessionPropose":
              return await this.onSessionProposeRequest(e, s);
            ...
            case "wc_sessionRequest":
              return await this.onSessionRequest(e, s);
            case "wc_sessionEvent":
              return await this.onSessionEventRequest(e, s);
            case "wc_sessionAuthenticate":
              return await this.onSessionAuthenticateRequest(e, s);
            default:
      ...
      (this.shouldIgnorePairingRequest = (t) => {
        const { topic: e, requestMethod: s } = t,
      ...
      (this.onSessionProposeRequest = async (t, e) => {
        ...
        try {
          ...
          const r = s.expiryTimestamp || N(R.wc_sessionPropose.req.ttl),
            o = m({ id: i, pairingTopic: t, expiryTimestamp: r }, s);
      ...
      (this.onSessionProposeResponse = async (t, e) => {
        ...
        if (b(e)) {
          ...
          this.events.emit(g("session_connect"), { error: e.error });
        }
      }),
      (this.onSessionSettleRequest = async (t, e) => {
        ...
        try {
          ...
          this.events.emit(g("session_connect"), { session: u });
        } catch (r) {
          await this.sendError({ id: s, topic: t, error: r }),
            this.client.logger.error(r);
        }
      }),
      (this.onSessionSettleResponse = async (t, e) => {
        ...
        b(e)
          ? (await this.client.session.update(t, { acknowledged: !0 }),
            this.events.emit(g("session_approve", s), {}))
          : M(e) &&
            (await this.client.session.delete(t, I("USER_DISCONNECTED")),
            this.events.emit(g("session_approve", s), { error: e.error }));
      }),
      (this.onSessionUpdateRequest = async (t, e) => {
        ...
        try {
          ...
          await this.sendError({ id: i, topic: t, error: r }),
            this.client.logger.error(r);
        }
      }),
      ...
      (this.onSessionUpdateResponse = (t, e) => {
        ...
        b(e)
          ? this.events.emit(g("session_update", s), {})
          : M(e) &&
            this.events.emit(g("session_update", s), { error: e.error });
      }),
      (this.onSessionExtendRequest = async (t, e) => {
        const { id: s } = e;
        try {
          this.isValidExtend({ topic: t }),
            await this.setExpiry(t, N($)),
            await this.sendResult({
              id: s,
              topic: t,
              result: !0,
          ...
          await this.sendError({ id: s, topic: t, error: i }),
      ...
      (this.onSessionExtendResponse = (t, e) => {
        ...
        if (this.events.listenerCount(i) === 0)
          throw new Error(`emitting ${i} without any listeners`);
        b(e)
          ? this.events.emit(g("session_extend", s), {})
          : M(e) &&
            this.events.emit(g("session_extend", s), { error: e.error });
      }),
      ...
      (this.onSessionPingResponse = (t, e) => {
        ...
        setTimeout(() => {
          b(e)
            ? this.events.emit(g("session_ping", s), {})
            : M(e) &&
              this.events.emit(g("session_ping", s), { error: e.error });
        }, 500);
      }),
      ...
      (this.onSessionRequest = async (t, e) => {
        ...
        try {
          await this.isValidRequest(m({ topic: t }, r));
          const o = te(JSON.stringify(Re("wc_sessionRequest", r, i))),
            ...
            h = { id: i, topic: t, params: r, verifyContext: c };
      ...
      (this.onSessionRequestResponse = (t, e) => {
        ...
        if (this.events.listenerCount(i) === 0)
          throw new Error(`emitting ${i} without any listeners`);
        b(e)
          ? this.events.emit(g("session_request", s), { result: e.result })
          : M(e) &&
            this.events.emit(g("session_request", s), { error: e.error });
      }),
      ...
      (this.onSessionAuthenticateRequest = async (t, e) => {
        try {
          const { requester: s, authPayload: i, expiryTimestamp: r } = e.params,
          ...
          await this.setAuthRequest(e.id, { request: c, pairingTopic: t }),
          ...
          const i = e.params.requester.publicKey,
            ...
            o = { type: me, receiverPublicKey: i, senderPublicKey: r };
          await this.sendError({
            id: e.id,
            topic: t,
            error: s,
      ...
      (this.processSessionRequestQueue = () => {
        ...
        try {
          (this.sessionRequestQueue.state = D.active),
      ...
      (this.isValidApprove = async (t) => {
        if (!x(t))
          throw new Error(
            l("MISSING_OR_INVALID", `approve() params: ${t}`).message
          );
        const {
          id: e,
          namespaces: s,
      ...
      (this.isValidSessionSettleRequest = (t) => {
        ...
        const a = ye(i, "onSessionSettleRequest()");
        if (a) throw new Error(a.message);
        if (j(r)) {
          const { message: c } = l("EXPIRED", "onSessionSettleRequest()");
          throw new Error(c);
        }
      }),
      ...
      (this.isValidRequest = async (t) => {
        ...
        if (r && !Pt(r, ne)) {
          const { message: a } = l(
            "MISSING_OR_INVALID",
            `request() expiry: ${r}. Expiry must be a number (in seconds) between ${ne.min} and ${ne.max}`
          );
          throw new Error(a);
        }
      }),
      (this.isValidRespond = async (t) => {
        ...
        try {
          ...
          throw (
            ((e = t?.response) != null && e.id && this.cleanupAfterResponse(t),
            r)
          );
        }
        if (!vt(i)) {
      ...
      (this.isValidPing = async (t) => {
        if (!x(t)) {
          const { message: s } = l("MISSING_OR_INVALID", `ping() params: ${t}`);
          throw new Error(s);
        }
        const { topic: e } = t;
      ...
      (this.isValidEmit = async (t) => {
        if (!x(t)) {
          const { message: o } = l("MISSING_OR_INVALID", `emit() params: ${t}`);
          throw new Error(o);
        }
        const { topic: e, event: s, chainId: i } = t;
      ...
      (this.isValidAuthenticate = (t) => {
        ...
        if (!C(s, !1)) throw new Error("uri is required parameter");
        if (!C(i, !1)) throw new Error("domain is required parameter");
        if (!C(r, !1)) throw new Error("nonce is required parameter");
        if ([...new Set(e.map((a) => ge(a).namespace))].length > 1)
          throw new Error(
            "Multi-namespace requests are not supported. Please request single namespace only."
          );
        const { namespace: o } = ge(e[0]);
        if (o !== "eip155")
          throw new Error(
      ...
      (this.getVerifyContext = async (t, e) => {
        ...
        try {
          ...
          i &&
            ((s.verified.origin = i.origin),
            (s.verified.isScam = i.isScam),
      ...
      (this.checkRecentlyDeleted = (t) => {
        ...
        if (e) {
          const { message: s } = l(
            "MISSING_OR_INVALID",
            `Record was recently deleted - ${e}: ${t}`
          );
          throw new Error(s);
        }
      });
  ...
  async isInitialized() {
    if (!this.initialized) {
      const { message: n } = l("NOT_INITIALIZED", this.name);
      throw new Error(n);
    }
    await this.client.core.relayer.confirmOnlineStateOrThrow();
  }
  registerRelayerEvents() {
    this.client.core.relayer.on(Pe.message, (n) => {
      !this.initialized || this.relayMessageCache.length > 0
        ? this.relayMessageCache.push(n)
        : this.onRelayMessage(n);
    });
  }
  async onRelayMessage(n) {
    const { topic: t, message: e } = n,
      { publicKey: s } = this.client.auth.authKeys.keys.includes(B)
        ? this.client.auth.authKeys.get(B)
        : { responseTopic: void 0, publicKey: void 0 },
      i = await this.client.core.crypto.decode(t, e, { receiverPublicKey: s });
    try {
      Kt(i)
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(rt.expired, async (n) => {
      const { topic: t, id: e } = At(n.target);
      if (e && this.client.pendingRequest.keys.includes(e))
        return await this.deletePendingSessionRequest(e, l("EXPIRED"), !0);
      if (e && this.client.auth.requests.keys.includes(e))
        return await this.deletePendingAuthRequest(e, l("EXPIRED"), !0);
      t
        ? this.client.session.keys.includes(t) &&
          (await this.deleteSession({ topic: t, expirerHasDeleted: !0 }),
          this.client.events.emit("session_expire", { topic: t }))
        : e &&
          (await this.deleteProposal(e, !0),
          this.client.events.emit("proposal_expire", { id: e }));
    });
  }
  registerPairingEvents() {
    this.client.core.pairing.events.on(ve.create, (n) =>
      this.onPairingCreated(n)
    ),
      this.client.core.pairing.events.on(ve.delete, (n) => {
  ...
  isValidPairingTopic(n) {
    ...
    if (j(this.client.core.pairing.pairings.get(n).expiry)) {
      const { message: t } = l("EXPIRED", `pairing topic: ${n}`);
      throw new Error(t);
    }
  }
  async isValidSessionTopic(n) {
    ...
    if (j(this.client.session.get(n).expiry)) {
      await this.deleteSession({ topic: n });
      const { message: t } = l("EXPIRED", `session topic: ${n}`);
      throw new Error(t);
    }
    if (!this.client.core.crypto.keychain.has(n)) {
      const { message: t } = l(
        "MISSING_OR_INVALID",
        `session topic does not exist in keychain: ${n}`
      );
  ...
  async isValidProposalId(n) {
    ...
    if (j(this.client.proposal.get(n).expiryTimestamp)) {
      await this.deleteProposal(n);
      const { message: t } = l("EXPIRED", `proposal id: ${n}`);
      throw new Error(t);
    }
  }
}
...
class ns {
  constructor(n, t) {
    (this.core = n),
      (this.logger = t),
      (this.authKeys = new ss(this.core, this.logger)),
      (this.pairingTopics = new is(this.core, this.logger)),
      (this.requests = new rs(this.core, this.logger));
  }
  async init() {
...
class oe extends pt {
  constructor(n) {
    super(n),
      ...
      (this.name = re.name),
      (this.events = new Vt()),
      (this.on = (e, s) => this.events.on(e, s)),
      (this.once = (e, s) => this.events.once(e, s)),
      (this.off = (e, s) => this.events.off(e, s)),
      (this.removeListener = (e, s) => this.events.removeListener(e, s)),
      ...
      (this.name = n?.name || re.name),
      (this.metadata = n?.metadata || Dt()),
      (this.signConfig = n?.signConfig);
    const t =
      typeof n?.logger < "u" && typeof n?.logger != "string"
        ? n.logger
        : ot(at({ level: n?.logger || re.logger }));
    (this.core = n?.core || new nt(n)),
      (this.logger = ct(t, this.name)),
      (this.session = new Ze(this.core, this.logger)),
      (this.proposal = new es(this.core, this.logger)),
      (this.pendingRequest = new ts(this.core, this.logger)),
      (this.engine = new Zt(this)),
      (this.auth = new ns(this.core, this.logger));
  }
  static async init(n) {
    const t = new oe(n);
...
export {
  He as AUTH_CONTEXT,
  Ye as AUTH_KEYS_CONTEXT,
  Xe as AUTH_PAIRING_TOPIC_CONTEXT,
  ze as AUTH_PROTOCOL,
  B as AUTH_PUBLIC_KEY_NAME,
  Je as AUTH_REQUEST_CONTEXT,
  J as AUTH_STORAGE_PREFIX,
  Ht as AUTH_VERSION,
  je as ENGINE_CONTEXT,
  D as ENGINE_QUEUE_STATES,
  R as ENGINE_RPC_OPTS,
  Ft as HISTORY_CONTEXT,
  jt as HISTORY_EVENTS,
  Qt as HISTORY_STORAGE_VERSION,
  Qe as METHODS_TO_VERIFY,
  Ue as PROPOSAL_CONTEXT,
  zt as PROPOSAL_EXPIRY,
  Ge as PROPOSAL_EXPIRY_MESSAGE,
  Fe as REQUEST_CONTEXT,
  ke as SESSION_CONTEXT,
  $ as SESSION_EXPIRY,
  ne as SESSION_REQUEST_EXPIRY_BOUNDARIES,
  _e as SIGN_CLIENT_CONTEXT,
  re as SIGN_CLIENT_DEFAULT,
  Gt as SIGN_CLIENT_EVENTS,
  Ee as SIGN_CLIENT_PROTOCOL,
  kt as SIGN_CLIENT_STORAGE_OPTIONS,
  ie as SIGN_CLIENT_STORAGE_PREFIX,
  Se as SIGN_CLIENT_VERSION,
  os as SessionStore,
  as as SignClient,
  fe as WALLETCONNECT_DEEPLINK_CHOICE,
  oe as default,
};
