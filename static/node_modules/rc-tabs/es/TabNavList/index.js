...
var TabNavList = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  // ========================== Unit =========================
  var containerExcludeExtraSizeValue = getUnitValue(
    containerExcludeExtraSize,
    tabPositionTopOrBottom
  );
  var tabContentSizeValue = getUnitValue(
    tabContentSize,
    tabPositionTopOrBottom
  );
  ...
  // ========================== Util =========================
  var operationsHiddenClassName = "".concat(
    prefixCls,
  ...
  var tabNodes = tabs.map(function (tab, i) {
    ...
    return /*#__PURE__*/ React.createElement(TabNode, {
      ...
      key: key,
      tab: tab,
      /* first node should not have margin left */ style:
        i === 0 ? undefined : tabNodeStyle,
  ...
  var updateTabSizes = function updateTabSizes() {
    return setTabSizes(function () {
      ...
      var listRect =
        (_tabListRef$current = tabListRef.current) === null ||
        _tabListRef$current === void 0
          ? void 0
          : _tabListRef$current.getBoundingClientRect();
      tabs.forEach(function (_ref2) {
        var _tabListRef$current2;
        var key = _ref2.key;
        var btnNode =
          (_tabListRef$current2 = tabListRef.current) === null ||
          _tabListRef$current2 === void 0
            ? void 0
            : _tabListRef$current2.querySelector(
                '[data-node-key="'.concat(genDataNodeKey(key), '"]')
              );
        if (btnNode) {
  ...
  var hiddenTabs = [].concat(
    _toConsumableArray(startHiddenTabs),
    _toConsumableArray(endHiddenTabs)
  );
