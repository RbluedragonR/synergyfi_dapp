...
class WalletLinkRelay extends RelayAbstract_1.RelayAbstract {
  constructor(options) {
      ...
      if (cachedAddresses) {
        ...
        if (
          ...
          (_a = this.diagnostic) === null || _a === void 0
            ? void 0
            : _a.log(DiagnosticLogger_1.EVENTS.UNLINKED_ERROR_STATE, {
                sessionIdHash,
              });
        }
      }
      ...
      if (WalletLinkRelay.accountRequestCallbackIds.size > 0) {
        ...
        Array.from(WalletLinkRelay.accountRequestCallbackIds.values()).forEach(
          (id) => {
            ...
            this.invokeCallback(
              Object.assign(Object.assign({}, message), { id })
            );
          }
        );
    ...
    this._reloadOnDisconnect =
      (_a = options.reloadOnDisconnect) !== null && _a !== void 0 ? _a : true;
    this.ui = ui;
  }
  subscribe() {
    const session =
      Session_1.Session.load(this.storage) ||
      new Session_1.Session(this.storage).save();
  ...
  resetAndReload() {
    Promise.race([
      ...
      .then(() => {
        ...
        (_a = this.diagnostic) === null || _a === void 0
          ? void 0
          : _a.log(DiagnosticLogger_1.EVENTS.SESSION_STATE_CHANGE, {
        ...
        if (
          ...
          (_b = this.diagnostic) === null || _b === void 0
            ? void 0
            : _b.log(DiagnosticLogger_1.EVENTS.SKIPPED_CLEARING_SESSION, {
                sessionIdHash: this.getSessionIdHash(),
      ...
      .catch((err) => {
        ...
        (_a = this.diagnostic) === null || _a === void 0
          ? void 0
          : _a.log(DiagnosticLogger_1.EVENTS.FAILURE, {
              method: "relay::resetAndReload",
    ...
    return this.sendRequest({
      ...
      params: {
        ...
        gasLimit: params.gasLimit
          ? (0, util_1.bigIntStringFromBN)(params.gasLimit)
          : null,
  ...
  submitEthereumTransaction(signedTransaction, chainId) {
    return this.sendRequest({
      ...
      params: {
        signedTransaction: (0, util_1.hexStringFromBuffer)(
          signedTransaction,
          true
        ),
        chainId,
  ...
  sendRequest(request) {
    ...
    const cancel = (error) => {
      ...
      hideSnackbarItem === null || hideSnackbarItem === void 0
        ? void 0
        : hideSnackbarItem();
    };
  ...
  publishWeb3RequestEvent(id, request) {
    ...
    (_a = this.diagnostic) === null || _a === void 0
      ? void 0
      : _a.log(DiagnosticLogger_1.EVENTS.WEB3_REQUEST, {
          eventId: message.id,
    ...
    this.publishEvent("Web3Request", message, true)
      .then((_) => {
        ...
        (_a = this.diagnostic) === null || _a === void 0
          ? void 0
          : _a.log(DiagnosticLogger_1.EVENTS.WEB3_REQUEST_PUBLISHED, {
              eventId: message.id,
              method: `relay::${request.method}`,
              sessionIdHash: this.getSessionIdHash(),
              storedSessionIdHash: storedSession
  ...
  handleWeb3ResponseMessage(message) {
    ...
    (_a = this.diagnostic) === null || _a === void 0
      ? void 0
      : _a.log(DiagnosticLogger_1.EVENTS.WEB3_RESPONSE, {
          eventId: message.id,
  ...
  handleErrorResponse(id, method, error, errorCode) {
    ...
    const errorMessage =
      (_a = error === null || error === void 0 ? void 0 : error.message) !==
        null && _a !== void 0
        ? _a
        : (0, error_1.getMessageFromCode)(errorCode);
    this.handleWeb3ResponseMessage({
      type: "WEB3_RESPONSE",
      id,
      response: {
  ...
  requestEthereumAccounts() {
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      if (this.ui.inlineAccountsResponse()) {
        ...
        const err = error_1.standardErrors.provider.userRejectedRequest(
  ...
  switchEthereumChain(chainId, address) {
    ...
    const promise = new Promise((resolve, reject) => {
      this.relayEventManager.callbacks.set(id, (response) => {
        if (
          (0, Web3Response_1.isErrorResponse)(response) &&
          response.errorCode
        ) {
          return reject(
            error_1.standardErrors.provider.custom({
      ...
      const _cancel = (error) => {
        ...
        if (error) {
          ...
          const errorCode =
            (_a = (0, error_1.getErrorCode)(error)) !== null && _a !== void 0
              ? _a
              : error_1.standardErrorCodes.provider.unsupportedChain;
          this.handleErrorResponse(
            id,
            "switchEthereumChain",
            error instanceof Error
              ? error
              : error_1.standardErrors.provider.unsupportedChain(chainId),
            errorCode
          );
        } else {
          this.handleWeb3ResponseMessage({
