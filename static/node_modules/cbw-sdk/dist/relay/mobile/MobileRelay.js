...
class MobileRelay extends WalletLinkRelay_1.WalletLinkRelay {
  constructor(options) {
    ...
    this._enableMobileWalletLink =
      (_a = options.enableMobileWalletLink) !== null && _a !== void 0
        ? _a
        : false;
  }
  // override
  requestEthereumAccounts() {
    ...
    return {
      promise: new Promise(() => {
        ...
        location.href = `https://go.cb-w.com/dapp?cb_url=${encodeURIComponent(
          location.href
        )}`;
      }),
      cancel: () => {},
  ...
  publishWeb3RequestEvent(id, request) {
    ...
    if (
      !(
        this._enableMobileWalletLink &&
        this.ui instanceof MobileRelayUI_1.MobileRelayUI
      )
    )
      return;
