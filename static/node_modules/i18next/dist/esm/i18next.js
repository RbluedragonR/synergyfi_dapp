          ...
          if (_this.formats[formatName]) {
            ...
            try {
              ...
              formatted = _this.formats[formatName](
                ...
                l,
                _objectSpread$4(
                  _objectSpread$4(_objectSpread$4({}, formatOptions), options),
                  valOptions
                )
              );
            } catch (error) {
  ...
  _createClass(I18n, [
    {
      ...
      value: function init() {
        ...
        this.options = _objectSpread$6(
          _objectSpread$6(_objectSpread$6({}, defOpts), this.options),
          transformOptions(options)
        );

        if (this.options.compatibilityAPI !== "v1") {
          this.options.interpolation = _objectSpread$6(
            _objectSpread$6({}, defOpts.interpolation),
            this.options.interpolation
          );
        }
    ...
    },
    {
      ...
      value: function getFixedT(lng, ns, keyPrefix) {
        ...
        var fixedT = function fixedT(key, opts) {
          ...
          options.keyPrefix =
            options.keyPrefix || keyPrefix || fixedT.keyPrefix;
          var keySeparator = _this5.options.keySeparator || ".";
          var resultKey = options.keyPrefix
    ...
    },
    {
      ...
      value: function cloneInstance() {
        ...
        var mergedOptions = _objectSpread$6(
          _objectSpread$6(_objectSpread$6({}, this.options), options),
          {
            isClone: true,
          }
        );
