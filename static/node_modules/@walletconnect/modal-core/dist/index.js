import { proxy as u, subscribe as h, snapshot as P } from "valtio/vanilla";
const o = u({
  ...
  a = {
    ...
    isAndroid() {
      return (
        a.isMobile() && navigator.userAgent.toLowerCase().includes("android")
      );
    },
    isIos() {
    ...
    setModalVersionInStorage() {
      try {
        typeof localStorage < "u" &&
          localStorage.setItem(a.WCM_VERSION, "2.6.2");
      } catch {
  ...
  R = {
    state: r,
    subscribe(e) {
      return h(r.events, () => e(P(r.events[r.events.length - 1])));
    },
    initialize() {
      r.enabled &&
        typeof (crypto == null ? void 0 : crypto.randomUUID) < "u" &&
        (r.userSessionId = crypto.randomUUID());
    },
  ...
  y = {
    ...
    setConfig(e) {
      var t, s;
      R.initialize(),
        p.setChains(e.chains),
        p.setIsAuth(Boolean(e.enableAuthMode)),
        p.setIsCustomMobile(
          Boolean((t = e.mobileWallets) == null ? void 0 : t.length)
        ),
        p.setIsCustomDesktop(
          Boolean((s = e.desktopWallets) == null ? void 0 : s.length)
        ),
...
async function w(e, t) {
  const s = K({ sdkType: E, sdkVersion: O }, t),
    n = new URL(e, L);
  return (
    n.searchParams.append("projectId", y.state.projectId),
...
var z = Object.defineProperty,
  ...
  k = (e, t, s) =>
    t in e
      ? z(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (e[t] = s),
  F = (e, t) => {
    ...
    async getRecomendedWallets() {
      ...
      if (a.isArray(e)) {
        const s = { recommendedIds: e.join(",") },
          { listings: n } = await m.getAllListings(s),
          i = Object.values(n);
        i.sort((l, v) => {
        ...
        const { chains: s, isAuth: n } = p.state,
          i = s?.join(","),
          l = a.isArray(t),
          v = {
            page: 1,
          ...
          { listings: b } = N
            ? await m.getMobileListings(v)
            : await m.getDesktopListings(v);
    ...
    async open(e) {
      return new Promise((t) => {
        ...
        if (
          ...
          p.setWalletConnectUri(e?.uri),
          p.setChains(e?.chains),
          T.reset("ConnectWallet"),
          s && n)
        )
          (I.open = !0), t();
        else {
...
var G = Object.defineProperty,
  ...
  S = (e, t, s) =>
    t in e
      ? G(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (e[t] = s),
  Y = (e, t) => {
...
const C = u({ themeMode: Z() ? "dark" : "light" }),
  ne = {
    state: C,
    subscribe(e) {
      return h(C, () => e(C));
  ...
  g = u({ open: !1, message: "", variant: "success" }),
  oe = {
    state: g,
    subscribe(e) {
      return h(g, () => e(g));
