...
var z = (i = {}) => {
  ...
  let n;
  return (
    i.dbName && i.storeName && (n = I(i.dbName, i.storeName)),
    {
      name: x,
      options: i,
      async hasItem(s) {
...
class _ {
  constructor() {
    this.indexedDb = w({ driver: z({ dbName: D, storeName: E }) });
  }
  async getKeys() {
