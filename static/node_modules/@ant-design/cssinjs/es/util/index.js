...
export function supportLogicProps() {
  if (canLogic === undefined) {
    canLogic = supportSelector(
      ".".concat(randomSelectorKey, " { inset-block: 93px !important; }"),
      function (ele) {
        ele.className = randomSelectorKey;
      },
      function (ele) {
...
export function toStyleStr(style, tokenKey, styleId) {
  ...
  var attrs = _objectSpread(
    _objectSpread({}, customizeAttrs),
    {},
    ((_objectSpread2 = {}),
    _defineProperty(_objectSpread2, ATTR_TOKEN, tokenKey),
    _defineProperty(_objectSpread2, ATTR_MARK, styleId),
    _objectSpread2)
  );
