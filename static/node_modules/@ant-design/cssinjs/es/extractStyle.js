...
var ExtractStyleFns =
  ((_ExtractStyleFns = {}),
  _defineProperty(_ExtractStyleFns, STYLE_PREFIX, styleExtractStyle),
  _defineProperty(_ExtractStyleFns, TOKEN_PREFIX, tokenExtractStyle),
  _defineProperty(_ExtractStyleFns, CSS_VAR_PREFIX, cssVarExtractStyle),
  _ExtractStyleFns);
...
export default function extractStyle(cache, options) {
  ...
  var matchPrefixRegexp = new RegExp(
    "^(".concat((typeof types === "string" ? [types] : types).join("|"), ")%")
  );
  ...
  styleText += toStyleStr(
    "."
      ...
      .concat(serializeCacheMap(cachePathMap), '";}'),
    undefined,
    undefined,
