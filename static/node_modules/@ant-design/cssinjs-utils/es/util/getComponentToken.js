    ...
    deprecatedTokens.forEach(function (_ref) {
      ...
      if (process.env.NODE_ENV !== "production") {
        warning(
          ...
          "Component Token `"
            .concat(String(oldTokenKey), "` of ")
            .concat(String(component), " is deprecated. Please use `")
            .concat(String(newTokenKey), "` instead.")
        );
      }
      ...
      if (
        ...
        (_customToken$newToken = customToken[newTokenKey]) !== null &&
        _customToken$newToken !== void 0
          ? _customToken$newToken
          : (customToken[newTokenKey] =
