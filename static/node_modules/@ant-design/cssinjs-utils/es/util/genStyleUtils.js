...
function genStyleUtils(config) {
  ...
  function genStyleHooks(component, styleFn, getDefaultToken, options) {
    ...
    function prefixToken(key) {
      return ""
        .concat(String(componentName))
        .concat(key.slice(0, 1).toUpperCase())
        .concat(key.slice(1));
    }

    // Fill unitless
    var originUnitless =
      (options === null || options === void 0 ? void 0 : options.unitless) ||
      {};
    var originCompUnitless =
      typeof getCompUnitless === "function" ? getCompUnitless(component) : {};
    var compUnitless = _objectSpread(
      _objectSpread({}, originCompUnitless),
      {},
      _defineProperty({}, prefixToken("zIndexPopup"), true)
    );
    ...
    // Hooks
    var useStyle = genComponentStyleHook(
      component,
      styleFn,
      getDefaultToken,
      mergedOptions
    );
    var useCSSVar = genCSSVarRegister(
      componentName,
      getDefaultToken,
      mergedOptions
    );
  ...
  function genCSSVarRegister(component, getDefaultToken, options) {
    var compUnitless = options.unitless,
      ...
      injectStyle =
        _options$injectStyle === void 0 ? true : _options$injectStyle,
    ...
    var CSSVarRegister = function CSSVarRegister(_ref) {
      ...
      useCSSVarRegister(
        ...
        function () {
          var defaultToken = getDefaultComponentToken(
            component,
            realToken,
            getDefaultToken
          );
          var componentToken = getComponentToken(
            component,
            realToken,
            defaultToken,
            {
        ...
        function (node) {
          return injectStyle && cssVar
            ? /*#__PURE__*/ React.createElement(
                React.Fragment,
                null,
                /*#__PURE__*/ React.createElement(CSSVarRegister, {
                  rootCls: rootCls,
                  cssVar: cssVar,
                  component: component,
                }),
  ...
  function genComponentStyleHook(componentName, styleFn, getDefaultToken) {
    ...
    var cells = Array.isArray(componentName)
      ? componentName
    ...
    return function (prefixCls) {
      ...
      var wrapSSR = useStyleRegister(
        ...
        function () {
          ...
          var defaultComponentToken = getDefaultComponentToken(
            component,
            realToken,
            getDefaultToken
          );
          ...
          if (
            cssVar &&
            defaultComponentToken &&
            _typeof(defaultComponentToken) === "object"
          ) {
  ...
  function genSubStyleComponent(componentName, styleFn, getDefaultToken) {
    ...
    if (process.env.NODE_ENV !== "production") {
      StyledComponent.displayName = "SubStyle_".concat(
        String(
