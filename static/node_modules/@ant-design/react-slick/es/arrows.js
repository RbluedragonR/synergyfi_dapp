    ...
    },
    {
      ...
      value: function render() {
        ...
        if (this.props.prevArrow) {
          prevArrow = /*#__PURE__*/ React.cloneElement(
            this.props.prevArrow,
            _objectSpread(_objectSpread({}, prevArrowProps), customProps)
          );
        } else {
          prevArrow = /*#__PURE__*/ React.createElement(
            "button",
            _extends(
              {
                key: "0",
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (this.props.nextArrow) {
          nextArrow = /*#__PURE__*/ React.cloneElement(
            this.props.nextArrow,
            _objectSpread(_objectSpread({}, nextArrowProps), customProps)
          );
        } else {
          nextArrow = /*#__PURE__*/ React.createElement(
            "button",
            _extends(
              {
                key: "1",
