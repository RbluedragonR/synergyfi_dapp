...
export var InnerSlider = /*#__PURE__*/ (function (_React$Component) {
  function InnerSlider(props) {
    ...
    _defineProperty(_this, "componentDidUpdate", function (prevProps) {
      ...
      setTrackStyle &&
        _this.updateState(spec, setTrackStyle, function () {
          ...
          if (
            prevProps.autoplay !== _this.props.autoplay ||
            prevProps.autoplaySpeed !== _this.props.autoplaySpeed
          ) {
    ...
    _defineProperty(_this, "ssrInit", function () {
      ...
      var trackLeft =
        (-slideWidth *
          (getPreClones(spec) + _this.state.currentSlide) *
          trackWidth) /
        100;
      if (_this.props.centerMode) {
    ...
    _defineProperty(_this, "progressiveLazyLoad", function () {
      ...
      for (
        ...
        index < _this.state.slideCount + getPostClones(spec);
        index++
      ) {
    ...
    _defineProperty(_this, "play", function () {
      ...
      if (_this.props.rtl) {
        ...
        if (
          canGoNext(_objectSpread(_objectSpread({}, _this.props), _this.state))
        ) {
          nextIndex = _this.state.currentSlide + _this.props.slidesToScroll;
        } else {
          return false;
