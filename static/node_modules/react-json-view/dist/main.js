!(function (e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.reactJsonView = t(require("react")))
    : (e.reactJsonView = t(e.React));
})(this, function (e) {
  return (function (e) {
    var t = {};
    function n(a) {
    ...
    function (e, t, n) {
      var a = n(3),
        ...
        c = function (e, t, n) {
          ...
          for (l in (d && (n = t), n))
            ((u = !p && E && void 0 !== E[l]) && s(y, l)) ||
              ((f = u ? E[l] : n[l]),
              (y[l] =
                d && "function" != typeof E[l]
                  ? n[l]
                  : v && u
                  ? o(f, a)
                  : m && E[l] == f
    ...
    function (e, t, n) {
      ...
      e.exports = function (e, t, n, b, h, v, m) {
        ...
        if (
          (A &&
            (E = u(A.call(new e()))) !== Object.prototype &&
            E.next &&
            (l(E, x, !0), a || "function" == typeof E[f] || i(E, f, d)),
          _ &&
            C &&
            "values" !== C.name &&
            ((k = !0),
    ...
    function (e, t, n) {
      ...
      var b = c.default,
        ...
        v = (0, f.default)(
          ...
          function (e) {
            var t,
              ...
              i = n[2];
            return [
              ((t = a), t < 0.25 ? 1 : t < 0.5 ? 0.9 - t : 1.1 - t),
              r,
              i,
            ];
          },
        ...
        g = function (e, t) {
          for (
            var n = arguments.length, o = Array(n > 2 ? n - 2 : 0), s = 2;
            s < n;
            s++
          )
            o[s - 2] = arguments[s];
        ...
        j =
          ((t.createStyling = (0, s.default)(function (e) {
            for (
              var t = arguments.length, n = Array(t > 3 ? t - 3 : 0), a = 3;
              a < t;
              a++
            )
              n[a - 3] = arguments[a];
    ...
    function (e, t, n) {
      ...
      var a = n(3),
        ...
        Q = function (e) {
          ...
          return (
            !(this === V && r(T, e) && !r(q, e)) &&
            (!(t || !r(this, e) || !r(T, e) || (r(this, L) && this[L][e])) || t)
          );
        },
        Z = function (e, t) {
          if (((e = j(e)), (t = x(t, !0)), e !== V || !r(T, t) || r(q, t))) {
            var n = M(e, t);
            return (
              !n || !r(T, t) || (r(e, L) && e[L][t]) || (n.enumerable = !0), n
            );
          }
        },
        X = function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        var t = a(e),
          n = r.f;
        if (n)
          for (var i, s = n(e), c = o.f, l = 0; s.length > l; )
    ...
    function (e, t, n) {
      ...
      e.exports =
        ...
        n(8)(function () {
          ...
          ? function (e, t) {
              for (
                var n = s(e), l = arguments.length, u = 1, f = o.f, p = i.f;
                l > u;
      ...
      (function (t) {
            ...
            (function (e, t, n) {
              if (t != t)
                return (function (e, t, n, a) {
                  var r = e.length,
                    o = n + (a ? 1 : -1);
                  for (; a ? o-- : ++o < r; ) if (t(e[o], o, e)) return o;
                  return -1;
                })(e, y, n);
              var a = n - 1,
                r = e.length;
        ...
        function z(e, t, n, a) {
          for (
            ...
            f[r] = e[r];
          for (var d = r; ++c < l; ) f[d + c] = t[c];
          for (; ++i < s; ) (p || r < o) && (f[d + n[i]] = e[r++]);
          return f;
        }
        function T(e) {
          return function () {
        ...
        function q(e, t, n, a, r, o, i, s, c, l) {
          ...
          return function m() {
            ...
            return (
              (y = j.length),
              s ? (j = Y(j, s)) : b && y > 1 && j.reverse(),
              u && c < y && (j.length = c),
              this && this !== h && this instanceof m && (S = v || T(S)),
              S.apply(C, j)
            );
          };
        }
        ...
        function K(e, t, n, a, r, o, i, s) {
          ...
          if (
            ...
            (a = p[3]),
            (r = p[4]),
            !(s = p[9] = null == p[9] ? (c ? 0 : e.length) : D(p[9] - l, 0)) &&
              24 & t &&
              (t &= -25),
            t && 1 != t)
          )
            d =
              8 == t || 16 == t
                ? (function (e, t, n) {
                    ...
                    return function r() {
                      for (
                        var o = arguments.length, i = Array(o), s = o, c = W(r);
                        s--;

                      )
                        i[s] = arguments[s];
                      var l =
                        o < 3 && i[0] !== c && i[o - 1] !== c ? [] : E(i, c);
                      if ((o -= l.length) < n)
                        return V(
                          e,
                          t,
                    ...
                    return function t() {
                      for (
                        var i = -1,
                          ...
                          l = a.length,
                          u = Array(l + s),
                          f = this && this !== h && this instanceof t ? o : e;
                        ++c < l;
          ...
          return (
            ...
            (function (e) {
              return (
                ...
                c.call(e, "callee") &&
                (!f.call(e, "callee") || "[object Arguments]" == l.call(e))
              );
            })(e) ||
            !!(p && e && e[p])
          );
        ...
        var v,
          ...
          g =
            ((m = function (e) {
              ...
              return function () {
                for (
                  var n = 0, a = t ? e[n].apply(this, arguments) : arguments[0];
                  ++n < t;
            ...
            (y = d(void 0 === y ? m.length - 1 : y, 0)),
            function () {
              for (
                var e = arguments, t = -1, n = d(e.length - y, 0), a = Array(n);
                ++t < n;

              )
                a[t] = e[y + t];
              t = -1;
              for (var r = Array(y + 1); ++t < y; ) r[t] = e[t];
          ...
          function n(e) {
            ...
            return (
              ...
              ((a = t.call(this, e)).toggleCollapsed = function () {
                a.setState({ collapsed: !a.state.collapsed }, function () {
                  q.set(
                    a.props.rjvId,
                    a.props.namespace,
                    "collapsed",
              ...
              if (t) {
                ...
                var o = (function (e, t, n, a) {
                    void 0 === n && (n = 1),
                      void 0 === a && (a = 1 / 0),
                      ne ||
                        ((ne = document.createElement("textarea")).setAttribute(
                          "tab-index",
                          "-1"
                        ),
                        ne.setAttribute("aria-hidden", "true"),
                        te(ne)),
                      null === ne.parentNode && document.body.appendChild(ne);
                    var r = e.paddingSize,
                      o = e.borderSize,
                      i = e.sizingStyle,
                      s = i.boxSizing;
            ...
            return (
              ...
              (a.handleCopy = function () {
                var e = document.createElement("textarea"),
                  ...
                  r = t.src,
                  o = t.namespace;
                (e.innerHTML = JSON.stringify(a.clipboardValue(r), null, "  ")),
                  ...
                  a.setState({ copied: !0 }, function () {
                    "function" == typeof n &&
                      n({ src: r, namespace: o, name: o[o.length - 1] });
                  });
              }),
              (a.getClippyIcon = function () {
                ...
                return a.state.copied
                  ? m.a.createElement(
                      ...
                      m.a.createElement("span", A(e, "copy-icon-copied"), "✔")
                    )
                  : m.a.createElement(
                      ve,
                      Object.assign(
            ...
            c(n, [
              {
                ...
                value: function () {
                  this.copiedTimer &&
                    (clearTimeout(this.copiedTimer), (this.copiedTimer = null));
                },
              },
              {
                key: "render",
          ...
          ? "array" == t
            ? s
              ? m.a.createElement(
                  ...
                  m.a.createElement("span", { className: "array-key" }, c),
      ...
      var Ae = (function (e) {
                ...
                value: function () {
                  ...
                  return m.a.createElement(
                    ...
                    Object.assign(
                      ...
                      A(o, i ? "jsv-root" : "objectKeyVal", { paddingLeft: l })
                    ),
                    ...
                    B(Array(p)).map(function (t, a) {
                      return m.a.createElement(
                        "div",
                        Object.assign(
                          { key: a, className: "object-key-val array-group" },
                          A(o, "objectKeyVal", {
                            marginLeft: 6,
                            paddingLeft: u,
                          })
        ...
        Me = (function (e) {
          ...
          function n(e) {
            ...
            i(this, n),
              ((a = t.call(this, e)).toggleCollapsed = function () {
                a.setState({ expanded: !a.state.expanded }, function () {
                  q.set(
                    a.props.rjvId,
                    a.props.namespace,
                    "expanded",
              ...
              (a.renderObjectContents = function (e, t) {
                var n,
                  ...
                  p = Object.keys(e || {});
                return (
                  a.props.sortKeys && "array" !== u && (p = p.sort()),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      s || "array_group" === r
                        ? "array_group" === r &&
                          ((d.borderLeft = 0), (d.display = "inline"))
                        : (d.paddingLeft = 5 * this.props.indentWidth),
                      m.a.createElement(
                        "div",
                        Object.assign(
                          {
                          ...
                          A(i, s ? "jsv-root" : "objectKeyVal", d)
                        ),
                        this.getBraceStart(f, p),
                        p
                        ...
                        m.a.createElement(
                          ...
                          p ? null : this.getObjectMetaData(a)
                        )
                      )
                    );
                  },
          ...
          function n() {
            ...
            return (
              ((e = t.call.apply(t, [this].concat(r))).isValid = function (t) {
                ...
                return (
                  "" != t && -1 === Object.keys(a.existing_value).indexOf(t)
                );
              }),
              (e.submit = function (t) {
                var n = e.props.rjvId,
                ...
                (a.new_value = o({}, a.existing_value)),
                  ...
                  z.dispatch({ name: "VARIABLE_ADDED", rjvId: n, data: a });
              }),
              e
            );
          }
                ...
                value: function () {
                  ...
                  return n
                    ? m.a.createElement(
                        ...
                        m.a.createElement(ge, A(a, "validation-failure-clear"))
                      )
                    : null;
                },
              },
          ...
          function n(e) {
            ...
            return (
              ...
              (a.updateSrc = function () {
                ...
                !1 !== e
                  ? (q.set(a.rjvId, "global", "src", s), a.setState({ src: s }))
              ...
              (a.resetState = function () {
                a.setState({ validationFailure: !1, addKeyRequest: !1 });
              }),
              (a.state = {
                addKeyRequest: !1,
                editKeyRequest: !1,
