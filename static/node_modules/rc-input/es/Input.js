...
var Input = /*#__PURE__*/ forwardRef(function (props, ref) {
    ...
    return {
      ...
      nativeElement:
        ...
        _holderRef$current === void 0
          ? void 0
          : _holderRef$current.nativeElement) || inputRef.current,
    };
  });
  useEffect(
    function () {
  ...
  var triggerChange = function triggerChange(e, currentValue, info) {
    ...
    if (
      ...
      if (currentValue !== cutValue) {
        ...
        setSelection([
          ((_inputRef$current4 = inputRef.current) === null ||
          _inputRef$current4 === void 0
            ? void 0
            : _inputRef$current4.selectionStart) || 0,
          ((_inputRef$current5 = inputRef.current) === null ||
          _inputRef$current5 === void 0
            ? void 0
            : _inputRef$current5.selectionEnd) || 0,
        ]);
      }
  ...
  useEffect(
    function () {
      if (selection) {
        ...
        (_inputRef$current6 = inputRef.current) === null ||
          _inputRef$current6 === void 0 ||
          _inputRef$current6.setSelectionRange.apply(
            _inputRef$current6,
  ...
  var getSuffix = function getSuffix() {
    ...
    if (suffix || countConfig.show) {
      var dataCount = countConfig.showFormatter
          ...
          /*#__PURE__*/ React.createElement(
            "span",
            {
              className: clsx(
                ...
                _defineProperty(
                  {},
                  "".concat(prefixCls, "-show-count-has-suffix"),
                  !!suffix
                ),
                classNames === null || classNames === void 0
                  ? void 0
