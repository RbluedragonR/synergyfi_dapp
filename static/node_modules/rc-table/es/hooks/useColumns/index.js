...
function flatColumns(columns) {
  var parentKey =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "key";
  return columns
    .filter(function (column) {
    ...
    .reduce(function (list, column, index) {
      ...
      if (subColumns && subColumns.length > 0) {
        return [].concat(
          ...
          _toConsumableArray(
            flatColumns(subColumns, mergedKey).map(function (subColum) {
              return _objectSpread(
                {
                  fixed: parsedFixed,
                },
...
function useColumns(_ref2, transformColumns) {
  ...
  var withExpandColumns = React.useMemo(
    function () {
      if (expandable) {
        ...
        var expandColumn = _defineProperty(
          _defineProperty(
            _defineProperty(
              _defineProperty(
                _defineProperty(
                  _defineProperty({}, INTERNAL_COL_DEFINE, {
  ...
  // ========================= FillWidth ========================
  var _useWidthColumns = useWidthColumns(
      flattenColumns,
      scrollWidth,
      clientWidth
    ),
