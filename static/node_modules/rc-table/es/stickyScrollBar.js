...
var StickyScrollBar = function StickyScrollBar(_ref, ref) {
  ...
  var bodyWidth =
    ((_scrollBodyRef$curren2 = scrollBodyRef.current) === null ||
  ...
  React.useEffect(
    function () {
      var onMouseUpListener = addEventListener(
        document.body,
        "mouseup",
        onMouseUp,
        false
      );
      var onMouseMoveListener = addEventListener(
        document.body,
        "mousemove",
        onMouseMove,
        false
  ...
  React.useEffect(
    function () {
      var onScrollListener = addEventListener(
        container,
        "scroll",
        checkScrollBarVisible,
        false
      );
      var onResizeListener = addEventListener(
        window,
        "resize",
        checkScrollBarVisible,
        false
