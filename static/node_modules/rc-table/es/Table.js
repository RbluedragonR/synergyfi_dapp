...
function Table(tableProps, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    [
      ...
      warning(
        ...
        "`".concat(name, "` is removed, please use `onRow` instead.")
      );
    });
    warning(
  ...
  var _useColumns = useColumns(
      _objectSpread(
        ...
        {},
        {
          ...
          direction: direction,
          scrollWidth:
            useInternalHooks && tailor && typeof scrollX === "number"
              ? scrollX
              : null,
  ...
  var mergedScrollX =
    flattenScrollX !== null && flattenScrollX !== void 0
      ? flattenScrollX
      : scrollX;
      ...
      scrollTo: function scrollTo(config) {
        ...
        if (scrollBodyRef.current instanceof HTMLElement) {
          ...
          if (validNumberValue(top)) {
            ...
            (_scrollBodyRef$curren = scrollBodyRef.current) === null ||
              _scrollBodyRef$curren === void 0 ||
              _scrollBodyRef$curren.scrollTo({
                top: top,
              });
          } else {
            ...
            var mergedKey =
              key !== null && key !== void 0
                ? key
                : getRowKey(mergedData[index]);
            (_scrollBodyRef$curren2 = scrollBodyRef.current.querySelector(
              '[data-row-key="'.concat(mergedKey, '"]')
            )) === null ||
              _scrollBodyRef$curren2 === void 0 ||
              _scrollBodyRef$curren2.scrollIntoView();
          }
        } else if (
          (_scrollBodyRef$curren3 = scrollBodyRef.current) !== null &&
          _scrollBodyRef$curren3 !== void 0 &&
          _scrollBodyRef$curren3.scrollTo
        ) {
          // Pass to proxy
  ...
  var horizonScroll =
    (scroll && validateValue(mergedScrollX)) || Boolean(expandableConfig.fixed);
  var fixColumn =
    horizonScroll &&
    flattenColumns.some(function (_ref) {
  ...
  var summaryNode = React.useMemo(
    function () {
      return summary === null || summary === void 0
        ? void 0
        : summary(mergedData);
    },
    [summary, mergedData]
  ...
  var onInternalScroll = useEvent(function (_ref2) {
    ...
    if (!getScrollTarget() || getScrollTarget() === compareTarget) {
      ...
      forceScroll(
        mergedScrollLeft,
        (_stickyRef$current = stickyRef.current) === null ||
          _stickyRef$current === void 0
          ? void 0
  ...
  var triggerOnScroll = function triggerOnScroll() {
    if (horizonScroll && scrollBodyRef.current) {
      ...
      onInternalScroll({
        ...
        scrollLeft:
          (_scrollBodyRef$curren4 = scrollBodyRef.current) === null ||
          _scrollBodyRef$curren4 === void 0
            ? void 0
            : _scrollBodyRef$curren4.scrollLeft,
      });
    } else {
      setPingedLeft(false);
      setPingedRight(false);
  ...
  var onFullTableResize = function onFullTableResize(_ref3) {
    ...
    (_stickyRef$current2 = stickyRef.current) === null ||
      _stickyRef$current2 === void 0 ||
      _stickyRef$current2.checkScrollBarVisible();
    var mergedWidth = fullTableRef.current
      ? fullTableRef.current.offsetWidth
      : width;
    if (useInternalHooks && getContainerWidth && fullTableRef.current) {
      mergedWidth =
        getContainerWidth(fullTableRef.current, mergedWidth) || mergedWidth;
    }
  ...
  React.useEffect(function () {
    if (!tailor || !useInternalHooks) {
      if (scrollBodyRef.current instanceof Element) {
        ...
        setScrollbarSize(
          getTargetScrollBarSize(scrollBodyContainerRef.current).width
        );
      }
    }
  ...
  // ========================================================================
  // =================== Render: Func ===================
  var renderFixedHeaderTable = React.useCallback(
  ...
  var renderFixedFooterTable = React.useCallback(
    function (fixedHolderPassProps) {
      return /*#__PURE__*/ React.createElement(
        Footer,
        fixedHolderPassProps,
  ...
  var mergedTableLayout = React.useMemo(
    function () {
      ...
      if (
        fixHeader ||
        isSticky ||
        flattenColumns.some(function (_ref4) {
  ...
  if (fixHeader || isSticky) {
    ...
    if (typeof customizeScrollBody === "function") {
      ...
      headerProps.colWidths = flattenColumns.map(function (_ref6, index) {
        ...
        var colWidth =
          index === flattenColumns.length - 1 ? width - scrollbarSize : width;
    ...
    groupTableNode = /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        showHeader !== false &&
          /*#__PURE__*/ React.createElement(
            Header,
            _extends({}, headerProps, columnContext)
          ),
        bodyTable,
        summaryNode &&
          /*#__PURE__*/ React.createElement(
            ...
            _defineProperty(
              _defineProperty(
                _defineProperty(
                  ...
                  "".concat(prefixCls, "-fixed-column-gapped"),
                  fixColumn && hasGapFixed
                ),
