...
var BodyLine = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  if (rowSupportExpand && expanded) {
    ...
    var expandedClsName = computedExpandedClassName(
    ...
    expandRowNode = /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        Cell,
        {
          ...
          className: classNames(
            rowCellCls,
            _defineProperty({}, "".concat(rowCellCls, "-fixed"), fixColumn)
          ),
  ...
  var rowNode = /*#__PURE__*/ React.createElement(
    RowComponent,
    _extends({}, rowProps, restProps, {
      ...
      className: classNames(
        ...
        _defineProperty({}, "".concat(prefixCls, "-row-extra"), extra)
      ),
      style: _objectSpread(
        _objectSpread({}, rowStyle),
        rowProps === null || rowProps === void 0 ? void 0 : rowProps.style
      ),
    }),
