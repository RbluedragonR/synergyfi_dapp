...
function VirtualCell(props) {
  ...
  var mergedStyle = _objectSpread(
    _objectSpread(_objectSpread({}, cellStyle), style),
    {},
    {
  ...
  if (needHide) {
    ...
    mergedStyle.height =
      getHeight === null || getHeight === void 0 ? void 0 : getHeight(rowSpan);
  }
  var mergedRender = needHide
    ? function () {
        return null;
      }
    : render;
    ...
    _extends(
      ...
      fixedInfo,
      {
        ...
        additionalProps: _objectSpread(
          _objectSpread({}, additionalCellProps),
          {},
          {
            style: mergedStyle,
          },
