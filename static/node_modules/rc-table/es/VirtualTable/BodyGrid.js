...
var Grid = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  // =========================== Data ===========================
  var flattenData = useFlattenRecords(
    data,
    childrenColumnName,
    expandedKeys,
    getRowKey
  ...
  var columnsOffset = React.useMemo(
    function () {
    ...
    var obj = {
      scrollTo: function scrollTo(config) {
        ...
        (_listRef$current = listRef.current) === null ||
          ...
          _listRef$current.scrollTo(config);
      },
      nativeElement:
        (_listRef$current2 = listRef.current) === null ||
        _listRef$current2 === void 0
          ? void 0
          : _listRef$current2.nativeElement,
    };
      ...
      get: function get() {
        ...
        return (
          ...
          _listRef$current3 === void 0
            ? void 0
            : _listRef$current3.getScrollInfo().x) || 0
        );
      },
      set: function set(value) {
        var _listRef$current4;
        (_listRef$current4 = listRef.current) === null ||
          _listRef$current4 === void 0 ||
          _listRef$current4.scrollTo({
            left: value,
          });
      },
    });
  ...
  var getRowSpan = function getRowSpan(column, index) {
    ...
    var record =
      (_flattenData$index = flattenData[index]) === null ||
      _flattenData$index === void 0
        ? void 0
        : _flattenData$index.record;
    var onCell = column.onCell;
    if (onCell) {
      var _cellProps$rowSpan;
      var cellProps = onCell(record, index);
      return (_cellProps$rowSpan =
        cellProps === null || cellProps === void 0
          ? void 0
          : cellProps.rowSpan) !== null && _cellProps$rowSpan !== void 0
        ? _cellProps$rowSpan
        : 1;
    }
    return 1;
  ...
  var extraRender = function extraRender(info) {
    ...
    var _loop3 = function _loop3(_i2) {
      ...
      if (
        flattenColumns.some(function (column) {
    ...
    var nodes = spanLines.map(function (index) {
      ...
      var getHeight = function getHeight(rowSpan) {
        ...
        var endItemKey = getRowKey(
          flattenData[endItemIndex].record,
          endItemIndex
        );
    ...
    /*#__PURE__*/ React.createElement(
      VirtualList,
      {
        ...
        onVirtualScroll: function onVirtualScroll(_ref4) {
          ...
          onScroll({
            currentTarget:
              (_listRef$current5 = listRef.current) === null ||
              _listRef$current5 === void 0
                ? void 0
                : _listRef$current5.nativeElement,
            scrollLeft: x,
          });
        },
