...
var FixedHolder = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  React.useEffect(function () {
    ...
    return function () {
      ...
      (_scrollRef$current2 = scrollRef.current) === null ||
        _scrollRef$current2 === void 0 ||
  ...
  var columnsWithScrollbar = useMemo(
    function () {
      return combinationScrollBarSize
        ? [].concat(_toConsumableArray(columns), [ScrollBarColumn])
        : columns;
    },
    [combinationScrollBarSize, columns]
  );
  var flattenColumnsWithScrollbar = useMemo(
    function () {
      return combinationScrollBarSize
  ...
  var headerStickyOffsets = useMemo(
    function () {
  ...
  return /*#__PURE__*/ React.createElement(
    "div",
    {
      ...
      className: classNames(
        className,
        _defineProperty({}, stickyClassName, !!stickyClassName)
      ),
    },
      ...
      (!noData || !maxContentScroll || allFlattenColumnsWithWidth) &&
        /*#__PURE__*/ React.createElement(ColGroup, {
          colWidths: mergedColumnWidth
            ? [].concat(_toConsumableArray(mergedColumnWidth), [
