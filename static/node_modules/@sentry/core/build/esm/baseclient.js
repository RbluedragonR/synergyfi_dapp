...
import {
  ...
  SyncPromise,
  rejectedSyncPromise,
} from "./utils-hoist/syncpromise.js";
...
class BaseClient {
  ...
  constructor(options) {
    ...
    const undefinedOption = tracingOptions.find(
      (option) => option in options && options[option] == undefined
    );
    if (undefinedOption) {
      consoleSandbox(() => {
