          ...
          arr.forEach(function (r) {
            ...
            if (typeof rule.transform === "function") {
              ...
              if (value !== undefined && value !== null) {
                rule.type =
                  rule.type ||
                  (Array.isArray(value) ? "array" : _typeof(value));
              }
            }
          ...
          function (data, doIt) {
              ...
              return _objectSpread(
                ...
                {},
                {
                  ...
                  fullFields: rule.fullFields
                    ? [].concat(_toConsumableArray(rule.fullFields), [key])
                    : [key],
                }
              );
            }
                  ...
                  function (errs) {
                    ...
                    if (filledErrors && filledErrors.length) {
                      finalErrors.push.apply(
                        finalErrors,
                        _toConsumableArray(filledErrors)
                      );
                    }
                    if (errs && errs.length) {
                      finalErrors.push.apply(
                        finalErrors,
                        _toConsumableArray(errs)
                      );
                    }
            ...
            if (rule.asyncValidator) {
              ...
              try {
                ...
                (_console$error = (_console = console).error) === null ||
                  _console$error === void 0 ||
              ...
              if (res === true) {
                ...
                cb(
                  typeof rule.message === "function"
                    ...
                    : rule.message ||
                        "".concat(rule.fullField || rule.field, " fails")
                );
