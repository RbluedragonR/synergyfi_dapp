...
export default function createImmutable() {
  ...
  function makeImmutable(Component, shouldTriggerRender) {
    ...
    if (process.env.NODE_ENV !== "production") {
      ImmutableComponent.displayName = "ImmutableRoot(".concat(
        Component.displayName || Component.name,
        ")"
      );
    }
    return refAble
      ? /*#__PURE__*/ React.forwardRef(ImmutableComponent)
      : ImmutableComponent;
  }
  ...
  function responseImmutable(Component, propsAreEqual) {
    ...
    if (process.env.NODE_ENV !== "production") {
      ImmutableComponent.displayName = "ImmutableResponse(".concat(
        Component.displayName || Component.name,
        ")"
      );
    }
    return refAble
      ...
      : /*#__PURE__*/ React.memo(ImmutableComponent, propsAreEqual);
  }
  return {
