const t = (t) => "object" == typeof t && null != t && 1 === t.nodeType,
  ...
  l = (e, l) => {
    ...
    const H =
        null != (d = null == (r = window.visualViewport) ? void 0 : r.width)
          ? d
          : innerWidth,
      b =
        null != (h = null == (s = window.visualViewport) ? void 0 : s.height)
          ? h
          : innerHeight,
        ...
        (B =
          ...
          (D =
            "start" === u
              ...
              : "end" === u
              ? V - r + m + L
              : o(s, r, i, a, m + L, V, V + M, M));
        const { scrollLeft: t, scrollTop: h } = e;
        (B = Math.max(0, Math.min(h + B / Y, e.scrollHeight - n / Y + S))),
          (D = Math.max(0, Math.min(t + D / X, e.scrollWidth - i / X + L))),
          (T += h - B),
          (V += t - D);
      }
      k.push({ el: e, top: B, left: D });
    }
    return k;
  };
export { l as compute };
