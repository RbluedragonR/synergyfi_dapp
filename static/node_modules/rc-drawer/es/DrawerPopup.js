...
function DrawerPopup(props, ref) {
      ...
      case KeyCode.TAB: {
        if (keyCode === KeyCode.TAB) {
          if (!shiftKey && document.activeElement === sentinelEndRef.current) {
            ...
            (_sentinelStartRef$cur = sentinelStartRef.current) === null ||
              _sentinelStartRef$cur === void 0 ||
            ...
            (_sentinelEndRef$curre = sentinelEndRef.current) === null ||
              _sentinelEndRef$curre === void 0 ||
  ...
  React.useEffect(
    function () {
      if (open && autoFocus) {
        ...
        (_panelRef$current = panelRef.current) === null ||
          _panelRef$current === void 0 ||
  ...
  var pushDistance =
    (_ref =
      (_pushConfig$distance =
        (_pushConfig = pushConfig) === null || _pushConfig === void 0
          ? void 0
          : _pushConfig.distance) !== null && _pushConfig$distance !== void 0
        ? _pushConfig$distance
      ...
      ? _ref
      : 180;
  var mergedContext = React.useMemo(
    function () {
      return {
    ...
    function () {
      if (open) {
        ...
        parentContext === null ||
          ...
          (_parentContext$push = parentContext.push) === null ||
          _parentContext$push === void 0 ||
          _parentContext$push.call(parentContext);
      } else {
        var _parentContext$pull;
        parentContext === null ||
          parentContext === void 0 ||
          (_parentContext$pull = parentContext.pull) === null ||
          _parentContext$pull === void 0 ||
  ...
  React.useEffect(function () {
    return function () {
      ...
      parentContext === null ||
        parentContext === void 0 ||
        (_parentContext$pull2 = parentContext.pull) === null ||
        _parentContext$pull2 === void 0 ||
      ...
      function (_ref2, maskRef) {
        ...
        return /*#__PURE__*/ React.createElement("div", {
          className: classNames(
            ...
            motionMaskClassName,
            drawerClassNames === null || drawerClassNames === void 0
              ? void 0
              : drawerClassNames.mask,
            maskClassName
          ),
          style: _objectSpread(
            _objectSpread(_objectSpread({}, motionMaskStyle), maskStyle),
  ...
  var panelNode = /*#__PURE__*/ React.createElement(
    CSSMotion,
    _extends(
      {
        key: "panel",
        ...
        _extends(
          {
            ...
            style: _objectSpread(
              _objectSpread(_objectSpread({}, wrapperStyle), motionStyle),
    ...
    /*#__PURE__*/ React.createElement(
      "div",
      {
        className: classNames(
          ...
          rootClassName,
          _defineProperty(
            _defineProperty({}, "".concat(prefixCls, "-open"), open),
            "".concat(prefixCls, "-inline"),
            inline
          )
        ),
