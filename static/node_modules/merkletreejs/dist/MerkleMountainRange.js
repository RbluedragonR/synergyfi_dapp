...
class MerkleMountainRange extends Base_1.default {
  ...
  append(data) {
    ...
    if (
      !this.data[dataHashHex] ||
      this.bufferToHex(this.hashFn(this.data[dataHashHex])) !== dataHashHex
    ) {
  ...
  hashLeaf(index, dataHash) {
    ...
    return this.hashFn(
      buffer_1.Buffer.concat([this.bufferify(index), dataHash])
    );
  }
  /**
  ...
  rollUp(root, width, peaks, itemHashes) {
    ...
    return this.peakBagging(
      tmpWidth,
      this.peakMapToPeaks(tmpWidth, tmpPeakMap)
    );
  }
  /**
