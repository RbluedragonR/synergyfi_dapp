    ...
    [`&${componentCls}-simple ${componentCls}-simple-pager`]: {
      ...
      input: {
        ...
        "&:focus": {
          ...
          boxShadow: `${unit(token.inputOutlineOffset)} 0 ${unit(
  ...
  return {
    ...
    [`${componentCls}-options`]: {
      ...
      "&-quick-jumper": {
        ...
        input: Object.assign(
          Object.assign(
            Object.assign({}, genBasicInputStyle(token)),
...
const genPaginationFocusStyle = (token) => {
  ...
  return {
    [`${componentCls}:not(${componentCls}-disabled)`]: {
      ...
      [`${componentCls}-prev, ${componentCls}-next`]: {
        [`&:focus-visible ${componentCls}-item-link`]: Object.assign(
          {},
          genFocusOutline(token)
        ),
      },
...
export const prepareToken = (token) =>
  mergeToken(
    token,
    {
      ...
      paginationMiniOptionsMarginInlineStart: token
        .calc(token.marginXXS)
        .div(2)
        .equal(),
      paginationMiniQuickJumperInputWidth: token
        .calc(token.controlHeightLG)
        .mul(1.1)
        .equal(),
      paginationItemPaddingInline: token.calc(token.marginXXS).mul(1.5).equal(),
      paginationEllipsisLetterSpacing: token
        .calc(token.marginXXS)
        .div(2)
        .equal(),
