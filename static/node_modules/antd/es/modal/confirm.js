...
const ConfirmDialogWrapper = (props) => {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    Object.assign({}, props, {
      ...
      locale:
        (_b =
          (_a = config.locale) === null || _a === void 0
            ? void 0
            : _a.Modal) !== null && _b !== void 0
          ? _b
          : runtimeLocale,
...
export default function confirm(config) {
  ...
  function destroy() {
    ...
    if (triggerCancel) {
      var _a2;
      (_a = config.onCancel) === null || _a === void 0
        ? void 0
        : (_a2 = _a).call.apply(
            _a2,
            [config, () => {}].concat(_toConsumableArray(args.slice(1)))
          );
    }
