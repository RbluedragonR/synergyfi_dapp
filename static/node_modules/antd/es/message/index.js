...
const GlobalHolder = /*#__PURE__*/ React.forwardRef((props, ref) => {
  ...
  const [api, holder] = useInternalMessage(
    Object.assign(
      Object.assign(Object.assign({}, messageConfig), {
        prefixCls,
      }),
      appConfig.message
    )
...
function flushNotice() {
  if (!message) {
    ...
    act(() => {
      render(
        /*#__PURE__*/ React.createElement(GlobalHolderWrapper, {
          ref: (node) => {
      ...
      switch (type) {
        case "open": {
          act(() => {
            const closeFn = message.instance.open(
              Object.assign(Object.assign({}, defaultGlobalConfig), task.config)
            );
            closeFn === null || closeFn === void 0
              ? void 0
        ...
        default: {
          act(() => {
            ...
            const closeFn = (_message$instance = message.instance)[type].apply(
              _message$instance,
              _toConsumableArray(task.args)
            );
            closeFn === null || closeFn === void 0
              ? void 0
              : closeFn.then(task.resolve);
...
function setMessageGlobalConfig(config) {
  ...
  act(() => {
    var _a;
    (_a = message === null || message === void 0 ? void 0 : message.sync) ===
      null || _a === void 0
      ? void 0
      : _a.call(message);
  });
