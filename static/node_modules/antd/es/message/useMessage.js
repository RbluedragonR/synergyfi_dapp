...
const Holder = /*#__PURE__*/ React.forwardRef((props, ref) => {
  ...
  const { getPrefixCls, getPopupContainer, message, direction } =
  ...
  // ============================ Close Icon =============================
  const mergedCloseIcon = /*#__PURE__*/ React.createElement(
    "span",
    {
...
export function useInternalMessage(messageConfig) {
  ...
  const wrapAPI = React.useMemo(() => {
    ...
    const open = (config) => {
      ...
      const { content, icon, type, key, className, style, onClose } = config,
      ...
      return wrapPromiseFn((resolve) => {
        originOpen(
          Object.assign(Object.assign({}, restConfig), {
            key: mergedKey,
            ...
            style: Object.assign(
              Object.assign(
                {},
                message === null || message === void 0 ? void 0 : message.style
              ),
              style
            ),
            onClose: () => {
