...
const Progress = /*#__PURE__*/ React.forwardRef((props, ref) => {
  ...
  const percentNumber = React.useMemo(() => {
    ...
    return parseInt(
      successPercent !== undefined
        ? (_a =
            successPercent !== null && successPercent !== void 0
              ? successPercent
              : 0) === null || _a === void 0
          ? void 0
          : _a.toString()
        : (_b = percent !== null && percent !== void 0 ? percent : 0) ===
            null || _b === void 0
        ? void 0
        : _b.toString(),
      10
  ...
  const progressInfo = React.useMemo(() => {
    ...
    if (
      ...
      text = isLineType
        ? /*#__PURE__*/ React.createElement(CheckCircleFilled, null)
  ...
  if (type === "line") {
    ...
    progress = /*#__PURE__*/ React.createElement(
      Circle,
      Object.assign({}, props, {
        strokeColor: strokeColorNotArray,
        prefixCls: prefixCls,
  ...
  const classString = classNames(
    ...
    `${prefixCls}-status-${progressStatus}`,
    {
      [`${prefixCls}-${(type === "dashboard" && "circle") || type}`]:
        type !== "line",
      [`${prefixCls}-inline-circle`]:
        type === "circle" && getSize(size, "circle")[0] <= 20,
    ...
    progressStyle === null || progressStyle === void 0
      ? void 0
