...
export const getSize = (size, type, extra) => {
  ...
  if (type === "step") {
    ...
    if (typeof size === "string" || typeof size === "undefined") {
      ...
      [width = 14, height = 8] = Array.isArray(size)
        ? size
    ...
    const strokeWidth =
      extra === null || extra === void 0 ? void 0 : extra.strokeWidth;
    if (typeof size === "string" || typeof size === "undefined") {
      height = strokeWidth || (size === "small" ? 6 : 8);
    } else if (typeof size === "number") {
      [width, height] = [size, size];
    } else {
      [width = -1, height = 8] = Array.isArray(size)
        ? size
        : [size.width, size.height];
    }
    ...
    if (typeof size === "string" || typeof size === "undefined") {
      ...
      width =
        (_b = (_a = size[0]) !== null && _a !== void 0 ? _a : size[1]) !==
          null && _b !== void 0
          ? _b
          : 120;
      height =
        (_d = (_c = size[0]) !== null && _c !== void 0 ? _c : size[1]) !==
          null && _d !== void 0
          ? _d
          : 120;
    }
