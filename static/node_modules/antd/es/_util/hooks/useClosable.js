...
function useClosableConfig(closableCollection) {
  ...
  return React.useMemo(() => {
    ...
    if (closable && typeof closable === "object") {
      closableConfig = Object.assign(
        Object.assign({}, closableConfig),
        closable
      );
    }
...
function assignWithoutUndefined() {
  const target = {};
  for (
    var _len = arguments.length, objList = new Array(_len), _key = 0;
    _key < _len;
    _key++
  ) {
...
export default function useClosable(
  ...
  const closeBtnIsDisabled =
    typeof propCloseConfig !== "boolean"
      ? !!(propCloseConfig === null || propCloseConfig === void 0
          ? void 0
          : propCloseConfig.disabled)
      : false;
  ...
  const mergedClosableConfig = React.useMemo(() => {
    ...
    // ============= Fallback Default ==============
    return !mergedFallbackCloseCollection.closable
      ? false
      : mergedFallbackCloseCollection;
  ...
  return React.useMemo(() => {
    ...
    if (mergedCloseIcon !== null && mergedCloseIcon !== undefined) {
      ...
      if (Object.keys(ariaProps).length) {
        mergedCloseIcon = /*#__PURE__*/ React.isValidElement(mergedCloseIcon)
          ? /*#__PURE__*/ React.cloneElement(mergedCloseIcon, ariaProps)
          : /*#__PURE__*/ React.createElement(
              "span",
              Object.assign({}, ariaProps),
              mergedCloseIcon
            );
      }
    }
