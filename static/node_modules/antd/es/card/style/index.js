    ...
    Object.assign(
      {
        ...
        borderBottom: `${unit(token.lineWidth)} ${token.lineType} ${
...
const genCardGridStyle = (token) => {
  const { cardPaddingBase, colorBorderSecondary, cardShadow, lineWidth } =
    token;
  return {
    width: "33.33%",
    ...
    Object.assign(
      {
        ...
        borderTop: `${unit(token.lineWidth)} ${
          token.lineType
        } ${colorBorderSecondary}`,
        display: "flex",
      ...
      "& > li": {
        ...
        "> span": {
          ...
          [`> ${iconCls}`]: {
            ...
            lineHeight: unit(
              token.calc(cardActionsIconSize).mul(token.lineHeight).equal()
            ),
          },
        },
        "&:not(:last-child)": {
          borderInlineEnd: `${unit(token.lineWidth)} ${
            token.lineType
          } ${colorBorderSecondary}`,
        },
      },
...
const genCardSizeStyle = (token) => {
  const { componentCls, cardPaddingSM, headerHeightSM, headerFontSizeSM } =
    token;
  return {
    [`${componentCls}-small`]: {
      [`> ${componentCls}-head`]: {
