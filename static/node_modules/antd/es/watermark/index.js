...
const Watermark = (props) => {
  ...
  const offsetLeft =
    (_a = offset === null || offset === void 0 ? void 0 : offset[0]) !== null &&
    _a !== void 0
      ? _a
      : gapXCenter;
  const offsetTop =
    (_b = offset === null || offset === void 0 ? void 0 : offset[1]) !== null &&
    _b !== void 0
      ? _b
      : gapYCenter;
  ...
  const getMarkSize = (ctx) => {
    ...
    if (!image && ctx.measureText) {
      ...
      defaultWidth = Math.ceil(
        Math.max.apply(Math, _toConsumableArray(sizes.map((size) => size[0])))
      );
      defaultHeight =
        Math.ceil(
          Math.max.apply(Math, _toConsumableArray(sizes.map((size) => size[1])))
        ) *
          contents.length +
        (contents.length - 1) * FontGap;
    }
    return [
      width !== null && width !== void 0 ? width : defaultWidth,
      height !== null && height !== void 0 ? height : defaultHeight,
    ];
  };
