...
export const genImageMaskStyle = (token) => {
  ...
  return {
    ...
    [`.${prefixCls}-mask-info`]: Object.assign(
...
export const genPreviewSwitchStyle = (token) => {
  ...
  return {
    [`${previewCls}-switch-left, ${previewCls}-switch-right`]: {
      ...
      marginTop: token
        .calc(token.imagePreviewSwitchSize)
        .mul(-1)
        .div(2)
        .equal(),
      color: token.previewOperationColor,
  ...
  return [
    {
      [`${componentCls}-preview-root`]: {
        ...
        [`${previewCls}-body`]: Object.assign(
          Object.assign({}, genBoxStyle()),
          {
            overflow: "hidden",
          }
        ),
...
export const prepareComponentToken = (token) => ({
  ...
  previewOperationColor: new TinyColor(token.colorTextLightSolid)
    .setAlpha(0.65)
    .toRgbString(),
