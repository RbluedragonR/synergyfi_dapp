...
const Image = (props) => {
  ...
  const mergedClassName = classNames(
    className,
    hashId,
    image === null || image === void 0 ? void 0 : image.className
  );
  ...
  const mergedPreview = React.useMemo(() => {
    ...
    const { getContainer, closeIcon, rootClassName } = _preview,
      restPreviewProps = __rest(_preview, [
        "getContainer",
        "closeIcon",
        "rootClassName",
      ]);
      ...
      Object.assign(
        {
          mask: /*#__PURE__*/ React.createElement(
            ...
            imageLocale === null || imageLocale === void 0
              ? void 0
              : imageLocale.preview
          ),
          icons,
      ...
      ),
      {
        ...
        closeIcon:
          closeIcon !== null && closeIcon !== void 0
            ? closeIcon
            : (_a =
                image === null || image === void 0 ? void 0 : image.preview) ===
                null || _a === void 0
            ? void 0
            : _a.closeIcon,
      }
    ...
    preview,
    imageLocale,
    (_a = image === null || image === void 0 ? void 0 : image.preview) ===
      null || _a === void 0
      ? void 0
      : _a.closeIcon,
  ]);
  const mergedStyle = Object.assign(
    Object.assign(
      {},
      image === null || image === void 0 ? void 0 : image.style
    ),
    style
  );
  return wrapCSSVar(
