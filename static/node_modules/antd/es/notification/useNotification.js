...
const Holder = /*#__PURE__*/ React.forwardRef((props, ref) => {
  ...
  const { getPrefixCls, getPopupContainer, notification, direction } =
  ...
  const getStyle = (placement) =>
    getPlacementStyle(
      placement,
      top !== null && top !== void 0 ? top : DEFAULT_OFFSET,
      bottom !== null && bottom !== void 0 ? bottom : DEFAULT_OFFSET
    );
  const getClassName = () =>
    classNames({
      [`${prefixCls}-rtl`]:
        rtl !== null && rtl !== void 0 ? rtl : direction === "rtl",
    });
  // ============================== Motion ===============================
  ...
  const [api, holder] = useRcNotification({
    ...
    duration:
      duration !== null && duration !== void 0 ? duration : DEFAULT_DURATION,
    getContainer: () =>
      (staticGetContainer === null || staticGetContainer === void 0
        ? void 0
        : staticGetContainer()) ||
...
export function useInternalNotification(notificationConfig) {
  ...
  const wrapAPI = React.useMemo(() => {
          ...
          Object.assign(
            {
              ...
              placement:
                (_a =
                  notificationConfig === null || notificationConfig === void 0
                    ? void 0
                    : notificationConfig.placement) !== null && _a !== void 0
                  ? _a
                  : DEFAULT_PLACEMENT,
            },
            restConfig
    ...
    const destroy = (key) => {
      var _a, _b;
      if (key !== undefined) {
        (_a = holderRef.current) === null || _a === void 0
          ? void 0
          : _a.close(key);
      } else {
        (_b = holderRef.current) === null || _b === void 0
          ? void 0
          : _b.destroy();
      }
    };
