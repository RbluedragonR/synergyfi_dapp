  ...
  return {
    ...
    [noticeCls]: {
      ...
      maxWidth: `calc(100vw - ${unit(
        token.calc(notificationMarginEdge).mul(2).equal()
      )})`,
      overflow: "hidden",
      lineHeight,
      wordWrap: "break-word",
...
export const prepareNotificationToken = (token) => {
  ...
  const notificationToken = mergeToken(token, {
    ...
    notificationPadding: `${unit(token.paddingMD)} ${unit(
