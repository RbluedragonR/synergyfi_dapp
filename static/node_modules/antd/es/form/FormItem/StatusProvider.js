  ...
  const formItemStatusContext = React.useMemo(() => {
    ...
    if (hasFeedback) {
      ...
      const customIconNode =
        ...
        ((_a =
          customIcons === null || customIcons === void 0
            ? void 0
            : customIcons({
      ...
      feedbackIcon =
        customIconNode !== false && IconNode
          ? /*#__PURE__*/ React.createElement(
              ...
              customIconNode ||
                /*#__PURE__*/ React.createElement(IconNode, null)
            )
          : null;
    }
    const context = {
    ...
    if (noStyle) {
      context.status =
        (mergedValidateStatus !== null && mergedValidateStatus !== void 0
          ? mergedValidateStatus
          : parentStatus) || "";
      context.isFormItemInput = parentIsFormItemInput;
      context.hasFeedback = !!(hasFeedback !== null && hasFeedback !== void 0
        ? hasFeedback
        : parentHasFeedback);
