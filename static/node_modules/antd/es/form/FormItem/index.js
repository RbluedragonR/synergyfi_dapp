...
function InternalFormItem(props) {
  ...
  const onMetaChange = (nextMeta) => {
    ...
    const keyInfo =
      listContext === null || listContext === void 0
        ? void 0
  ...
  const onSubItemMetaChange = (subMeta, uniqueKeys) => {
    ...
    setSubFieldErrors((prevSubFieldErrors) => {
      ...
      const mergedNamePath = [].concat(
        _toConsumableArray(subMeta.name.slice(0, -1)),
        _toConsumableArray(uniqueKeys)
      );
  ...
  const [mergedErrors, mergedWarnings] = React.useMemo(() => {
    ...
    Object.values(subFieldErrors).forEach((subFieldError) => {
      errorList.push.apply(
        errorList,
        _toConsumableArray(subFieldError.errors || [])
      );
      warningList.push.apply(
        warningList,
        _toConsumableArray(subFieldError.warnings || [])
      );
    });
      ...
      (control, renderMeta, context) => {
            ...
            : !!(rules === null || rules === void 0
                ...
                : rules.some((rule) => {
                    ...
                    if (typeof rule === "function") {
                      ...
                      return (
                        (ruleEntity === null || ruleEntity === void 0
                          ? void 0
                          : ruleEntity.required) &&
                        !(ruleEntity === null || ruleEntity === void 0
                          ? void 0
        ...
        if (Array.isArray(mergedChildren) && hasName) {
          ...
          const triggers = new Set(
            [].concat(
              _toConsumableArray(toArray(trigger)),
              _toConsumableArray(toArray(mergedValidateTrigger))
            )
          );
          triggers.forEach((eventName) => {
            childProps[eventName] = function () {
              ...
              (_a = mergedControl[eventName]) === null || _a === void 0
                ? void 0
                : (_a2 = _a).call.apply(_a2, [mergedControl].concat(args));
              (_c = (_b = mergedChildren.props)[eventName]) === null ||
              _c === void 0
                ? void 0
