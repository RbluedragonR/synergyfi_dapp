...
const genSkeletonElementAvatar = (token) => {
  ...
  return {
    ...
    [`${skeletonAvatarCls}${skeletonAvatarCls}-lg`]: Object.assign(
      {},
      genSkeletonElementAvatarSize(controlHeightLG)
    ),
    [`${skeletonAvatarCls}${skeletonAvatarCls}-sm`]: Object.assign(
      {},
...
const genSkeletonElementInput = (token) => {
  ...
  return {
    ...
    [`${skeletonInputCls}-lg`]: Object.assign(
      {},
      genSkeletonElementInputSize(controlHeightLG, calc)
    ),
    [`${skeletonInputCls}-sm`]: Object.assign(
      {},
...
const genSkeletonElementImage = (token) => {
  ...
  return {
    [skeletonImageCls]: Object.assign(
      Object.assign(
        {
          display: "inline-flex",
          alignItems: "center",
      ...
      ),
      {
        ...
        [`${skeletonImageCls}-svg`]: Object.assign(
          Object.assign({}, genSkeletonElementImageSize(imageSizeBase)),
          {
...
const genSkeletonElementButton = (token) => {
  ...
  return Object.assign(
    Object.assign(
      ...
      {
        [`${skeletonButtonCls}-sm`]: Object.assign(
          {},
  ...
  return {
    [componentCls]: {
      ...
      [`${componentCls}-header`]: {
        ...
        [`${skeletonAvatarCls}-lg`]: Object.assign(
          {},
          genSkeletonElementAvatarSize(controlHeightLG)
        ),
        [`${skeletonAvatarCls}-sm`]: Object.assign(
          {},
          genSkeletonElementAvatarSize(controlHeightSM)
        ),
      },
