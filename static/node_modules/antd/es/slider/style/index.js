    ...
    [componentCls]: Object.assign(Object.assign({}, resetComponent(token)), {
      ...
      "&:hover": {
        ...
        [`${componentCls}-handle::after`]: {
          boxShadow: `0 0 0 ${unit(handleLineWidth)} ${
  ...
  const draggableBorder = horizontal
    ...
    : {
        ...
        transform: `translateX(${unit(
          token.calc(draggableBorderSize).mul(-1).equal()
        )})`,
      };
  return {
...
const genHorizontalStyle = (token) => {
  ...
  return {
    [`${componentCls}-horizontal`]: Object.assign(
      Object.assign({}, genDirectionStyle(token, true)),
      {
...
const genVerticalStyle = (token) => {
  ...
  return {
    [`${componentCls}-vertical`]: Object.assign(
      Object.assign({}, genDirectionStyle(token, false)),
      {
        height: "100%",
      }
    ),
...
export const prepareComponentToken = (token) => {
  ...
  const handleActiveOutlineColor = new TinyColor(handleActiveColor)
    .setAlpha(0.2)
    .toRgbString();
  return {
    controlSize,
