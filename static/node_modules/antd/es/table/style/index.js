  ...
  return {
    [`${componentCls}-wrapper`]: Object.assign(
      ...
      ),
      {
        ...
        `]: {
          position: "relative",
          padding: `${unit(tablePaddingVertical)} ${unit(
            tablePaddingHorizontal
          )}`,
          ...
          "> tr": {
            ...
            `]: {
                [componentCls]: {
                  ...
                  marginInline: `${unit(
                    calc(tableExpandColumnWidth)
                      .sub(tablePaddingHorizontal)
                      .equal()
                  )}
