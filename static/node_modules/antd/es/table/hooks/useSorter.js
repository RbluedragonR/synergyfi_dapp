...
const collectSortStates = (columns, init, pos) => {
  ...
  (columns || []).forEach((column, index) => {
    ...
    if (column.children) {
      ...
      sortStates = [].concat(
        _toConsumableArray(sortStates),
        _toConsumableArray(collectSortStates(column.children, init, columnPos))
      );
  ...
  const finalColumns = (columns || []).map((column, index) => {
    ...
    if (newColumn.sorter) {
      ...
      if (column.sortIcon) {
        ...
        sorter = /*#__PURE__*/ React.createElement(
          "span",
          {
      ...
      newColumn = Object.assign(Object.assign({}, newColumn), {
        ...
        title: (renderProps) => {
          ...
          const renderColumnTitleWrapper = /*#__PURE__*/ React.createElement(
            "span",
            {
          ...
          const renderSortTitle = /*#__PURE__*/ React.createElement(
            "div",
            {
          ...
          if (showSorterTooltip) {
            if (
              ...
              (showSorterTooltip === null || showSorterTooltip === void 0
                ? void 0
        ...
        onHeaderCell: (col) => {
          var _a;
          const cell =
            ((_a = column.onHeaderCell) === null || _a === void 0
              ? void 0
              : _a.call(column, col)) || {};
          ...
          cell.onClick = (event) => {
            ...
            originOnClick === null || originOnClick === void 0
              ? void 0
              : originOnClick(event);
          };
          cell.onKeyDown = (event) => {
            if (event.keyCode === KeyCode.ENTER) {
              ...
              originOKeyDown === null || originOKeyDown === void 0
                ? void 0
          ...
          if (column.ellipsis) {
            cell.title = (
              renderTitle !== null && renderTitle !== void 0 ? renderTitle : ""
            ).toString();
          }
          return cell;
        },
...
const generateSorterInfo = (sorterStates) => {
  ...
  if (activeSorters.length === 0 && sorterStates.length) {
    ...
    return Object.assign(
      Object.assign({}, stateToInfo(sorterStates[lastIndex])),
      {
        column: undefined,
        order: undefined,
        field: undefined,
...
const useFilterSorter = (props) => {
  ...
  const columnTitleSorterProps = React.useMemo(() => {
    ...
    return {
      ...
      // Legacy
      sortColumn:
        (_a = sortColumns[0]) === null || _a === void 0 ? void 0 : _a.column,
      sortOrder:
        (_b = sortColumns[0]) === null || _b === void 0 ? void 0 : _b.order,
    };
  }, [mergedSorterStates]);
  const triggerSorter = (sortState) => {
    ...
    if (
      ...
      newSorterStates = [].concat(
        _toConsumableArray(
          mergedSorterStates.filter((_ref6) => {
            let { key } = _ref6;
