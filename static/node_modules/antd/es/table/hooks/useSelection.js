...
const useSelection = (config, rowSelection) => {
  ...
  const { keyEntities } = useMemo(() => {
    ...
    if (preserveSelectedRowKeys) {
      ...
      convertData = [].concat(
        _toConsumableArray(convertData),
        _toConsumableArray(preserveRecords)
      );
    }
  ...
  const isCheckboxDisabled = useCallback(
    (r) => {
      var _a;
      return !!((_a = checkboxPropsMap.get(getRowKey(r))) === null ||
      _a === void 0
        ? void 0
        : _a.disabled);
    },
  ...
  const setSelectedKeys = useCallback(
    (keys, method) => {
      ...
      onSelectionChange === null || onSelectionChange === void 0
        ? void 0
      ...
      .map((selection) => {
              ...
              setSelectedKeys(
                data
                  ...
                  .filter((key) => {
                    ...
                    return (
                      !(checkProps === null || checkProps === void 0
                        ? void 0
        ...
        if (selection === SELECTION_NONE) {
          return {
            ...
            onSelect() {
              onSelectNone === null || onSelectNone === void 0
                ? void 0
                : onSelectNone();
              setSelectedKeys(
                Array.from(derivedSelectedKeySet).filter((key) => {
                  const checkProps = checkboxPropsMap.get(key);
                  return checkProps === null || checkProps === void 0
                    ? void 0
                    : checkProps.disabled;
                }),
                "none"
      ...
      .map((selection) =>
        Object.assign(Object.assign({}, selection), {
          onSelect: function () {
            ...
            (_a = selection.onSelect) === null || _a === void 0
              ? void 0
  ...
  const transformColumns = useCallback(
    (columns) => {
      ...
      const onSelectAllChange = () => {
        ...
        const keys = Array.from(keySet);
        onSelectAll === null || onSelectAll === void 0
          ? void 0
          : onSelectAll(
              !checkedCurrentAll,
      ...
      if (selectionType !== "radio") {
        ...
        if (mergedSelections) {
          const menu = {
            ...
            items: mergedSelections.map((selection, index) => {
              ...
              return {
                ...
                onClick: () => {
                  onSelectionClick === null || onSelectionClick === void 0
                    ? void 0
          ...
          customizeSelections = /*#__PURE__*/ React.createElement(
            "div",
            {
      ...
      if (selectionType === "radio") {
            ...
            node: /*#__PURE__*/ React.createElement(
              ...
              Object.assign({}, checkboxProps, {
                ...
                onClick: (e) => {
                  ...
                  e.stopPropagation();
                  (_a =
                    checkboxProps === null || checkboxProps === void 0
                      ? void 0
                      : checkboxProps.onClick) === null || _a === void 0
                    ? void 0
                ...
                onChange: (event) => {
                  ...
                  (_a =
                    checkboxProps === null || checkboxProps === void 0
                      ? void 0
                      : checkboxProps.onChange) === null || _a === void 0
                    ? void 0
        ...
        renderCell = (_, record, index) => {
          ...
          if (expandType === "nest") {
            ...
            process.env.NODE_ENV !== "production"
              ? warning(
                  typeof (checkboxProps === null || checkboxProps === void 0
                    ? void 0
            ...
            mergedIndeterminate =
              (_a =
                checkboxProps === null || checkboxProps === void 0
                  ? void 0
                  : checkboxProps.indeterminate) !== null && _a !== void 0
                ? _a
                : indeterminate;
          }
          // Record checked
              ...
              Object.assign({}, checkboxProps, {
                ...
                onChange: (event) => {
                  ...
                  if (shiftKey && checkStrictly && isMultiple) {
                    ...
                    const keys = Array.from(keySet);
                    onSelectMultiple === null || onSelectMultiple === void 0
                      ? void 0
                      : onSelectMultiple(
                          !checked,
                    ...
                    if (checkStrictly) {
                      ...
                      const result = conductCheck(
                        [].concat(_toConsumableArray(originCheckedKeys), [key]),
                        true,
                        keyEntities,
                        isCheckboxDisabled
                      );
      ...
      if (!cloneColumns.includes(SELECTION_COLUMN)) {
        ...
        if (
          cloneColumns.findIndex((col) => {
            var _a;
            return (
              ((_a = col[INTERNAL_COL_DEFINE]) === null || _a === void 0
                ? void 0
                : _a.columnType) === "EXPAND_COLUMN"
            );
          }) === 0
        ) {
          const [expandColumn, ...restColumns] = cloneColumns;
          cloneColumns = [expandColumn, SELECTION_COLUMN].concat(
            _toConsumableArray(restColumns)
          );
        } else {
          // Normal insert at first column
          cloneColumns = [SELECTION_COLUMN].concat(
            _toConsumableArray(cloneColumns)
          );
        }
      }
      ...
      if (mergedFixed === undefined) {
        if (
          (nextCol === null || nextCol === void 0 ? void 0 : nextCol.fixed) !==
          undefined
        ) {
          mergedFixed = nextCol.fixed;
        } else if (
          (prevCol === null || prevCol === void 0 ? void 0 : prevCol.fixed) !==
          undefined
        ) {
      ...
      if (
        mergedFixed &&
        prevCol &&
        ((_a = prevCol[INTERNAL_COL_DEFINE]) === null || _a === void 0
          ? void 0
          : _a.columnType) === "EXPAND_COLUMN" &&
