...
const InternalTable = (props, ref) => {
  ...
  const tableLocale = Object.assign(
  ...
  const mergedExpandable = Object.assign(
    ...
    ),
    {
      expandIcon:
        (_a =
          expandable === null || expandable === void 0
            ? void 0
            : expandable.expandIcon) !== null && _a !== void 0
          ? _a
          : (_b =
              table === null || table === void 0
                ? void 0
                : table.expandable) === null || _b === void 0
          ? void 0
          : _b.expandIcon,
    }
  );
  ...
  const expandType = React.useMemo(() => {
    if (
      rawData.some((item) =>
        item === null || item === void 0 ? void 0 : item[childrenColumnName]
      )
    ) {
      return "nest";
    }
  ...
  const getRowKey = React.useMemo(() => {
    ...
    return (record) =>
      record === null || record === void 0 ? void 0 : record[rowKey];
  }, [rowKey]);
  ...
  const triggerOnChange = function (info, action) {
    ...
    if (reset) {
      (_a = changeEventInfo.resetPagination) === null || _a === void 0
        ? void 0
        : _a.call(changeEventInfo);
      // Reset event param
      if (
        (_b = changeInfo.pagination) === null || _b === void 0
          ? void 0
          : _b.current
      ) {
      ...
      if (pagination) {
        (_c = pagination.onChange) === null || _c === void 0
          ? void 0
          : _c.call(
              pagination,
              1,
              (_d = changeInfo.pagination) === null || _d === void 0
                ? void 0
                : _d.pageSize
            );
      }
  ...
  const pageData = React.useMemo(() => {
    ...
    !!pagination,
    mergedData,
    mergedPagination === null || mergedPagination === void 0
      ? void 0
  ...
  const wrapperClassNames = classNames(
    ...
    rootCls,
    `${prefixCls}-wrapper`,
    table === null || table === void 0 ? void 0 : table.className,
    {
  ...
  const emptyText =
    typeof (locale === null || locale === void 0
      ? void 0
