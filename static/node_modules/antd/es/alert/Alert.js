...
const Alert = /*#__PURE__*/ React.forwardRef((props, ref) => {
  ...
  const isClosable = React.useMemo(() => {
    ...
    closeIcon,
    closable,
    alert === null || alert === void 0 ? void 0 : alert.closable,
  ]);
  ...
  const alertCls = classNames(
    ...
    alert === null || alert === void 0 ? void 0 : alert.className,
    className,
    rootClassName,
    cssVarCls,
    hashId
  ...
  const mergedCloseIcon = React.useMemo(() => {
    ...
    if (
      typeof (alert === null || alert === void 0 ? void 0 : alert.closable) ===
        "object" &&
      ((_a = alert === null || alert === void 0 ? void 0 : alert.closable) ===
        null || _a === void 0
        ? void 0
        : _a.closeIcon)
    ) {
    ...
    closable,
    closeText,
    alert === null || alert === void 0 ? void 0 : alert.closeIcon,
  ]);
  const mergedAriaProps = React.useMemo(() => {
    const merged =
      closable !== null && closable !== void 0
        ? closable
        : alert === null || alert === void 0
        ? void 0
        : alert.closable;
    ...
    /*#__PURE__*/ React.createElement(
      ...
      (_ref, setRef) => {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          Object.assign(
            {
              ...
              style: Object.assign(
                Object.assign(
                  Object.assign(
                    {},
                    alert === null || alert === void 0 ? void 0 : alert.style
                  ),
                  style
                ),
                motionStyle
          ...
          isShowIcon
            ? /*#__PURE__*/ React.createElement(IconNode, {
          ...
          action
            ...
            : null,
          /*#__PURE__*/ React.createElement(CloseIconNode, {
