...
const genItemStyle = (token) => {
  const { optionHeight, optionFontSize, optionLineHeight, optionPadding } =
    token;
  return {
    position: "relative",
    display: "block",
  ...
  return [
    {
      [`${componentCls}-dropdown`]: Object.assign(
        ...
        `]: {
          ...
          [selectItemCls]: Object.assign(
            Object.assign({}, genItemStyle(token)),
            {
              cursor: "pointer",
              ...
              "&-option": {
                ...
                "&-grouped": {
                  paddingInlineStart: token
                    .calc(token.controlPaddingHorizontal)
                    .mul(2)
                    .equal(),
                },
              },
