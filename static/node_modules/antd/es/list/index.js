...
function InternalList(_a, ref) {
  ...
  const { getPrefixCls, renderEmpty, direction, list } =
    ...
    if (pagination) {
      (_a =
        pagination === null || pagination === void 0
          ? void 0
          : pagination[eventName]) === null || _a === void 0
        ? void 0
        : _a.call(pagination, page, pageSize);
    }
  };
  ...
  const isLoading = !!(loadingProp === null || loadingProp === void 0
    ? void 0
    : loadingProp.spinning);
  ...
  const classString = classNames(
    ...
    list === null || list === void 0 ? void 0 : list.className,
    className,
    rootClassName,
    hashId,
    cssVarCls
  ...
  if (splitDataSource.length > 0) {
    ...
    childrenContent = /*#__PURE__*/ React.createElement(
      "div",
      {
        className: `${prefixCls}-empty-text`,
      },
      (locale === null || locale === void 0 ? void 0 : locale.emptyText) ||
        ...
        Object.assign(
          {
            ...
            style: Object.assign(
              Object.assign(
                {},
                list === null || list === void 0 ? void 0 : list.style
              ),
              style
            ),
