...
function getIcon(props) {
  ...
  return expanded
    ? /*#__PURE__*/ React.createElement(FolderOpenOutlined, null)
...
const DirectoryTree = (_a, ref) => {
  ...
  const onExpand = (keys, info) => {
    ...
    return (_a = props.onExpand) === null || _a === void 0
      ? void 0
  ...
  const onSelect = (keys, event) => {
    ...
    const ctrlPick =
      (nativeEvent === null || nativeEvent === void 0
        ? void 0
        : nativeEvent.ctrlKey) ||
      (nativeEvent === null || nativeEvent === void 0
        ? void 0
    ...
    if (multiple && ctrlPick) {
      ...
      newSelectedKeys = Array.from(
        new Set(
          [].concat(
            _toConsumableArray(cachedSelectedKeys.current || []),
            _toConsumableArray(
              calcRangeKeys({
                treeData,
                expandedKeys,
