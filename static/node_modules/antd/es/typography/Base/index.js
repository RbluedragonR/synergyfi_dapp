...
const Base = /*#__PURE__*/ React.forwardRef((props, ref) => {
  ...
  const triggerEdit = (edit) => {
    var _a;
    if (edit) {
      (_a = editConfig.onStart) === null || _a === void 0
        ? void 0
        : _a.call(editConfig);
    }
    setEditing(edit);
  ...
  useLayoutEffect(() => {
    ...
    if (!editing && prevEditing) {
      (_a = editIconRef.current) === null || _a === void 0
        ? void 0
        : _a.focus();
    }
  }, [editing]);
  ...
  const onEditChange = (value) => {
    var _a;
    (_a = editConfig.onChange) === null || _a === void 0
      ? void 0
      : _a.call(editConfig, value);
    triggerEdit(false);
  };
  const onEditCancel = () => {
    var _a;
    (_a = editConfig.onCancel) === null || _a === void 0
      ? void 0
      : _a.call(editConfig);
    triggerEdit(false);
  };
  ...
  const [isTextOverflowSupport, setIsTextOverflowSupport] =
  ...
  const [enableEllipsis, ellipsisConfig] = useMergedConfig(ellipsis, {
    ...
    symbol: (isExpanded) =>
      isExpanded
        ? textLocale === null || textLocale === void 0
          ? void 0
          : textLocale.collapse
        : textLocale === null || textLocale === void 0
        ? void 0
  ...
  const onExpandClick = (e, info) => {
    ...
    (_a = ellipsisConfig.onExpand) === null || _a === void 0
      ? void 0
      : _a.call(ellipsisConfig, e, info);
  };
  ...
  const onJsEllipsis = (jsEllipsis) => {
    ...
    if (isJsEllipsis !== jsEllipsis) {
      (_a = ellipsisConfig.onEllipsis) === null || _a === void 0
        ? void 0
        : _a.call(ellipsisConfig, jsEllipsis);
    }
  };
  // >>>>> Native ellipsis
  React.useEffect(() => {
  ...
  const topAriaLabel = React.useMemo(() => {
    ...
    return [editConfig.text, children, title, tooltipProps.title].find(
      isValidText
    );
  }, [
    enableEllipsis,
  ...
  if (editing) {
    return /*#__PURE__*/ React.createElement(Editable, {
      value:
        (_a = editConfig.text) !== null && _a !== void 0
          ? _a
  ...
  const renderEdit = () => {
    ...
    const editTitle =
      toArray(tooltip)[0] ||
      (textLocale === null || textLocale === void 0 ? void 0 : textLocale.edit);
          ...
          Object.assign(
            {
              ...
              "aria-label":
                topAriaLabel === null || topAriaLabel === void 0
                  ? void 0
                  : topAriaLabel.toString(),
              title: title,
            },
            textProps
          ),
