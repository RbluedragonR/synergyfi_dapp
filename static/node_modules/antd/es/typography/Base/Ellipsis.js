...
export default function EllipsisMeasure(props) {
  ...
  useLayoutEffect(() => {
    ...
    if (needEllipsis === STATUS_MEASURE_PREPARE) {
      ...
      const isOverflow = !!((_a = needEllipsisRef.current) === null ||
      _a === void 0
        ? void 0
        : _a.isExceed());
      setNeedEllipsis(
      ...
      const baseRowsEllipsisHeight =
        ((_b = needEllipsisRef.current) === null || _b === void 0
          ? void 0
          : _b.getHeight()) || 0;
      ...
      const descRowsEllipsisHeight =
        rows === 1
          ? 0
          : ((_c = descRowsEllipsisRef.current) === null || _c === void 0
              ? void 0
              : _c.getHeight()) || 0;
      const symbolRowEllipsisHeight =
        ((_d = symbolRowEllipsisRef.current) === null || _d === void 0
          ? void 0
          : _d.getHeight()) || 0;
  ...
  useLayoutEffect(() => {
    ...
    if (minIndex !== maxIndex) {
      const midHeight =
        ((_a = cutMidRef.current) === null || _a === void 0
          ? void 0
          : _a.getHeight()) || 0;
    ...
    needEllipsis === STATUS_MEASURE_START &&
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            style: Object.assign(
              Object.assign(Object.assign({}, measureStyle), lineClipStyle),
              {
                WebkitLineClamp: rows,
              }
            ),
