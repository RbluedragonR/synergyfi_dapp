...
const ProviderChildren = (props) => {
  ...
  let childNode = /*#__PURE__*/ React.createElement(
    React.Fragment,
    null,
    /*#__PURE__*/ React.createElement(PropWarning, {
  ...
  const memoTheme = React.useMemo(() => {
    const _a = mergedTheme || {},
      { algorithm, token, components, cssVar } = _a,
    ...
    const mergedToken = Object.assign(
      Object.assign({}, defaultSeedToken),
      token
    );
