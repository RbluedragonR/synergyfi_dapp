...
const MenuItem = (props) => {
  ...
  const renderItemChildren = (inlineCollapsed) => {
    const label =
      children === null || children === void 0 ? void 0 : children[0];
    const wrapNode = /*#__PURE__*/ React.createElement(
      "span",
      {
    ...
    if (
      !icon ||
      /*#__PURE__*/ (React.isValidElement(children) && children.type === "span")
    ) {
      if (
        children &&
        inlineCollapsed &&
  ...
  let returnNode = /*#__PURE__*/ React.createElement(
    Item,
  ...
  if (!disableMenuItemTitleTooltip) {
    returnNode = /*#__PURE__*/ React.createElement(
      Tooltip,
