...
const ColorPresets = (_ref) => {
  ...
  const activeKeys = useMemo(
    () =>
      presetsValue.reduce((acc, preset, index) => {
  ...
  const items = presetsValue.map((preset, index) => {
    ...
    return {
      ...
      children: /*#__PURE__*/ React.createElement(
        ...
        Array.isArray(
          preset === null || preset === void 0 ? void 0 : preset.colors
        ) &&
          ((_a = preset.colors) === null || _a === void 0
            ? void 0
            : _a.length) > 0
