...
const i = window,
  ...
  c = Array.isArray,
  v = (t) =>
    c(t) || "function" == typeof (null == t ? void 0 : t[Symbol.iterator]),
  a = "[ \t\n\f\r]",
  f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  _ = /-->/g,
  m = />/g,
  ...
  for (let i = 0; i < s; i++) {
    ...
    r +=
      u === f
        ? s + h
        : v >= 0
        ? (e.push(d), s.slice(0, v) + o + s.slice(v) + n + w)
        : s + n + (-2 === v ? (e.push(void 0), i) : w);
  }
      ...
      if (1 === h.nodeType) {
        if (h.hasAttributes()) {
          ...
          for (const i of h.getAttributeNames())
            if (i.endsWith(o) || i.startsWith(n)) {
              const s = f[d++];
        ...
        if (h.data === l) v.push({ type: 2, index: r });
        else {
          let t = -1;
          for (; -1 !== (t = h.data.indexOf(n, t + 1)); )
            v.push({ type: 7, index: r }), (t += n.length - 1);
        }
      r++;
    }
  }
  ...
  return (
    (null == r ? void 0 : r.constructor) !== u &&
      ...
      void 0 !== e
        ...
        : (s._$Cl = r)),
    void 0 !== r && (i = S(t, r._$AS(t, i.values), r, e)),
    i
  );
}
class M {
...
class R {
    ...
    const { values: s, _$litType$: e } = t,
      o =
        "number" == typeof e
          ? this._$AC(t)
          : (void 0 === e.el &&
              (e.el = N.createElement(P(e.h, e.h[0]), this.options)),
            e);
  ...
  T(t) {
    ...
    for (const o of t)
      e === i.length
        ? i.push((s = new R(this.k(u()), this.k(u()), this, this.options)))
        : (s = i[e]),
        s._$AI(o),
        e++;
...
class z extends k {
  ...
  _$AI(t, i = this) {
    var s;
    if ((t = null !== (s = S(this, t, i, 0)) && void 0 !== s ? s : A) === T)
      return;
    const e = this._$AH,
      o =
        (t === A && e !== A) ||
