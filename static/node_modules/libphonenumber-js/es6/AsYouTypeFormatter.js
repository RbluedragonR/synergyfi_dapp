  ...
  _createClass(AsYouTypeFormatter, [
          ...
          for (
            ...
            var formattedCompleteNumber = formatCompleteNumber(state, format, {
              ...
              shouldTryNationalPrefixFormattingRule:
                function shouldTryNationalPrefixFormattingRule(format) {
    ...
    },
    {
      ...
      value: function narrowDownMatchingFormats(_ref2) {
        ...
        this.matchingFormats = this.matchingFormats.filter(function (format) {
          return (
            _this2.formatSuits(format, international, nationalPrefix) &&
    ...
    },
    {
      ...
      value: function formatMatches(
        ...
        return new RegExp("^(".concat(leadingDigitsPattern, ")")).test(
          leadingDigits
        );
      },
    },
      ...
      value: function chooseFormat(state) {
        ...
        var _loop = function _loop() {
          ...
          if (!_this3.createTemplateForFormat(format, state)) {
            ...
            _this3.matchingFormats = _this3.matchingFormats.filter(function (
              _
            ) {
              return _ !== format;
            });
    ...
    },
    {
      ...
      value: function getInternationalPrefixBeforeCountryCallingCode(
        _ref3,
        options
      ) {
    ...
    },
    {
      ...
      value: function getTemplateForFormat(format, _ref4) {
        ...
        var nationalNumberDummyDigits = nationalSignificantNumber.replace(
          /\d/g,
          DUMMY_DIGIT
