...
import AsYouTypeParser, {
  extractFormattedDigitsAndPlus,
} from "./AsYouTypeParser.js";
  ...
  _createClass(AsYouType, [
    ...
    },
    {
      ...
      value: function getFullNumber(formattedNationalNumber) {
        ...
        if (this.isInternational()) {
          ...
          return prefix(
            "".concat(callingCode, " ").concat(formattedNationalNumber)
          );
        }
    ...
    },
    {
      ...
      value: function getNonFormattedNationalNumberWithPrefix() {
        ...
        var prefix =
          complexPrefixBeforeNationalSignificantNumber || nationalPrefix;
      ...
      value: function getNumber() {
        ...
        if (country) {
          if (country === this.defaultCountry) {
            ...
            var ambiguousCountries =
              this.metadata.getCountryCodesForCallingCode(_callingCode);

            if (ambiguousCountries.length > 1) {
              var exactCountry = getCountryByNationalNumber(
