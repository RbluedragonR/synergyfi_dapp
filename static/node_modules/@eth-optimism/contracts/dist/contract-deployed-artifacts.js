  ...
  abi: [
    {
      inputs: [
        ...
        { internalType: "address", name: "_finalOwner", type: "address" },
...
const goerli__CanonicalTransactionChain = {
  abi: [
    {
      inputs: [
        {
...
const goerli__ChainStorageContainer_CTC_batches = {
  abi: [
    {
      inputs: [
        {
    ...
    },
    {
      inputs: [
        ...
        { internalType: "bytes27", name: "_globalMetadata", type: "bytes27" },
      ],
    ...
    },
    {
      ...
      outputs: [{ internalType: "bytes27", name: "", type: "bytes27" }],
      stateMutability: "view",
      type: "function",
    },
    {
    ...
    {
      inputs: [
        { internalType: "bytes32", name: "_object", type: "bytes32" },
        { internalType: "bytes27", name: "_globalMetadata", type: "bytes27" },
      ],
      name: "push",
      outputs: [],
    ...
    {
      inputs: [{ internalType: "bytes32", name: "_object", type: "bytes32" }],
      name: "push",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
...
const goerli__ChainStorageContainer_SCC_batches = {
  abi: [
    {
      inputs: [
        {
...
const goerli__ChugSplashDictator = {
  abi: [
    {
      inputs: [
        {
        ...
        { internalType: "bytes32", name: "_messengerSlotKey", type: "bytes32" },
        { internalType: "bytes32", name: "_messengerSlotVal", type: "bytes32" },
        { internalType: "bytes32", name: "_bridgeSlotKey", type: "bytes32" },
        { internalType: "bytes32", name: "_bridgeSlotVal", type: "bytes32" },
      ],
      stateMutability: "nonpayable",
      type: "constructor",
    },
...
const goerli__L1StandardBridge_for_verification_only = {
  abi: [
...
const goerli__Lib_AddressManager = {
  abi: [
    {
      anonymous: false,
      inputs: [
...
const goerli__OVM_L1CrossDomainMessenger = {
  abi: [
    { inputs: [], stateMutability: "nonpayable", type: "constructor" },
    {
      anonymous: false,
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_messageNonce", type: "uint256" },
        {
          ...
          internalType:
            "struct IL1CrossDomainMessenger.L2MessageInclusionProof",
          name: "_proof",
          type: "tuple",
        },
      ],
...
const goerli__Proxy__OVM_L1StandardBridge = {
  abi: [
    {
...
const goerli__StateCommitmentChain = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__AddressDictator = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__CanonicalTransactionChain = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__ChainStorageContainer_CTC_batches = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__ChainStorageContainer_SCC_batches = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__ChugSplashDictator = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__Lib_AddressManager = {
  abi: [
    {
      anonymous: false,
      inputs: [
...
const mainnet__OVM_L1CrossDomainMessenger = {
  abi: [
    { inputs: [], stateMutability: "nonpayable", type: "constructor" },
    {
      anonymous: false,
...
const mainnet__Proxy__OVM_L1CrossDomainMessenger = {
  abi: [
    {
      inputs: [
        {
...
const mainnet__Proxy__OVM_L1StandardBridge = {
  abi: [
    {
      inputs: [{ internalType: "address", name: "_owner", type: "address" }],
      stateMutability: "nonpayable",
...
const mainnet__TeleportrDeposit = {
  abi: [
    {
      inputs: [
