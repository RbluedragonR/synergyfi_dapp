...
(function (L2ChainID) {
  ...
  L2ChainID[(L2ChainID["OPTIMISM_HARDHAT_LOCAL"] = 31337)] =
    "OPTIMISM_HARDHAT_LOCAL";
  L2ChainID[(L2ChainID["OPTIMISM_HARDHAT_DEVNET"] = 17)] =
    "OPTIMISM_HARDHAT_DEVNET";
  L2ChainID[(L2ChainID["OPTIMISM_BEDROCK_ALPHA_TESTNET"] = 28528)] =
...
(function (MessageStatus) {
  MessageStatus[(MessageStatus["UNCONFIRMED_L1_TO_L2_MESSAGE"] = 0)] =
    "UNCONFIRMED_L1_TO_L2_MESSAGE";
  MessageStatus[(MessageStatus["FAILED_L1_TO_L2_MESSAGE"] = 1)] =
    "FAILED_L1_TO_L2_MESSAGE";
  MessageStatus[(MessageStatus["STATE_ROOT_NOT_PUBLISHED"] = 2)] =
    "STATE_ROOT_NOT_PUBLISHED";
  MessageStatus[(MessageStatus["READY_TO_PROVE"] = 3)] = "READY_TO_PROVE";
  MessageStatus[(MessageStatus["IN_CHALLENGE_PERIOD"] = 4)] =
    "IN_CHALLENGE_PERIOD";
...
(function (MessageReceiptStatus) {
  MessageReceiptStatus[(MessageReceiptStatus["RELAYED_FAILED"] = 0)] =
    "RELAYED_FAILED";
  MessageReceiptStatus[(MessageReceiptStatus["RELAYED_SUCCEEDED"] = 1)] =
    "RELAYED_SUCCEEDED";
})(
  MessageReceiptStatus ||
    (exports.MessageReceiptStatus = MessageReceiptStatus = {})
);
