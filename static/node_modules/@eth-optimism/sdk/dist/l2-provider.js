...
exports.asL2Provider =
  exports.isL2Provider =
  exports.estimateTotalGasCost =
  exports.estimateL2GasCost =
  exports.estimateL1GasCost =
  exports.estimateL1Gas =
  exports.getL1GasPrice =
    void 0;
...
const connectGasPriceOracle = (provider) => {
  return new ethers_1.Contract(
    contracts_1.predeploys.OVM_GasPriceOracle,
    (0, contracts_1.getContractInterface)("OVM_GasPriceOracle"),
    (0, utils_1.toProvider)(provider)
  );
};
...
const asL2Provider = (provider) => {
  ...
  const ogBlockWithTxFormatter =
    formatter.blockWithTransactions.bind(formatter);
