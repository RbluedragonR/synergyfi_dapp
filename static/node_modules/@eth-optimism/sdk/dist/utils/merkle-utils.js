...
exports.makeStateTrieProof =
  exports.maybeAddProofNode =
  exports.makeMerkleTreeProof =
    void 0;
...
const makeMerkleTreeProof = (leaves, index) => {
  ...
  for (let i = 0; i < correctedTreeSize; i++) {
    if (i < leaves.length) {
      ...
      parsedLeaves.push(
        ethers_1.ethers.utils.keccak256("0x" + "00".repeat(32))
      );
    }
  }
...
const makeStateTrieProof = async (provider, blockNumber, address, slot) => {
  ...
  proof.storageProof[0].proof = (0, exports.maybeAddProofNode)(
    ethers_1.ethers.utils.keccak256(slot),
