...
exports.toAddress =
  exports.toNumber =
  exports.toBigNumber =
  exports.toTransactionHash =
  exports.toJsonRpcProvider =
  exports.toProvider =
  exports.toSignerOrProvider =
    void 0;
...
const toTransactionHash = (transaction) => {
  if (typeof transaction === "string") {
    (0, assert_1.assert)(
      ethers_1.ethers.utils.isHexString(transaction, 32),
...
const toAddress = (addr) => {
  if (typeof addr === "string") {
    (0, assert_1.assert)(
      ethers_1.ethers.utils.isAddress(addr),
      "Invalid address"
    );
    return ethers_1.ethers.utils.getAddress(addr);
  } else {
    (0, assert_1.assert)(
      ethers_1.ethers.utils.isAddress(addr.address),
      "Invalid address"
    );
