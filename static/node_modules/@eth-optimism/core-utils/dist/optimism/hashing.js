...
exports.hashOutputRootProof =
  exports.hashWithdrawal =
  exports.hashCrossDomainMessagev1 =
  exports.hashCrossDomainMessagev0 =
  exports.hashCrossDomainMessage =
    void 0;
const keccak256_1 = require("@ethersproject/keccak256");
const abi_1 = require("@ethersproject/abi");
const encoding_1 = require("./encoding");
const hashCrossDomainMessage = (
  nonce,
  sender,
  target,
  value,
  ...
  if (version.eq(0)) {
    return (0, exports.hashCrossDomainMessagev0)(
      target,
      sender,
      message,
      nonce
    ...
    return (0, exports.hashCrossDomainMessagev1)(
      nonce,
      sender,
      target,
      value,
...
const hashCrossDomainMessagev0 = (target, sender, message, nonce) => {
  return (0, keccak256_1.keccak256)(
    (0, encoding_1.encodeCrossDomainMessageV0)(target, sender, message, nonce)
  );
};
exports.hashCrossDomainMessagev0 = hashCrossDomainMessagev0;
const hashCrossDomainMessagev1 = (
  nonce,
  sender,
  target,
  value,
  ...
  return (0, keccak256_1.keccak256)(
    (0, encoding_1.encodeCrossDomainMessageV1)(
      nonce,
      sender,
      target,
      value,
