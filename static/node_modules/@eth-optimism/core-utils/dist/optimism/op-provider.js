...
class OpNodeProvider extends events_1.default {
  ...
  async syncStatus() {
    ...
    return {
      ...
      unsafeL2: {
        ...
        sequencerNumber: bignumber_1.BigNumber.from(
          result.unsafe_l2.sequenceNumber
        ),
      },
      safeL2: {
      ...
      finalizedL2: {
        ...
        l1Origin: {
          ...
          number: bignumber_1.BigNumber.from(
            result.finalized_l2.l1origin.number
          ),
        },
        sequencerNumber: bignumber_1.BigNumber.from(
          result.finalized_l2.sequenceNumber
        ),
      },
    };
  }
  ...
  send(method, params) {
    ...
    const result = (0, web_1.fetchJson)(
      this.connection,
