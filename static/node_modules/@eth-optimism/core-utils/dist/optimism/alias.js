...
exports.undoL1ToL2Alias =
  exports.applyL1ToL2Alias =
  exports.L1_TO_L2_ALIAS_OFFSET =
    void 0;
...
const applyL1ToL2Alias = (address) => {
  ...
  return (0, common_1.bnToAddress)(
    bignumber_1.BigNumber.from(address).add(exports.L1_TO_L2_ALIAS_OFFSET)
  );
};
...
const undoL1ToL2Alias = (address) => {
  ...
  return (0, common_1.bnToAddress)(
    bignumber_1.BigNumber.from(address).sub(exports.L1_TO_L2_ALIAS_OFFSET)
  );
};
