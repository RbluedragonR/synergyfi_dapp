...
exports.encodeCrossDomainMessage =
  exports.encodeCrossDomainMessageV1 =
  exports.encodeCrossDomainMessageV0 =
  exports.decodeVersionedNonce =
  exports.encodeVersionedNonce =
    void 0;
...
const nonceMask = bignumber_1.BigNumber.from(
...
const encodeCrossDomainMessageV1 = (
  nonce,
  sender,
  target,
  value,
...
const encodeCrossDomainMessage = (
  nonce,
  sender,
  target,
  value,
  ...
  if (version.eq(0)) {
    ...
    return (0, exports.encodeCrossDomainMessageV1)(
      nonce,
      sender,
      target,
      value,
