...
var Pagination = function Pagination(props) {
  ...
  var _props$prefixCls = props.prefixCls,
    prefixCls =
      _props$prefixCls === void 0 ? "rc-pagination" : _props$prefixCls,
    _props$selectPrefixCl = props.selectPrefixCls,
    selectPrefixCls =
      _props$selectPrefixCl === void 0 ? "rc-select" : _props$selectPrefixCl,
    className = props.className,
    currentProp = props.current,
    _props$defaultCurrent = props.defaultCurrent,
    defaultCurrent =
      _props$defaultCurrent === void 0 ? 1 : _props$defaultCurrent,
    _props$total = props.total,
    total = _props$total === void 0 ? 0 : _props$total,
    pageSizeProp = props.pageSize,
    _props$defaultPageSiz = props.defaultPageSize,
    defaultPageSize =
      _props$defaultPageSiz === void 0 ? 10 : _props$defaultPageSiz,
    ...
    showPrevNextJumpers =
      _props$showPrevNextJu === void 0 ? true : _props$showPrevNextJu,
  ...
  var _useMergedState3 = useMergedState(1, {
      ...
      postState: function postState(c) {
        return Math.max(
          1,
          Math.min(c, calculatePage(undefined, pageSize, total))
        );
      },
    }),
    ...
    if (
      ...
      for (
        var _len = arguments.length,
          restParams = new Array(_len > 2 ? _len - 2 : 0),
          _key = 2;
        _key < _len;
        _key++
      ) {
  ...
  function renderPrev(prevPage) {
    ...
    return /*#__PURE__*/ React.isValidElement(prevButton)
      ? /*#__PURE__*/ React.cloneElement(prevButton, {
          disabled: !hasPrev,
        })
      : prevButton;
  }
  function renderNext(nextPage) {
    ...
    return /*#__PURE__*/ React.isValidElement(nextButton)
      ? /*#__PURE__*/ React.cloneElement(nextButton, {
          disabled: !hasNext,
        })
      : nextButton;
  }
  ...
  if (simple) {
    ...
    if (goButton) {
      if (typeof goButton === "boolean") {
        gotoButton = /*#__PURE__*/ React.createElement(
          "button",
          {
            type: "button",
            onClick: handleGoTO,
      ...
      gotoButton = /*#__PURE__*/ React.createElement(
        ...
        {
          title: showTitle
            ? "".concat(locale.jump_to).concat(current, "/").concat(allPages)
            : null,
    ...
    simplePager = /*#__PURE__*/ React.createElement(
      "li",
      {
  ...
  if (allPages <= 3 + pageBufferSize * 2) {
    ...
    var jumpPrevContent = itemRender(
      jumpPrevPage,
      "jump-prev",
      getItemIcon(jumpPrevIcon, "prev page")
    );
    var jumpNextContent = itemRender(
      jumpNextPage,
      "jump-next",
        ...
        ? /*#__PURE__*/ React.createElement(
            "li",
            {
              ...
              className: classNames(
                ...
                _defineProperty(
                  {},
                  "".concat(prefixCls, "-jump-prev-custom-icon"),
                  !!jumpPrevIcon
                )
              ),
            },
        ...
        ? /*#__PURE__*/ React.createElement(
            "li",
            {
              ...
              className: classNames(
                ...
                _defineProperty(
                  {},
                  "".concat(prefixCls, "-jump-next-custom-icon"),
                  !!jumpNextIcon
                )
              ),
            },
    ...
    if (current - 1 >= pageBufferSize * 2 && current !== 1 + 2) {
      pagerList[0] = /*#__PURE__*/ React.cloneElement(pagerList[0], {
        className: classNames(
          "".concat(prefixCls, "-item-after-jump-prev"),
    ...
    if (allPages - current >= pageBufferSize * 2 && current !== allPages - 2) {
      ...
      pagerList[pagerList.length - 1] = /*#__PURE__*/ React.cloneElement(
        lastOne,
        {
          className: classNames(
            "".concat(prefixCls, "-item-before-jump-next"),
    ...
    prev = /*#__PURE__*/ React.createElement(
      "li",
      {
        ...
        className: classNames(
          ...
          _defineProperty({}, "".concat(prefixCls, "-disabled"), prevDisabled)
        ),
    ...
    next = /*#__PURE__*/ React.createElement(
      "li",
      {
        ...
        className: classNames(
          ...
          _defineProperty({}, "".concat(prefixCls, "-disabled"), nextDisabled)
        ),
  ...
  var cls = classNames(
    ...
    _defineProperty(
      _classNames5,
      "".concat(prefixCls, "-center"),
      align === "center"
    ),
    _defineProperty(
      _classNames5,
      "".concat(prefixCls, "-end"),
      align === "end"
    ),
    _defineProperty(_classNames5, "".concat(prefixCls, "-simple"), simple),
    _defineProperty(_classNames5, "".concat(prefixCls, "-disabled"), disabled),
    _classNames5)
  );
