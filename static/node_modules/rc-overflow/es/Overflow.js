...
function Overflow(props, ref) {
  ...
  var mergedDisplayCount = React.useMemo(
    function () {
  ...
  var getKey = useCallback(
    function (item, index) {
      ...
      return (_ref =
        itemKey &&
        (item === null || item === void 0 ? void 0 : item[itemKey])) !== null &&
        _ref !== void 0
        ? _ref
        : index;
    },
  ...
  if (!renderRawRest) {
    ...
    restNode = /*#__PURE__*/ React.createElement(
      Item,
      _extends({}, itemSharedProps, restContextProps),
  ...
  var overflowNode = /*#__PURE__*/ React.createElement(
    Component,
    _extends(
      {
  ...
  if (isResponsive) {
    overflowNode = /*#__PURE__*/ React.createElement(
      ResizeObserver,
      {
