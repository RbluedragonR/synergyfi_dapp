...
function createRouter(init) {
  ...
  let detectErrorBoundary =
    init.detectErrorBoundary || defaultDetectErrorBoundary; // Routes keyed by ID
  ...
  async function startRedirectNavigation(state, redirect, _temp) {
    ...
    let redirectLocation = createLocation(
      state.location,
      redirect.location, // TODO: This can be removed once we get rid of useTransition in Remix v2
      _extends(
        {
          _isRedirect: true,
        },
...
function createStaticHandler(routes, opts) {
  ...
  let manifest = {};
  let detectErrorBoundary =
    (opts == null ? void 0 : opts.detectErrorBoundary) ||
