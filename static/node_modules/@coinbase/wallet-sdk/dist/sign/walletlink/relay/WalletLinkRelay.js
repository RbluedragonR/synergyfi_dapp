...
class WalletLinkRelay {
  ...
  subscribe() {
    const session =
      WalletLinkSession_1.WalletLinkSession.load(this.storage) ||
      new WalletLinkSession_1.WalletLinkSession(this.storage).save();
    ...
    const ui = this.isMobileWeb
      ? new WLMobileRelayUI_1.WLMobileRelayUI()
      : new WalletLinkRelayUI_1.WalletLinkRelayUI();
    connection.connect();
  ...
  resetAndReload() {
    Promise.race([
      ...
      .then(() => {
         ...
         */
        const storedSession = WalletLinkSession_1.WalletLinkSession.load(
          this.storage
        );
        if (
    ...
    return this.sendRequest({
      ...
      params: {
        ...
        gasLimit: params.gasLimit
          ? (0, util_2.bigIntStringFromBigInt)(params.gasLimit)
          : null,
    ...
    return this.sendRequest({
      ...
      params: {
        ...
        maxFeePerGas: params.maxFeePerGas
          ? (0, util_2.bigIntStringFromBigInt)(params.maxFeePerGas)
          : null,
  ...
  submitEthereumTransaction(signedTransaction, chainId) {
    return this.sendRequest({
      ...
      params: {
        signedTransaction: (0, util_2.hexStringFromBuffer)(
          signedTransaction,
          true
        ),
        chainId,
