...
exports.checkErrorForInvalidRequestArgs =
  exports.getCoinbaseInjectedProvider =
  exports.getCoinbaseInjectedSigner =
  exports.fetchRPCRequest =
    void 0;
...
function getInjectedEthereum() {
  ...
  try {
    const window = globalThis;
    return (_a = window.ethereum) !== null && _a !== void 0
      ? _a
...
function getCoinbaseInjectedProvider({ metadata, preference }) {
  ...
  if (preference.options !== "smartWalletOnly") {
    ...
    if (extension) {
      ...
      (_a = extension.setAppInfo) === null || _a === void 0
        ? void 0
        : _a.call(extension, appName, appLogoUrl, appChainIds);
      return extension;
    }
  }
  const ethereum = getInjectedEthereum();
  if (
    ethereum === null || ethereum === void 0
      ? void 0
