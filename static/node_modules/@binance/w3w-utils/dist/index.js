...
function g(e, r) {
  if (r && (w(r) === "object" || typeof r === "function")) {
    return r;
  }
  return t(e);
}
...
function R(r, t) {
  if (!r) return;
  if (typeof r === "string") return e(r, t);
...
var x = function (e, r, t) {
  return (
    S(
      e,
      (typeof r === "undefined" ? "undefined" : w(r)) != "symbol" ? r + "" : r,
      t
    ),
    t
  );
...
var I = "PARSE_ERROR",
  ...
  M =
    ((N = {}),
    s(N, I, { code: -32700, message: "Parse error" }),
    s(N, P, { code: -32600, message: "Invalid Request" }),
    s(N, T, { code: -32601, message: "Method not found" }),
    s(N, C, { code: -32602, message: "Invalid params" }),
    s(N, j, { code: -32603, message: "Internal error" }),
    s(N, D, { code: -32e3, message: "Server error" }),
    N),
  B = D;
function L(e) {
  return e <= k[0] && e >= k[1];
...
function H(e) {
  return Object.keys(M).includes(e) ? M[e] : M[B];
}
function V(e) {
  var r = Object.values(M).find(function (r) {
    return r.code === e;
  });
  return r || M[B];
}
function F(e) {
  ...
  if (w(e.error.message) > "u")
    return { valid: !1, error: "Missing message for JSON-RPC error" };
  if (!K(e.error.code))
    return {
      valid: !1,
      error: "Invalid error code type for JSON-RPC: ".concat(e.error.code),
    };
  if (J(e.error.code)) {
    var r = V(e.error.code);
    if (r.message !== M[B].message && e.error.message === r.message)
      return {
        valid: !1,
        error: "Invalid error code message for JSON-RPC: ".concat(e.error.code),
      };
  }
  return { valid: !0 };
}
function z(e, r, t) {
  return e.message.includes("getaddrinfo ENOTFOUND") ||
    ...
    ? new Error("Unavailable ".concat(t, " RPC url at ").concat(r))
    : e;
}
function W() {
  var e = Date.now() * Math.pow(10, 3),
    r = Math.floor(Math.random() * Math.pow(10, 3));
  return e + r;
}
function q() {
  return (function (e, r) {
...
function G(e, r, t) {
  return { id: t || W(), jsonrpc: "2.0", method: e, params: r || [] };
}
function Z(e, r) {
  return { id: e, jsonrpc: "2.0", result: r };
}
function Q(e, r, t) {
  return { id: e, jsonrpc: "2.0", error: X(r, t) };
}
function X(e, r) {
  return (typeof e === "undefined" ? "undefined" : w(e)) > "u"
    ? H(j)
    : (typeof e == "string" && (e = y(v({}, H(D)), { message: e })),
      (typeof r === "undefined" ? "undefined" : w(r)) < "u" && (e.data = r),
      J(e.code) && (e = V(e.code)),
      e);
}
function Y(e) {
...
var et = "^https?:",
  en = "^wss?:";
function eo(e) {
  var r = e.match(new RegExp(/^\w+:/, "gi"));
  if (!(!r || !r.length)) return r[0];
}
function ei(e, r) {
  var t = eo(e);
  return (typeof t === "undefined" ? "undefined" : w(t)) > "u"
    ? !1
    : new RegExp(r).test(t);
}
function ea(e) {
...
var ec = { 1: "mainnet", 3: "ropsten", 4: "rinkeby", 5: "goerli", 42: "kovan" },
  ef = [
    "eth_requestAccounts",
    "eth_accounts",
    "eth_chainId",
...
function el(e, r) {
  ...
  return (
    typeof n == "string" &&
      (t = "https://".concat(n, ".infura.io/v3/").concat(r)),
    t
  );
}
function ep(e) {
  if (typeof e != "string")
    throw new Error(
      "Cannot safe json parse value of type ".concat(
        typeof e === "undefined" ? "undefined" : w(e)
      )
    );
  try {
    return JSON.parse(e);
...
function ev(e, r) {
  var t,
    n = el(e, r.infuraId);
  return r.custom && r.custom[e] ? (t = r.custom[e]) : n && (t = n), t;
}
function eh() {
  return (
    (typeof process === "undefined" ? "undefined" : w(process)) < "u" &&
    w(process.versions) < "u" &&
    w(process.versions.node) < "u"
  );
}
function ey(e) {
  return typeof e == "string"
    ? Number.parseInt(e, e.trim().substring(0, 2) === "0x" ? 16 : 10)
    : (typeof e === "undefined" ? "undefined" : w(e)) == "bigint"
    ? Number(e)
    : e;
}
var eg = "hex",
...
function ex() {
  ...
  return (
    r.forEach(function (e) {
      return (n = n.concat(Array.from(e)));
    }),
    new Uint8Array(b(n))
  );
}
function eN(e) {
  return eE(Buffer.from(e, em));
}
function eI(e) {
  return Buffer.from(e, em);
}
function eP(e) {
  return e.toString(em);
}
function eT(e) {
  return eP(eA(e));
}
...
function eD(e, r) {
  return eR(new Uint8Array(e), !r);
}
function eU(e) {
  return eE(e).buffer;
}
function ek(e) {
  return eA(new Uint8Array(e));
}
function eM(e) {
  var r = "0x0";
  return (
    typeof e == "number" && (r = "0x".concat(e.toString(16))),
    typeof e == "string" && (e.startsWith("0x") ? (r = e) : (r = "0x0")),
    r
  );
}
import * as eB from "hash.js";
var eL = { 16: 10, 24: 12, 32: 14 },
  eJ = [
...
function e2(e) {
  return parseInt("".concat(e)) === e;
}
function e3(e) {
  if (!e2(e.length)) return !1;
  for (var r = 0; r < e.length; r++)
    if (!e2(e[r]) || e[r] < 0 || e[r] > 255) return !1;
  return !0;
}
function e4(e) {
  return new Uint8Array(e);
...
function e5(e, r) {
  if (e.buffer && e.name === "Uint8Array")
    return (
      r && (e.slice ? (e = e.slice()) : (e = Array.prototype.slice.call(e))), e
    );
  if (Array.isArray(e)) {
    if (!e3(e)) throw new Error("Array contains invalid value");
    return new Uint8Array(e);
  }
  if (e2(e.length) && e3(e)) return new Uint8Array(e);
  throw new Error("unsupported array-like object");
}
function e7(e, r, t, n, o) {
  (n != null || o != null) &&
    (e.slice ? (e = e.slice(n, o)) : (e = Array.prototype.slice.call(e, n, o))),
    r.set(e, t);
}
var e6 = (function () {
    "use strict";
    function e(r) {
      ...
      x(this, "_Ke");
      x(this, "_Kd");
      (this.key = e5(r, !0)), this._prepare();
    }
    a(e, [
      {
        key: "_prepare",
        value: function e() {
          var e = eL[this.key.length];
          if (e == null)
          ...
          for (; u < t; ) {
            if (
              ...
              for (var f = 1; f < n; f++) o[f] ^= o[f - 1];
            else {
              for (var l = 1; l < n / 2; l++) o[l] ^= o[l - 1];
              (c = o[n / 2 - 1]),
                (o[n / 2] ^=
                  eK[c & 255] ^
                  (eK[(c >> 8) & 255] << 8) ^
                  (eK[(c >> 16) & 255] << 16) ^
                  (eK[(c >> 24) & 255] << 24));
              for (var p = n / 2 + 1; p < n; p++) o[p] ^= o[p - 1];
            }
            var d = 0,
              v = void 0,
              h = void 0;
      ...
      },
      {
        ...
        value: function e(e) {
          ...
          var r = this._Ke.length - 1,
            t = [0, 0, 0, 0],
            n = e0(e);
          for (var o = 0; o < 4; o++) n[o] ^= this._Ke[0][o];
          for (var i = 1; i < r; i++) {
            for (var a = 0; a < 4; a++)
              t[a] =
                eV[(n[a] >> 24) & 255] ^
          ...
          for (var c = 0; c < 4; c++)
            (u = this._Ke[r][c]),
              (s[4 * c] = (eK[(n[c] >> 24) & 255] ^ (u >> 24)) & 255),
              (s[4 * c + 1] =
                (eK[(n[(c + 1) % 4] >> 16) & 255] ^ (u >> 16)) & 255),
              (s[4 * c + 2] =
                (eK[(n[(c + 2) % 4] >> 8) & 255] ^ (u >> 8)) & 255),
              (s[4 * c + 3] = (eK[n[(c + 3) % 4] & 255] ^ u) & 255);
          return s;
        },
      },
      {
        ...
        value: function e(e) {
          ...
          var r = this._Kd.length - 1,
            t = [0, 0, 0, 0],
            n = e0(e);
          for (var o = 0; o < 4; o++) n[o] ^= this._Kd[0][o];
          for (var i = 1; i < r; i++) {
            for (var a = 0; a < 4; a++)
              t[a] =
                eq[(n[a] >> 24) & 255] ^
          ...
          for (var c = 0; c < 4; c++)
            (u = this._Kd[r][c]),
              (s[4 * c] = (eH[(n[c] >> 24) & 255] ^ (u >> 24)) & 255),
              (s[4 * c + 1] =
                (eH[(n[(c + 3) % 4] >> 16) & 255] ^ (u >> 16)) & 255),
              (s[4 * c + 2] =
                (eH[(n[(c + 2) % 4] >> 8) & 255] ^ (u >> 8)) & 255),
              (s[4 * c + 3] = (eH[n[(c + 1) % 4] & 255] ^ u) & 255);
          return s;
        },
      },
    ]);
  ...
  e8 = (function () {
    ...
    function e(r, t) {
      n(this, e);
      x(this, "_aes");
      x(this, "_lastCipherblock");
      if (!t) t = new Uint8Array(16);
      else if (t.length != 16)
        throw new Error("invalid initialation vector size (must be 16 bytes)");
      (this._lastCipherblock = e5(t, !0)), (this._aes = new e6(r));
    }
    a(e, [
      {
        key: "encrypt",
        value: function e(e) {
          if (((e = e5(e)), e.length % 16 !== 0))
            throw new Error(
      ...
      },
      {
        ...
        value: function e(e) {
          ...
          var r = e4(e.length),
            t = e4(16);
          for (var n = 0; n < e.length; n += 16) {
            e7(e, t, 0, n, n + 16), (t = this._aes.decrypt(t));
            for (var o = 0; o < 16; o++)
              r[n + o] = t[o] ^ this._lastCipherblock[o];
            e7(e, this._lastCipherblock, 0, n, n + 16);
          }
          return r;
        },
      },
...
var e9 = [
  ...
  re = {
    pad: function e(e) {
      var r = e9[e.byteLength % 16 || 0],
        t = new Uint8Array(e.byteLength + r.length);
      return t.set(e), t.set(r, e.byteLength), t;
    },
    unpad: function e(e) {
...
function rn(e, r, t) {
  var n = new e8(r, e).decrypt(t),
    o = new Uint8Array(n);
  return re.unpad(o);
}
function ro(e, r) {
  var t = eB.hmac(eB[rr], e).update(r).digest("hex");
  return ew(t);
}
function ri(e) {
  for (var r = new Uint8Array(e), t = 0; t < e; ++t)
    r[t] = Math.floor(256 * Math.random());
  return eA(r);
}
function ra(e) {
  var r = ri(e);
...
function rc(e, r, t) {
  var n = eE(ek(r)),
    ...
    p = ro(n, l),
    d = eR(p, !1);
  return { data: f, hmac: d, iv: a };
}
function rf(e, r) {
  var t = eE(ek(r));
  if (!t) throw new Error("Missing key: required for decryption");
  if (!ru(e, t)) return null;
  var n = ew(e.data),
    o = ew(e.iv),
    i = rn(o, t, n),
    a = eT(i),
...
import rv from "eventemitter3";
var rh = function e() {
  "use strict";
  var r = this;
  n(this, e);
  x(this, "events", new rv());
  x(this, "on", function (e, t) {
    return r.events.on(e, t);
  });
  x(this, "once", function (e, t) {
    return r.events.once(e, t);
  });
  x(this, "off", function (e, t) {
    return r.events.off(e, t);
  });
  x(this, "removeListener", function (e, t) {
    return r.events.removeListener(e, t);
  });
  x(this, "removeAllListeners", function () {
    return r.events.removeAllListeners();
  });
};
var ry = { ERROR: 0, WARN: 1, INFO: 2, DEBUG: 3 },
  rg = ry.DEBUG,
  rm = {
    error: function e() {
      for (var e = arguments.length, r = new Array(e), t = 0; t < e; t++) {
      ...
      var n;
      rg >= ry.ERROR && (n = console).error.apply(n, ["[ERROR]"].concat(b(r)));
    },
    warn: function e() {
      for (var e = arguments.length, r = new Array(e), t = 0; t < e; t++) {
        r[t] = arguments[t];
      ...
      var n;
      rg >= ry.WARN && (n = console).warn.apply(n, ["[WARN]"].concat(b(r)));
    },
    info: function e() {
      for (var e = arguments.length, r = new Array(e), t = 0; t < e; t++) {
        r[t] = arguments[t];
      ...
      var n;
      rg >= ry.INFO && (n = console).info.apply(n, ["[INFO]"].concat(b(r)));
    },
    debug: function e() {
      for (var e = arguments.length, r = new Array(e), t = 0; t < e; t++) {
        r[t] = arguments[t];
      ...
      var n;
      rg >= ry.DEBUG && (n = console).log.apply(n, ["[DEBUG]"].concat(b(r)));
    },
  };
var rb = (typeof window === "undefined" ? "undefined" : w(window)) < "u";
function rw() {
...
function rR() {
  ...
  for (var i = 0; i < o.length; i++) {
    var a = e(i);
    if (w(a) === "object") return a.v;
  }
  return "";
}
function rE() {
  var e = rR("name", "og:site_name", "og:title", "twitter:title");
  return e || (e = document.title), e;
}
function rO() {
  return rR("description", "og:description", "twitter:description", "keywords");
}
function r_() {
  if (!rb) return;
  var e = rE(),
    ...
    t = location.origin,
    n = rw();
  return { description: r, url: t, icons: n, name: e };
}
var rA = (function e(e) {
  "use strict";
  c(o, e);
  ...
  function o(e, i) {
    ...
    (a.code = e),
      Object.setPrototypeOf(
        t(a),
        (f(this, o) ? this.constructor : void 0).prototype
      );
    return a;
  }
  a(o, [
...
var rS = {
    CLOSE_MODAL: { code: 100001, message: "[binance-w3w] User closed modal" },
    REJECT_SESSION: {
      code: 100002,
    ...
    CONNECTED: { code: 100005, message: "[binance-w3w] Already connected" },
  },
  rx = {
    REJECT_ERR: {
      code: 200001,
  ...
  rN = {
    INTERNAL_ERR: { code: 300001, message: "[binance-w3w] Internal error" },
  };
import { encodeURI as rI } from "js-base64";
var rP = function () {
    return !!(w(window.navigator) > "u" ? "" : navigator.userAgent).match(
  ...
  rC = function (e, r) {
    var t =
      "appId=xoqXxUSMRccLCrZNRebmzj&startPagePath=L3BhZ2VzL2Rhc2hib2FyZC1uZXcvaW5kZXg=";
    if (r) {
      var n = rI(
        "wc="
          .concat(encodeURIComponent(r), "&isDeepLink=true&id=")
          .concat(+new Date())
      );
      t = "".concat(t, "&startPageQuery=").concat(n);
    }
    var o = "//app.binance.com";
    return e
      ? "bnc:".concat(o, "/mp/app?").concat(t)
      : "https:".concat(o, "/?_dp=").concat(rI("/mp/app?".concat(t)));
  },
  rj = function (e) {
    var r = rP(),
      t = rC(!0, e);
...
export {
  rS as CONNECTION_ERR,
  B as DEFAULT_ERROR,
  rh as Events,
  j as INTERNAL_ERROR,
  C as INVALID_PARAMS,
  P as INVALID_REQUEST,
  T as METHOD_NOT_FOUND,
  rN as MISC_ERR,
  I as PARSE_ERROR,
  rA as ProviderRpcError,
  U as RESERVED_ERROR_CODES,
  rx as RPC_ERROR,
  D as SERVER_ERROR,
  k as SERVER_ERROR_CODE_RANGE,
  M as STANDARD_ERROR_MAP,
  eS as addHexPrefix,
  eA as arrayToBuffer,
  eR as arrayToHex,
  eT as arrayToUtf8,
  ...
  eP as bufferToUtf8,
  ex as concatArrays,
  ek as convertArrayBufferToBuffer,
  eD as convertArrayBufferToHex,
  eU as convertBufferToArrayBuffer,
  ej as convertHexToArrayBuffer,
  eM as convertNumberToHex,
  rf as decrypt,
  rc as encrypt,
  X as formatErrorMessage,
  Q as formatJsonRpcError,
  G as formatJsonRpcRequest,
  Z as formatJsonRpcResult,
  rs as generateKey,
  r_ as getClientMetadata,
  H as getError,
  V as getErrorByCode,
  rC as getHref,
  el as getInfuraRpcUrl,
  rT as getIsAndroid,
  rP as getIsMobile,
  ev as getRpcUrl,
  rl as getStorage,
  ew as hexToArray,
  ec as infuraNetworks,
  ea as isHttpUrl,
  rD as isInBinance,
  er as isJsonRpcError,
  Y as isJsonRpcPayload,
  $ as isJsonRpcResponse,
  ee as isJsonRpcSuccess,
  eu as isLocalhostUrl,
  eh as isNode,
  J as isReservedErrorCode,
  L as isServerErrorCode,
  K as isValidErrorCode,
  es as isWsUrl,
  rm as log,
  ey as normalizeChainId,
  rj as openBinanceDeepLink,
  z as parseConnectionError,
  W as payloadId,
  eb as removeHexPrefix,
  rp as removeStorage,
  ep as safeJsonParse,
  ed as safeJsonStringify,
  rd as setStorage,
  ef as signingMethods,
  e_ as typedArrayToBuffer,
  eN as utf8ToArray,
  eI as utf8ToBuffer,
  eC as utf8ToHex,
  q as uuid,
  F as validateJsonRpcError,
};
