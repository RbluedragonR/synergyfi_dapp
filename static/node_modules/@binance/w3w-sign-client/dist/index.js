...
function u(n, e) {
  ...
  n.prototype = Object.create(e && e.prototype, {
    constructor: { value: n, writable: true, configurable: true },
  });
  if (e) a(n, e);
}
function s(e, t) {
...
function h(n) {
  ...
  return function t() {
    ...
    if (e) {
      ...
      o = Reflect.construct(t, arguments, r);
    } else {
...
var b = function (n, e, t) {
  return e in n
    ? y(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (n[e] = t);
};
var v = function (n, e, t) {
  return (
    b(
      n,
      (typeof e === "undefined" ? "undefined" : f(e)) != "symbol" ? e + "" : e,
      t
    ),
    t
  );
};
import { Core as d } from "@binance/w3w-core";
import { DisconnectType as C } from "@binance/w3w-types";
import { Events as w } from "@binance/w3w-utils";
var g = (function (e) {
  "use strict";
  u(i, e);
  var r = h(i);
  ...
  c(i, [
    ...
    },
    {
      key: "connected",
      get: function n() {
        return this.coreConnection ? this.coreConnection.connected : !1;
      },
    },
    {
      key: "connecting",
      get: function n() {
        return this.coreConnection ? this.coreConnection.pending : !1;
      },
    },
    {
      key: "open",
      value: function n(n) {
        ...
        return t(function () {
          ...
          return p(this, function (i) {
            switch (i.label) {
              case 0:
                if ((c.register(), c.coreConnection.connected)) return [2];
                return [
                  4,
                  c.coreConnection.connect({
                    chainId: e,
                    lng: o,
                    showQrCodeModal: r,
                  }),
          ...
          return p(this, function (o) {
            switch (o.label) {
              ...
              case 1:
                ...
                o.label = 2;
              case 2:
                return [2, (t, e.coreConnection.request(n))];
            }
          });
        })();
      },
    },
    {
      ...
      value: function n() {
        this.connected &&
          ...
          this.onClose(C.DisconnectAtClient));
      },
    },
    {
      key: "register",
      ...
      value: function n() {
        ...
        this.coreConnection.on("chainChanged", function (e) {
          ...
          this.coreConnection.on("accountsChanged", function (e) {
            (n.accounts = e), n.events.emit("accountsChanged", e);
          }),
    ...
    },
    {
      key: "onClose",
      value: function n(n) {
        (this.coreConnection = null), this.events.emit("disconnect", n);
      },
    },
  ]);
  return i;
})(w);
export { g as SignClient };
