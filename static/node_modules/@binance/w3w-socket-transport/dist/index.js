...
function s(e, n) {
  if (n && (c(n) === "object" || typeof n === "function")) {
    return n;
  }
  return t(e);
}
...
function c(t) {
  "@swc/helpers - typeof";
  return t && typeof Symbol !== "undefined" && t.constructor === Symbol
    ? "symbol"
    : typeof t;
}
function a() {
...
var y = function (t, e, n) {
  return (
    h(
      t,
      (typeof e === "undefined" ? "undefined" : c(e)) != "symbol" ? e + "" : e,
      n
    ),
    n
  );
};
import { Events as p } from "@binance/w3w-utils";
import k from "ws";
var d =
    (typeof window === "undefined" ? "undefined" : c(window)) < "u"
      ? window.WebSocket
      : k,
  v = (function (n) {
    "use strict";
    ...
    r(s, [
      ...
      },
      {
        ...
        value: function t(t, e, n) {
          ...
          this.socketSend({ topic: e, type: "pub", payload: t, silent: !!n });
        },
      },
      {
        key: "subscribe",
        value: function t(t) {
          this.socketSend({ topic: t, type: "sub", payload: "", silent: !0 });
        },
      },
      {
        key: "socketCreate",
        value: function t() {
          ...
          if (((this.url = e), (this.nextSocket = new d(e)), !this.nextSocket))
      ...
      },
      {
        ...
        value: function t() {
          return this.retryIndex >= this.urls.length
            ? ""
            : "".concat(this.urls[this.retryIndex++], "?").concat(this.qs);
        },
      },
      {
        key: "socketOpen",
...
function b(t) {
  ...
  return new Promise(function (n) {
    try {
      ...
      var r = new d(t);
      (r.onopen = function () {
        r.close(), n({ ttl: Date.now() - e, url: t });
      }),
        (r.onerror = function () {
          n({ ttl: 0, url: t });
        });
...
export { v as SocketTransport, b as detectWebSocket };
