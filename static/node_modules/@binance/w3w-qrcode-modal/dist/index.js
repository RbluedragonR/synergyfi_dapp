...
function r(n, e) {
  ...
  var o, d;
  try {
    for (a = a.call(n); !(i = (o = a.next()).done); i = true) {
      t.push(o.value);
...
function l(n, e) {
  ...
  if (Object.getOwnPropertySymbols) {
    ...
    for (i = 0; i < r.length; i++) {
      ...
      if (!Object.prototype.propertyIsEnumerable.call(n, t)) continue;
      a[t] = n[t];
    }
  }
  return a;
...
function u(n, e) {
  ...
  return (
    (r = { next: d(0), throw: d(1), return: d(2) }),
...
import { isNode as m } from "@binance/w3w-utils";
...
import { createContext as v, useContext as g } from "react";
var h = v({}),
  y = function () {
    return g(h);
  };
import { openBinanceDeepLink as x } from "@binance/w3w-utils";
import W, { useEffect as B, useState as E } from "react";
var C = "binanceW3W-wrapper",
  ...
  I = "data:image/svg+xml;base64,".concat(S);
import { getIsAndroid as O, getIsMobile as N } from "@binance/w3w-utils";
import { useEffect as j, useState as D } from "react";
var z = function () {
  var n = s(D(), 2),
    e = n[0],
    a = n[1],
...
var nv = function () {
    ...
    return L(
      function (n, a) {
        ...
        return (
          (nb === null || nb === void 0
            ? void 0
            : (t = nb[e]) === null || t === void 0
            ? void 0
            : t[n]) ||
          (nb === null || nb === void 0
            ? void 0
            : (i = nb.en) === null || i === void 0
            ? void 0
            : i[n]) ||
          (a === null || a === void 0 ? void 0 : a.default) ||
          n
        );
      },
      [e]
  ...
  ng = nv;
import nh from "react";
import ny from "react";
var nx = function (n) {
    var e = n.size,
      a = e === void 0 ? 24 : e,
      t = n.color,
      i = t === void 0 ? "currentColor" : t,
      r = n.className,
      o = n.children,
      c = l(n, ["size", "color", "className", "children"]);
    return ny.createElement(
      "svg",
      d(
        {
          width: a,
  ...
  nW = nx;
var nB = function (n) {
  return nh.createElement(
    nW,
    d({ size: 24 }, n),
    nh.createElement("path", {
...
var nI = function (n) {
    var e = n.value,
      a = l(n, ["value"]);
    var t = nO(e).map(function (n) {
      return typeof n == "string"
        ? n
        : nS.cloneElement(a[n.key], { key: n.key });
    });
    return nS.createElement(nS.Fragment, null, t);
  },
  nO = function (n) {
    var e = /{{(.*?)}}/g,
      a,
      ...
      i = [];
    for (; (a = e.exec(n)) !== null; )
      a.index !== t && i.push(n.substring(t, a.index)),
        i.push({ key: a[1] }),
        (t = e.lastIndex);
    return t !== n.length && i.push(n.substring(t)), i;
  };
var nN = function () {
    var n = ng();
    return T.createElement(
      T.Fragment,
      null,
      T.createElement(nj, { t: n }),
      T.createElement(nD, { t: n }),
      T.createElement(nz, null)
    );
  },
  nj = function (n) {
    var e = n.t;
    return T.createElement(
      ...
      T.createElement(
        "div",
        null,
        e("sdk-modal-instruct-1", { default: "1. Open Binance app" })
      ),
      T.createElement(
        "div",
  ...
  nD = function (n) {
    ...
    return T.createElement(
      ...
      e("sdk-no-app", { default: "Don't have Binance app yet?" })
    );
  },
  nz = function () {
    return T.createElement(
      ...
      T.createElement(nT, { type: "iOS" }),
      T.createElement(nT, { type: "Android" })
    );
  },
  nT = function (n) {
    var e = n.type;
    ...
    return T.createElement(
      "div",
      {
        ...
        onClick: function () {
          window.open(e === "Android" ? M.googlePlay : M.appleStore, "_blank");
        },
      },
      e === "Android"
        ? T.createElement(nC, { className: "w-[24px] h-[24px] m-auto" })
        : T.createElement(nB, { className: "w-[24px] h-[24px] m-auto" }),
      T.createElement(
        "div",
        { className: "w-[75px] w3w-caption2 w3w-t-secondary" },
        a("sdk-download-".concat(e.toLowerCase()), {
          default: "Download for ".concat(e),
        })
      )
    );
  };
import nL from "react";
import nP from "react";
var nH = function (n) {
  return nP.createElement(
    nW,
    d({}, n),
    nP.createElement("path", {
...
var nF = function (n) {
    ...
    return nL.createElement(
      ...
      nL.createElement(
        ...
        a("sdk-modal-title", { default: "Connect with Binance" })
      ),
      nL.createElement(
        "div",
        { className: "cursor-pointer text-[#929AA5]", onClick: e },
        nL.createElement(nH, null)
      )
    );
  },
  nZ = nF;
import nV from "react";
var nR = function (n) {
    var e = n.id,
      a = n.onClose,
      t = n.onConnect;
    ...
    return nV.createElement(
      ...
      nV.createElement(
        ...
        nV.createElement(nU, { onClose: a }),
        nV.createElement(
          "div",
          { className: "mt-6 mb-4 flex justify-center" },
          nV.createElement("img", { className: "w-[60px]", src: I })
        ),
        nV.createElement(
          "div",
          { className: "w3w-subtitle1 text-center mb-6 w3w-t-primary" },
          i("sdk-modal-title", { default: "Connect with Binance" })
        ),
        nV.createElement(
          "button",
          {
        ...
        nV.createElement(
          ...
          nV.createElement(
            "span",
            null,
            i("sdk-no-app", { default: "Don’t have Binance app yet?" })
          ),
          nV.createElement(
            "a",
            {
  ...
  nU = function (n) {
    ...
    return nV.createElement(
      ...
      nV.createElement(
        "div",
        { className: "cursor-pointer text-[#929AA5]", onClick: e },
        nV.createElement(nH, { className: "w-[20px]" })
      )
    );
  };
import { QRCodeSVG as nQ } from "qrcode.react";
import nG from "react";
import { getHref as nY } from "@binance/w3w-utils";
var nK = function (n, e) {
    var a = "visibilitychange",
      ...
      i = function () {
        document.hidden &&
          (clearTimeout(t), document.removeEventListener(a, i));
      };
    document.addEventListener(a, i, !1);
  },
  nJ = function (n) {
...
function n_(n) {
  ...
  return nG.createElement(
    ...
    nG.createElement(
      ...
      nG.createElement(
        "div",
        { className: "w-[200px] h-[200px] mb-4", onClick: a },
        n.url &&
          nG.createElement(nQ, {
            value: n.url,
            width: "100%",
            height: "100%",
            level: "M",
            imageSettings: { src: I, height: 32, width: 32, excavate: !1 },
          })
      )
    )
  );
    ...
    if (i === !1)
      return W.createElement(
        ...
        W.createElement(
          ...
          W.createElement(nZ, { onClose: e }),
          W.createElement(nX, d({}, w)),
          W.createElement(nN, null)
        )
      );
    if (i) return W.createElement(nR, { onConnect: m, onClose: e, id: A });
  },
  n1 = n$;
var n0 = {
    order: [
    ...
    lookupQuerystring: function n() {
      var n = window.location.search.match(/lng=([^&]*)/);
      return n && n[1];
    },
    lookupCookie: function n() {
      var n = document.cookie.match(/i18next=([^;]*)/);
      return n && n[1];
    },
    lookupLocalStorage: function n() {
      return localStorage.getItem("i18nextLng");
    },
    lookupSessionStorage: function n() {
      return sessionStorage.getItem("i18nextLng");
    },
    lookupFromNavigator: function n() {
      return navigator.language;
    },
    lookupFromHtmlTag: function n() {
      return document.documentElement.lang;
    },
    lookupFromPath: function n() {
      var n = window.location.pathname.match(/\/([^/]*)/);
      return n && n[1];
    },
    lookupFromSubdomain: function n() {
  ...
  n2 = function () {
    ...
    try {
      for (
        var t = n0.order[Symbol.iterator](), i;
        !(n = (i = t.next()).done);
        n = true
      ) {
        var r = i.value;
        try {
          var o = n0["lookup" + r.charAt(0).toUpperCase() + r.slice(1)]();
          if (o) return o;
        } catch (n) {
          console.error("Error detecting language with method: ".concat(r), n);
          continue;
        }
      }
    } catch (n) {
...
function n3() {
  ...
  return e.setAttribute("id", C), n.body.appendChild(e), e;
}
function n4() {
  var n = window.document,
    e = n.getElementById(A);
  e &&
    ((e.className = e.className.replace("w3w-fadeIn", "w3w-fadeOut")),
    setTimeout(function () {
      var e = n.getElementById(C);
...
function n6() {
  n6 = t(function (n) {
    ...
    return u(this, function (d) {
      switch (d.label) {
        case 0:
          (e = n.isReady), (a = n.cb), (t = n.lng);
          (i = n3()), (r = k(i));
          return [4, e];
        case 1:
          d.sent();
          o = t !== null && t !== void 0 ? t : n2();
          r.render(
            w.createElement(
              h.Provider,
              { value: { lng: o } },
              ...
              w.createElement(n1, { isReady: e, onClose: n5(a) })
            )
          );
          return [2];
      }
...
var er = { open: ee, close: ea, ready: et, fail: ei },
  eo = er;
