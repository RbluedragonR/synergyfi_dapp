...
var Group = function Group(_ref) {
  ...
  var _ref$previewPrefixCls = _ref.previewPrefixCls,
    previewPrefixCls =
      _ref$previewPrefixCls === void 0
        ? "rc-image-preview"
        : _ref$previewPrefixCls,
  ...
  // >>> Image
  var _ref3 =
      ((_mergedItems$current = mergedItems[current]) === null ||
      _mergedItems$current === void 0
        ? void 0
        : _mergedItems$current.data) || {},
    src = _ref3.src,
  ...
  var onPreviewFromImage = React.useCallback(
    function (id, imageSrc, mouseX, mouseY) {
      var index = fromItems
  ...
  // ========================= Context ==========================
  var previewGroupContext = React.useMemo(
    function () {
      return {
        register: register,
