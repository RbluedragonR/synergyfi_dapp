...
var ImageInternal = function ImageInternal(props) {
  var imgSrc = props.src,
    ...
    previewPrefixCls =
      _props$previewPrefixC === void 0
        ? "".concat(prefixCls, "-preview")
  ...
  var _ref = _typeof(preview) === "object" ? preview : {},
    ...
    onPreviewVisibleChange =
      _ref$onVisibleChange === void 0
        ? onInitialPreviewClose
        : _ref$onVisibleChange,
    _ref$getContainer = _ref.getContainer,
    getPreviewContainer =
      _ref$getContainer === void 0 ? undefined : _ref$getContainer,
  ...
  var wrapperClass = cn(
    ...
    wrapperClassName,
    rootClassName,
    _defineProperty({}, "".concat(prefixCls, "-error"), status === "error")
  );

  // ========================= ImageProps =========================
  var imgCommonProps = useMemo(
    function () {
      var obj = {};
  ...
  // ========================== Register ==========================
  var registerData = useMemo(
    function () {
      return _objectSpread(
        _objectSpread({}, imgCommonProps),
        {},
        {
          src: src,
        }
        ...
        _extends(
          ...
          imgCommonProps,
          {
            className: cn(
              ...
              _defineProperty(
                {},
                "".concat(prefixCls, "-img-placeholder"),
                placeholder === true
              ),
              className
            ),
