...
var Preview = function Preview(props) {
  var prefixCls = props.prefixCls,
    ...
    transitionName =
      _props$transitionName === void 0 ? "zoom" : _props$transitionName,
    _props$maskTransition = props.maskTransitionName,
    maskTransitionName =
      _props$maskTransition === void 0 ? "fade" : _props$maskTransition,
  ...
  var _useImageTransform = useImageTransform(
      imgRef,
      minScale,
      maxScale,
      onTransform
  ...
  var _useMouseEvent = useMouseEvent(
      imgRef,
      movable,
      visible,
      scaleStep,
  ...
  var wrapClassName = classnames(
    _defineProperty({}, "".concat(prefixCls, "-moving"), isMoving)
  );
  useEffect(
    function () {
      if (!enableTransition) {
  ...
  var onZoomOut = function onZoomOut() {
    dispatchZoomChange(
      BASE_SCALE_RATIO / (BASE_SCALE_RATIO + scaleStep),
      "zoomOut"
    );
  };
  ...
  useEffect(
    function () {
      var onKeyDownListener = addEventListener(
        window,
        "keydown",
        onKeyDown,
        false
  ...
  var imgNode = /*#__PURE__*/ React.createElement(
    PreviewImage,
    _extends({}, imgCommonProps, {
      width: props.width,
      height: props.height,
      imgRef: imgRef,
      ...
      style: {
        transform: "translate3d("
          .concat(transform.x, "px, ")
          .concat(transform.y, "px, 0) scale3d(")
          .concat(transform.flipX ? "-" : "")
          .concat(scale, ", ")
          .concat(transform.flipY ? "-" : "")
