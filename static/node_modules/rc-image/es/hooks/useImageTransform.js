...
export default function useImageTransform(
  ...
  var updateTransform = function updateTransform(newTransform, action) {
    ...
    queue.current.push(
      _objectSpread(_objectSpread({}, transform), newTransform)
    );
  };

  /** Scale according to the position of centerX and centerY */
  var dispatchZoomChange = function dispatchZoomChange(
    ratio,
    action,
    centerX,
    centerY,
    ...
    var mergedCenterX =
      centerX !== null && centerX !== void 0 ? centerX : innerWidth / 2;
    var mergedCenterY =
      centerY !== null && centerY !== void 0 ? centerY : innerHeight / 2;
