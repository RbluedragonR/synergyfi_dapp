...
export default function useMouseEvent(
  ...
  useEffect(
    function () {
      ...
      if (movable) {
        onMouseUpListener = addEventListener(
          window,
          "mouseup",
          onMouseUp,
          false
        );
        onMouseMoveListener = addEventListener(
          window,
          "mousemove",
          onMouseMove,
          false
      ...
      return function () {
        var _onMouseUpListener,
          ...
          _onTopMouseMoveListen;
        (_onMouseUpListener = onMouseUpListener) === null ||
          _onMouseUpListener === void 0 ||
          _onMouseUpListener.remove();
        (_onMouseMoveListener = onMouseMoveListener) === null ||
          _onMouseMoveListener === void 0 ||
          _onMouseMoveListener.remove();
        /* istanbul ignore next */
        (_onTopMouseUpListener = onTopMouseUpListener) === null ||
          _onTopMouseUpListener === void 0 ||
          _onTopMouseUpListener.remove();
        /* istanbul ignore next */
        (_onTopMouseMoveListen = onTopMouseMoveListener) === null ||
          _onTopMouseMoveListen === void 0 ||
