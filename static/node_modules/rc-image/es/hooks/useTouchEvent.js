...
export default function useTouchEvent(
  ...
  var updateTouchPointInfo = function updateTouchPointInfo(values) {
    touchPointInfo.current = _objectSpread(
      _objectSpread({}, touchPointInfo.current),
      values
    );
  };
  ...
  useEffect(
    function () {
      ...
      if (visible && movable) {
        onTouchMoveListener = addEventListener(
          window,
          "touchmove",
          function (e) {
      ...
      return function () {
        ...
        (_onTouchMoveListener = onTouchMoveListener) === null ||
          _onTouchMoveListener === void 0 ||
          _onTouchMoveListener.remove();
      };
    },
    [visible, movable]
  );
