...
function U(t) {
  return "children" in t
    ? U(t.children)
    : t.current
        .filter(({ el: n }) => n.current !== null)
        .filter(({ state: n }) => n === "visible").length > 0;
}
function se(t, n) {
  let r = A(t),
    s = c([]),
    ...
    x = E((i) => {
      ...
      return (
        e
          ...
          : s.current.push({ el: i, state: "visible" }),
        () => p(i, y.Unmount)
      );
    }),
    h = c([]),
    v = c(Promise.resolve()),
    u = c({ enter: [], leave: [], idle: [] }),
    g = E((i, e, a) => {
      h.current.splice(0),
        n &&
          (n.chains.current[e] = n.chains.current[e].filter(([o]) => o !== i)),
        n == null ||
          n.chains.current[e].push([
            i,
            new Promise((o) => {
              h.current.push(o);
            }),
        ...
        e === "enter"
          ? (v.current = v.current
              .then(() => (n == null ? void 0 : n.wait.current))
              .then(() => a(e)))
          : a(e);
    }),
    d = E((i, e, a) => {
      Promise.all(u.current[e].splice(0).map(([o, f]) => f))
        .then(() => {
          var o;
...
function He(t, n) {
  ...
  let {
    ...
    { show: f, appear: N, initial: T } = ye(),
    [l, j] = X(f ? "visible" : "hidden"),
    z = xe(),
    { register: L, unregister: O } = z;
  F(() => L(e), [L, e]),
    F(() => {
      if (o === y.Hidden && e.current) {
        ...
        return _(l, { ["hidden"]: () => O(e), ["visible"]: () => L(e) });
      }
    }, [l, e, L, O, f, o]);
  let k = A({
      base: S(i.className),
    ...
    V = Re({ beforeEnter: r, afterEnter: s, beforeLeave: R, afterLeave: D }),
    G = te();
  F(() => {
    if (G && l === "visible" && e.current === null)
      throw new Error(
  ...
  return (
    K
      ...
      : B.current &&
        ((P.className = ie(
          i.className,
          (Y = e.current) == null ? void 0 : Y.className
        )),
    ...
    m.createElement(
      ...
      m.createElement(
        Ee,
        {
          value: _(l, { ["visible"]: b.Open, ["hidden"]: b.Closed }) | H.flags,
        },
        oe({
          ourProps: ce,
          theirProps: P,
...
function Fe(t, n) {
  let { show: r, appear: s = !1, unmount: R = !0, ...D } = t,
    p = c(null),
    x = ne(p, n);
  te();
  let h = re();
  if (
    (r === void 0 && h !== null && (r = (h & b.Open) === b.Open),
    ![!0, !1].includes(r))
  )
    throw new Error(
  ...
  ge(() => {
    d !== !1 &&
      ...
      (e.current.push(r), i(!1));
  }, [e, r]);
  let a = ee(() => ({ show: r, appear: s, initial: d }), [r, s, d]);
  F(() => {
    if (r) u("visible");
...
let q = W(Fe),
  ue = W(He),
  Le = W(_e),
  qe = Object.assign(q, { Child: Le, Root: q });
export { qe as Transition };
