...
import {
  Direction as L,
  useTabDirection as W,
} from "../../hooks/use-tab-direction.js";
...
function z(t, n) {
  let e = d(null),
    o = K(e, n),
    { initialFocus: l, containers: c, features: r = 30, ...s } = t;
  G() || (r = 1);
  let i = I(e);
  Y({ ownerDocument: i }, Boolean(r & 16));
  let u = Z(
    { ownerDocument: i, container: e, initialFocus: l },
    Boolean(r & 2)
  );
  $(
    { ownerDocument: i, container: e, containers: c, previousActiveElement: u },
    Boolean(r & 8)
  );
  let y = W(),
    R = v((a) => {
      ...
      ((B) => B())(() => {
        k(y.current, {
          [L.Forwards]: () => {
            M(m, p.First, { skipElements: [a.relatedTarget] });
          },
          [L.Backwards]: () => {
            M(m, p.Last, { skipElements: [a.relatedTarget] });
          },
        });
      });
    }),
    ...
    j = {
      ...
      onBlur(a) {
        ...
        T instanceof HTMLElement &&
          T.dataset.headlessuiFocusGuard !== "true" &&
          (S(m, T) ||
            (H.current
              ? M(
                  e.current,
  ...
  return E.createElement(
    ...
    J({ ourProps: j, theirProps: s, defaultTag: X, name: "FocusTrap" }),
    Boolean(r & 4) &&
      E.createElement(O, {
        as: "button",
        type: "button",
...
function Q(t = !0) {
  ...
  return (
    ...
    v(() => {
      var e;
      return (e = n.current.find((o) => o != null && o.isConnected)) != null
        ? e
        : null;
    })
  );
      ...
      r &&
        C(() => {
          ...
          e != null && e.current
            ...
            (l.current = t == null ? void 0 : t.activeElement);
        });
    }, [o]),
    l
  );
...
function $(
  { ownerDocument: t, container: n, containers: e, previousActiveElement: o },
  l
) {
  let c = g();
  x(
    ...
    (r) => {
      ...
      u && u instanceof HTMLElement
        ? S(s, u)
          ? ((o.current = u), f(u))
          : (r.preventDefault(), r.stopPropagation(), f(i))
        : f(o.current);
    },
    !0
  );
