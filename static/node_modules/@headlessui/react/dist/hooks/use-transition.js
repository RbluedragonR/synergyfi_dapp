import { transition as f } from "../components/transitions/utils/transition.js";
...
function D({
  ...
  o(() => {
    ...
    o(() => {
      ...
      d.add(r.dispose);
      let i = s.current;
      if (i && e.current !== "idle" && l.current)
        return (
          r.dispose(),
          a.current(e.current),
          r.add(
            f(i, u.current, e.current === "enter", () => {
