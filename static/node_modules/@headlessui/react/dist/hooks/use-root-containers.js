import m, { useMemo as d, useRef as M } from "react";
    ...
    c = E(() => {
      ...
      for (let e of (i =
        ...
        e !== document.body &&
          ...
          (e.contains(t.current) ||
            e.contains(
              (a = (s = t.current) == null ? void 0 : s.getRootNode()) == null
                ? void 0
                : a.host
            ) ||
            n.some((L) => e.contains(L)) ||
            n.push(e));
      return n;
    });
  return {
    ...
    MainTreeNode: d(
      () =>
        function () {
          return u != null
            ? null
            : m.createElement(T, { features: H.Hidden, ref: t });
        },
      [t, u]
    ),
  };
...
function y() {
  ...
  return {
    ...
    MainTreeNode: d(
      () =>
        function () {
          return m.createElement(T, { features: H.Hidden, ref: o });
        },
      [o]
    ),
  };
}
export { y as useMainTreeNode, N as useRootContainers };
