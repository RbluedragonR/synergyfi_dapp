...
function f(e = document.body) {
  return e == null
    ? []
    : Array.from(e.querySelectorAll(c)).sort((r, t) =>
        Math.sign(
...
function h(e, r = 0) {
  var t;
  return e === ((t = m(e)) == null ? void 0 : t.body)
    ? !1
    : L(r, {
        [0]() {
          return e.matches(c);
...
function H(e) {
  var r, t;
  return (t =
    (r = e == null ? void 0 : e.matches) == null ? void 0 : r.call(e, S)) !=
    null
    ? t
    : !1;
}
...
function O(
  ...
  o.length > 0 && n.length > 1 && (n = n.filter((s) => !o.includes(s))),
