...
function C({
  ...
  if (y & 1) {
    ...
    return w(u ? 0 : 1, {
      ...
      [1]() {
        return m({ ...d, hidden: !0, style: { display: "none" } }, e, n, f, l);
      },
    });
  }
  return m(s, e, n, f, l);
...
function m(r, t = {}, e, n, o) {
  ...
  if (t) {
    let i = !1,
      c = [];
    for (let [T, p] of Object.entries(t))
      typeof p == "boolean" && (i = !0), p === !0 && c.push(T);
    i && (d["data-headlessui-state"] = c.join(" "));
  }
  if (a === g && Object.keys(x(s)).length > 0) {
    if (!P(u) || (Array.isArray(u) && u.length > 1))
      throw new Error(
        [
...
`)
    ...
    let i = u.props,
      c =
        typeof (i == null ? void 0 : i.className) == "function"
          ? (...p) => b(i == null ? void 0 : i.className(...p), s.className)
...
function R(...r) {
  ...
  for (let o of r)
    for (let a in o)
      a.startsWith("on") && typeof o[a] == "function"
        ? ((n = e[a]) != null || (e[a] = []), e[a].push(o[a]))
        : (t[a] = o[a]);
  if (t.disabled || t["aria-disabled"])
    return Object.assign(
      t,
      Object.fromEntries(Object.keys(e).map((o) => [o, void 0]))
    );
  for (let o in e)
    Object.assign(t, {
      [o](a, ...f) {
