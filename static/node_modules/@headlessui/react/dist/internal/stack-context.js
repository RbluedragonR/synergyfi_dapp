import d, { createContext as c, useContext as m } from "react";
...
var s = ((e) => ((e[(e.Add = 0)] = "Add"), (e[(e.Remove = 1)] = "Remove"), e))(
  s || {}
);
function x() {
  return m(a);
...
function b({ children: i, onUpdate: r, type: e, element: n, enabled: u }) {
  ...
  return (
    ...
    d.createElement(a.Provider, { value: o }, i)
  );
}
export { s as StackMessage, b as StackProvider, x as useStackContext };
