...
var calculateWordWidths = function calculateWordWidths(props) {
  try {
    ...
    var spaceWidth = props.breakAll
      ? 0
      : getStringSize("\xA0", props.style).width;
    return {
...
var calculateWordsByLines = function calculateWordsByLines(
  ...
  var checkOverflow = function checkOverflow(index) {
    ...
    var doesOverflow =
      result.length > props.maxLines ||
      findLongestLine(result).width > lineWidth;
    ...
    [
      {
        ...
        value: function render() {
          ...
          if (angle) {
            transforms.push(
              "rotate(".concat(angle, ", ").concat(x, ", ").concat(y, ")")
            );
          }
          ...
          return /*#__PURE__*/ React.createElement(
            "text",
            _extends({}, filterProps(textProps, true), {
              x: x,
              y: y,
              className: classNames("recharts-text", className),
              textAnchor: textAnchor,
              fill: textProps.fill.includes("url")
                ? Text.defaultProps.fill
                : textProps.fill,
            }),
