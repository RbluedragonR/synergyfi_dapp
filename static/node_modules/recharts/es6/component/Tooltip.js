  ...
  _createClass(Tooltip, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        var finalPayload = getUniqPayload(
          payloadUniqBy,
            ...
            "div",
            {
              ...
              onKeyDown: function onKeyDown(event) {
                if (event.key === "Escape") {
                  _this2.setState({
                    dismissed: true,
                    dismissedAtCoordinate: _objectSpread(
                      _objectSpread({}, _this2.state.dismissedAtCoordinate),
                      {},
                      {
