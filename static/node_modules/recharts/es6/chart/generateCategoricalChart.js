...
export var getAxisMapByAxes = function getAxisMapByAxes(props, _ref2) {
  ...
  var axisMap = axes.reduce(function (result, child) {
    ...
    if (!domain || domain.length === 0) {
      ...
      var childDomain =
        (_child$props$domain = child.props.domain) !== null &&
        _child$props$domain !== void 0
          ? _child$props$domain
          : defaultDomain;
      if (dataKey) {
        // has dataKey in <Axis />
        ...
        if (type === "category" && isCategorical) {
          ...
          var errorBarsDomain = parseErrorBarsOfAxis(
            ...
            graphicalItems.filter(function (item) {
              return (
                item.props[axisIdKey] === axisId &&
                (includeHidden || !item.props.hide)
              );
            }),
            dataKey,
            axisType,
      ...
      _defineProperty(
        ...
        _objectSpread(
          ...
          {},
          {
            ...
            originalDomain:
              (_child$props$domain2 = child.props.domain) !== null &&
              _child$props$domain2 !== void 0
                ? _child$props$domain2
                : defaultDomain,
...
var createDefaultState = function createDefaultState(props) {
  ...
  var startIndex =
    (brushItem && brushItem.props && brushItem.props.startIndex) || 0;
  var endIndex =
    (brushItem === null || brushItem === void 0
      ? void 0
      : (_brushItem$props = brushItem.props) === null ||
        _brushItem$props === void 0
      ? void 0
      : _brushItem$props.endIndex) !== undefined
      ? brushItem === null || brushItem === void 0
        ? void 0
        : (_brushItem$props2 = brushItem.props) === null ||
          _brushItem$props2 === void 0
        ? void 0
        : _brushItem$props2.endIndex
      ...
      if (!entry.mirror && !entry.hide) {
        return _objectSpread(
          ...
          _defineProperty(
            {},
            orientation,
            _get(result, "".concat(orientation)) + entry.height
          )
        );
      }
      return result;
...
export var generateCategoricalChart = function generateCategoricalChart(_ref6) {
    ...
    graphicalItems.forEach(function (item, index) {
      ...
      var axisObj = axisComponents.reduce(function (result, entry) {
        ...
        return _objectSpread(
          ...
          {},
          ((_objectSpread6 = {}),
          _defineProperty(_objectSpread6, entry.axisType, axis),
          _defineProperty(
            _objectSpread6,
      ...
      if (itemIsBar) {
        ...
        // 如果是bar，计算bar的位置
        var maxBarSize = _isNil(childMaxBarSize)
          ? globalMaxBarSize
          : childMaxBarSize;
        var barBandSize =
          (_ref7 =
      ...
      if (composedFn) {
        ...
        formattedItems.push({
          props: _objectSpread(
            ...
            _defineProperty(_objectSpread7, "animationId", updateId),
            _objectSpread7)
          ),
  ...
  return (
      ...
      function CategoricalChartWrapper(_props) {
          ...
          function (cId, chartId, data) {
            ...
            if (syncId === cId && chartId !== _this.uniqueChartId) {
              ...
              _this.deferId =
                defer &&
                defer(
                  _this.applySyncEvent.bind(_assertThisInitialized(_this), data)
                );
            }
          }
        );
          ...
          function (_ref10) {
            ...
            return getCoordinatesOfGrid(
              getTicks(
                _objectSpread(
                  _objectSpread(
                    _objectSpread({}, CartesianAxis.defaultProps),
                    xAxis
                  ),
                  {},
                  {
        ...
        _defineProperty(
          ...
          function (element) {
            ...
            return /*#__PURE__*/ isValidElement(element.props.cursor)
              ? /*#__PURE__*/ cloneElement(element.props.cursor, cursorProps)
              : /*#__PURE__*/ createElement(cursorComp, cursorProps);
          }
        );
        _defineProperty(
          _assertThisInitialized(_this),
          ...
          function (element, displayName, index) {
            ...
            var axisOption =
              axisMap && axisMap[element.props["".concat(axisType, "Id")]];
        ...
        _defineProperty(
          ...
          function (element) {
            ...
            var yAxis =
              yAxisWithFiniteDomain || getAnyElementOfObject(yAxisMap);
            ...
            return /*#__PURE__*/ cloneElement(element, {
              ...
              chartHeight: height,
              verticalCoordinatesGenerator:
                props.verticalCoordinatesGenerator ||
                _this.verticalCoordinatesGenerator,
              horizontalCoordinatesGenerator:
        ...
        _defineProperty(
          ...
          function (element) {
            ...
            return /*#__PURE__*/ cloneElement(element, {
              polarAngles: _isArray(polarAngles)
                ? polarAngles
                : getTicksOfAxis(angleAxis, true).map(function (entry) {
                    return entry.coordinate;
                  }),
              polarRadius: _isArray(polarRadius)
                ? polarRadius
        ...
        _defineProperty(
          ...
          function (_ref12) {
            ...
            result.push(
              CategoricalChartWrapper.renderActiveDot(activeDot, dotProps)
            );
            if (basePoint) {
              result.push(
        ...
        _defineProperty(
          ...
          function (element, displayName, index) {
            ...
            var graphicalItem = /*#__PURE__*/ cloneElement(
              element,
        ...
        _this.uniqueChartId = _isNil(_props.id)
          ? uniqueId("recharts")
          : _props.id;
        _this.clipPathId = "".concat(_this.uniqueChartId, "-clip");
        if (_props.throttleDelay) {
          _this.triggeredAfterMouseMove = _throttle(
        ...
        },
        {
          ...
          value: function getCursorPoints() {
            ...
            if (layout === "horizontal") {
              ...
              !_isNil(activeCoordinate.cx) ||
              !_isNil(activeCoordinate.cy)
            ) {
              if (layout === "centric") {
        ...
        },
        {
          ...
          value: function getXScaleByAxisId(axisId) {
            ...
            return (_this$state$xAxisMap = this.state.xAxisMap) === null ||
              ...
              ? void 0
              : (_this$state$xAxisMap$ = _this$state$xAxisMap[axisId]) ===
                  null || _this$state$xAxisMap$ === void 0
              ? void 0
        ...
        },
        {
          ...
          value: function getYScaleByAxisId(axisId) {
            ...
            return (_this$state$yAxisMap = this.state.yAxisMap) === null ||
              ...
              ? void 0
              : (_this$state$yAxisMap$ = _this$state$yAxisMap[axisId]) ===
                  null || _this$state$yAxisMap$ === void 0
              ? void 0
            ...
            if (formattedGraphicalItems && formattedGraphicalItems.length) {
              for (
                ...
                if (itemDisplayName === "Bar") {
                  ...
                  var _activeBarItem = (props.data || []).find(function (
                    entry
                  ) {
    ...
    _defineProperty(_class, "displayName", chartName),
    _defineProperty(
      _class,
      "defaultProps",
      _objectSpread(
