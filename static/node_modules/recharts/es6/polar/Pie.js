        ...
        value: function renderLabels(sectors) {
          ...
          var labels = sectors.map(function (entry, i) {
            ...
            var labelProps = _objectSpread(
              _objectSpread(
                _objectSpread(_objectSpread({}, pieProps), entry),
                {},
                {
                  stroke: "none",
                },
          ...
          return sectors.map(function (entry, i) {
            var inactiveShape =
              inactiveShapeProp && _this2.hasActiveIndex()
                ? inactiveShapeProp
                : null;
            var sectorOptions = _this2.isActiveIndex(i)
              ? activeShape
              : inactiveShape;
            var sectorProps = _objectSpread(
              _objectSpread({}, entry),
              {},
              {
      ...
      },
      {
        ...
        value: function renderSectors() {
          ...
          if (
            ...
            sectors &&
            sectors.length &&
            (!prevSectors || !_isEqual(prevSectors, sectors))
          ) {
...
_defineProperty(Pie, "parseCoordinateOfPie", function (item, offset) {
  ...
  var maxRadius =
    item.props.maxRadius || Math.sqrt(width * width + height * height) / 2;
  return {
    cx: cx,
    cy: cy,
