 ...
 */
export var formatAxisMap = function formatAxisMap(
  props,
  axisMap,
  offset,
  axisType,
...
export var distanceBetweenPoints = function distanceBetweenPoints(
  point,
  anotherPoint
) {
  var x1 = point.x,
