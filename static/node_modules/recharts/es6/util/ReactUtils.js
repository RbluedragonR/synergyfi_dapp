 ...
 */
export var isValidSpreadableProp = function isValidSpreadableProp(
  property,
  key,
  includeEvents,
  svgElementType
 ...
 */
export var isChildrenEqual = function isChildrenEqual(
  nextChildren,
  prevChildren
) {
  ...
  if (count === 1) {
    ...
    return isSingleChildEqual(
      _isArray(nextChildren) ? nextChildren[0] : nextChildren,
      _isArray(prevChildren) ? prevChildren[0] : prevChildren
    );
  }
...
export var isSingleChildEqual = function isSingleChildEqual(
  nextChild,
  prevChild
) {
