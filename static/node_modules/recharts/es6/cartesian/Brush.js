    ...
    [
      ...
      },
      {
        ...
        value: function getIndex(_ref2) {
          ...
          return {
            ...
            endIndex:
              maxIndex === lastIndex ? lastIndex : maxIndex - (maxIndex % gap),
          };
        },
      },
      {
      ...
      },
      {
        ...
        value: function handleTravellerMove(e) {
          ...
          this.setState(
            ...
            _defineProperty(_this$setState, "brushMoveStartX", e.pageX),
            _this$setState),
            function () {
              if (onChange) {
                if (isFullGap()) {
      ...
      },
      {
        ...
        value: function renderTravellerLayer(travellerX, id) {
          ...
          var travellerProps = _objectSpread(
            _objectSpread({}, filterProps(this.props)),
            {},
            {
              x: x,
              y: y,
