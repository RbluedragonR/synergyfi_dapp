  ...
  function Line() {
    ...
    _defineProperty(
      ...
      function (length, totalLength, lines) {
        ...
        return []
          .concat(
            _toConsumableArray(Line.repeat(lines, count)),
    ...
    [
      ...
      },
      {
        ...
        value: function renderCurveStatically(
          ...
          var curveProps = _objectSpread(
            _objectSpread(
              _objectSpread({}, filterProps(others, true)),
              {},
              {
                fill: "none",
            ...
            function (_ref) {
              ...
              if (strokeDasharray) {
                ...
                currentStrokeDasharray = ""
                  .concat(curLength, "px ")
                  .concat(totalLength - curLength, "px");
              }
              return _this2.renderCurveStatically(
                points,
                needClip,
    ...
    [
      ...
      },
      {
        ...
        value: function repeat(lines, count) {
          var linesUnit =
            lines.length % 2 !== 0
              ? [].concat(_toConsumableArray(lines), [0])
              : lines;
          var result = [];
