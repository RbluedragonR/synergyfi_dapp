        ...
        value: function renderAreaStatically(
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              Curve,
              _extends({}, filterProps(others, true), {
                points: points,
        ...
        value: function renderArea(needClip, clipPathId) {
          ...
          if (
            ...
            ((!prevPoints && totalLength > 0) ||
              !_isEqual(prevPoints, points) ||
              !_isEqual(prevBaseLine, baseLine))
          ) {
    ...
    baseLine = points.map(function (entry) {
      if (layout === "horizontal") {
        return {
          x: entry.x,
          y:
            !_isNil(_get(entry, "value[0]")) && !_isNil(_get(entry, "y"))
              ? yAxis.scale(_get(entry, "value[0]"))
              : null,
        };
      }
      return {
        x: !_isNil(_get(entry, "value[0]"))
          ? xAxis.scale(_get(entry, "value[0]"))
          : null,
        y: entry.y,
      };
    });
