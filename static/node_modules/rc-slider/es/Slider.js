...
var Slider = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var mergedMin = React.useMemo(
    function () {
      return isFinite(min) ? min : 0;
    },
    [min]
  );
  var mergedMax = React.useMemo(
    function () {
      ...
      return Object.keys(marks || {})
        .map(function (key) {
          ...
          if (
            mark &&
            _typeof(mark) === "object" &&
            !(/*#__PURE__*/ React.isValidElement(mark)) &&
    ...
    if (!disabled) {
      ...
      if (e) {
        ...
        (_document$activeEleme = document.activeElement) === null ||
          ...
          (_document$activeEleme2 = _document$activeEleme.blur) === null ||
          _document$activeEleme2 === void 0 ||
          _document$activeEleme2.call(_document$activeEleme);
  ...
  // ============================= Drag =============================
  var mergedDraggableTrack = React.useMemo(
    function () {
  ...
  // =========================== Included ===========================
  var sortedCacheValues = React.useMemo(
    function () {
    ...
    return {
      ...
      blur: function blur() {
        ...
        if (
          ...
          _containerRef$current2.contains(activeElement)
        ) {
          activeElement === null ||
