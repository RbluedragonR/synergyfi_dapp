...
export default function useOffset(
  ...
  var formatRangeValue = React.useCallback(
    function (val) {
      return Math.max(min, Math.min(max, val));
    },
    [min, max]
  );
  var formatStepValue = React.useCallback(
    function (val) {
      if (step !== null) {
        var stepValue =
  ...
  var formatValue = React.useCallback(
    function (val) {
  ...
  var offsetChangedValue = function offsetChangedValue(
    values,
    offset,
    valueIndex
  ) {
