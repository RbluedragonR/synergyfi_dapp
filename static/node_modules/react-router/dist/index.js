    ...
    matches &&
      matches.map((match) =>
        Object.assign({}, match, {
          ...
          pathname: joinPaths([
            parentPathnameBase, // Re-encode pathnames that were decoded inside matchRoutes
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    if (dataRouterState) {
      if (match.route.ErrorBoundary) {
        errorElement = /*#__PURE__*/ React.createElement(
...
function useDataRouterContext(hookName) {
  ...
  !ctx
    ? process.env.NODE_ENV !== "production"
      ? UNSAFE_invariant(false, getDataRouterConsoleError(hookName))
      : UNSAFE_invariant(false)
    : void 0;
  return ctx;
}
...
function useActionData() {
  ...
  !route
    ? process.env.NODE_ENV !== "production"
      ? UNSAFE_invariant(
          false,
          "useActionData must be used inside a RouteContext"
        )
      : UNSAFE_invariant(false)
    : void 0;
...
function RouterProvider(_ref) {
  ...
  let state = useSyncExternalStore(
    router.subscribe,
    getState, // We have to provide this so React@18 doesn't complain during hydration,
...
function Navigate(_ref3) {
  ...
  !useInRouterContext()
    ? process.env.NODE_ENV !== "production"
      ? UNSAFE_invariant(
          false, // TODO: This error is probably because they somehow have 2 versions of
...
function Router(_ref4) {
  ...
  !!useInRouterContext()
    ? process.env.NODE_ENV !== "production"
      ...
      : UNSAFE_invariant(false)
    : void 0; // Preserve trailing slashes on basename, so we can let the user control
...
function createRoutesFromChildren(children, parentPath) {
  ...
  React.Children.forEach(children, (element, index) => {
    ...
    !(!element.props.index || !element.props.children)
      ? process.env.NODE_ENV !== "production"
        ? UNSAFE_invariant(false, "An index route cannot have child routes.")
        : UNSAFE_invariant(false)
      : void 0;
    let route = {
