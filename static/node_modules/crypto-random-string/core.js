...
const createGenerator =
  (generateForCustomCharacters, specialRandomBytes, randomBytes) =>
  ({ length, type, characters }) => {
    ...
    if (type === "url-safe") {
      return generateForCustomCharacters(
        length,
        urlSafeCharacters,
        randomBytes
      );
...
export function createAsyncStringGenerator(
  specialRandomBytesAsync,
  randomBytesAsync
) {
  return createGenerator(
