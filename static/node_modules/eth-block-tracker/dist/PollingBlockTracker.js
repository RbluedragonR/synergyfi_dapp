...
const log = (0, logging_utils_1.createModuleLogger)(
  logging_utils_1.projectLogger,
...
class PollingBlockTracker extends BaseBlockTracker_1.BaseBlockTracker {
  constructor(opts = {}) {
    ...
    super(
      Object.assign(Object.assign({}, opts), {
        blockResetDuration:
          (_a = opts.blockResetDuration) !== null && _a !== void 0
            ? _a
  ...
  async _fetchLatestBlock() {
    ...
    const res = await (0, pify_1.default)((cb) =>
