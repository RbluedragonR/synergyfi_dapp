      ...
      if (i) {
        ...
        if (a) {
          var c = 0 | parseInt(a[1], 10),
            u = a[2];
          0 !== c && (z(u, c), L(e, u, a[3]), e.getTag().insertRules(c, r)),
            (r.length = 0);
        } else r.push(i);
      }
    }
...
function Le(e) {
  ...
  return e.children
    ? r.createElement(Me.Provider, { value: n }, e.children)
    : null;
}
var Fe = {};
function Ye(e, t, n) {
      ...
      return (function (e, t, n, r) {
        ...
        for (var C in N)
          "$" !== C[0] &&
            ...
            ("forwardedAs" === C
              ? (A.as = N[C])
              : (l ? l(C, f, b) : !_ || f(C)) && (A[C] = N[C]));
        return (
          t.style &&
            v.style !== t.style &&
            (A.style = y({}, t.style, {}, v.style)),
  ...
  return (
    ...
    (A.withComponent = function (e) {
      var r = t.componentId,
        ...
        s = r && r + "-" + (xe(e) ? e : je(b(e)));
      return Ye(e, y({}, o, { attrs: g, componentId: s }), n);
    }),
...
var Ue = (function () {
    function e() {
      ...
      (this._emitSheetCSS = function () {
        ...
        (this.getStyleElement = function () {
          ...
          return (
            o && (n.nonce = o),
            [r.createElement("style", y({}, n, { key: "sc-0-0" }))]
          );
        }),
        (this.seal = function () {
          e.sealed = !0;
    ...
    return (
      (t.collectStyles = function (e) {
        return this.sealed
          ? D(2)
          : r.createElement(me, { sheet: this.instance }, e);
      }),
  ...
  Je = function (e) {
    var t = r.forwardRef(function (t, n) {
      ...
      return (
        ...
        r.createElement(e, y({}, t, { theme: a, ref: n }))
      );
    });
