...
var patchResizeHandler = function (
  resizeCallback,
  refreshMode,
  refreshRate,
  refreshOptions
...
var ResizeDetector = /** @class */ (function (_super) {
  ...
  function ResizeDetector(props) {
    ...
    _this.createResizeHandler = function (entries) {
      ...
      var notifyResize = createNotifier(
        function (setStateFunc) {
          return _this.setState(setStateFunc, function () {
            return onResize === null || onResize === void 0
              ? void 0
              : onResize(_this.state.width, _this.state.height);
          });
        },
        handleWidth,
        handleHeight
    ...
    _this.resizeHandler = patchResizeHandler(
  ...
  ResizeDetector.prototype.render = function () {
    ...
    switch (renderType) {
      ...
      case "childFunction": {
        ...
        return childFunction === null || childFunction === void 0
          ? void 0
...
function withResizeDetector(ComponentInner, options) {
  ...
  var ResizeDetectorHOC = /** @class */ (function (_super) {
    ...
    ResizeDetectorHOC.prototype.render = function () {
      ...
      var targetRef =
        forwardedRef !== null && forwardedRef !== void 0
          ? forwardedRef
          : this.ref;
      return React.createElement(
        ResizeDetector,
        __assign({}, options, { targetRef: targetRef }),
        React.createElement(
          ComponentInner,
          __assign({ targetRef: targetRef }, rest)
        )
      );
    };
  ...
  useEnhancedEffect(
    function () {
      ...
      return function () {
        ...
        (_b = (_a = resizeHandler.current).cancel) === null || _b === void 0
          ? void 0
          : _b.call(_a);
      };
    },
