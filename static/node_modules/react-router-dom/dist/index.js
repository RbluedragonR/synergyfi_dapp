  ...
  return React.useCallback(
    function (target, options) {
      ...
      if (fetcherKey) {
        !(routeId != null)
          ? process.env.NODE_ENV !== "production"
            ? UNSAFE_invariant(false, "No routeId available for useFetcher()")
            : UNSAFE_invariant(false)
          : void 0;
...
function useFetcher() {
  ...
  !route
    ? process.env.NODE_ENV !== "production"
      ? UNSAFE_invariant(false, "useFetcher must be used inside a RouteContext")
      : UNSAFE_invariant(false)
    : void 0;
  let routeId =
  ...
  let [Form] = React.useState(() => {
    !routeId
      ? process.env.NODE_ENV !== "production"
        ? UNSAFE_invariant(false, "No routeId available for fetcher.Form()")
        : UNSAFE_invariant(false)
      : void 0;
  ...
  let [load] = React.useState(() => (href) => {
    !router
      ? process.env.NODE_ENV !== "production"
        ? UNSAFE_invariant(false, "No router available for fetcher.load()")
        : UNSAFE_invariant(false)
      : void 0;
    !routeId
      ? process.env.NODE_ENV !== "production"
