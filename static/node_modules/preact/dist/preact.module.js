...
function M(n) {
  ((!n.__d && (n.__d = !0) && i.push(n) && !P.__r++) ||
    o !== l.debounceRendering) &&
    ((o = l.debounceRendering) || r)(P);
}
function P() {
  var n, u, t, o, r, e, c, s;
...
function S(n, l, u, t, i, o, r, f, e, c, s) {
  var a,
    ...
    _ = (t && t.__k) || p,
    g = l.length;
  for (u.__d = e, $(u, l, _), e = u.__d, a = 0; a < g; a++)
    null != (y = u.__k[a]) &&
      "boolean" != typeof y &&
      "function" != typeof y &&
      ((v = -1 === y.__i ? h : _[y.__i] || h),
      (y.__i = a),
      O(n, y, v, i, o, r, f, e, c, s),
      (d = y.__e),
      y.ref &&
        v.ref != y.ref &&
        (v.ref && N(v.ref, null, y), s.push(y.ref, y.__c || d, y)),
      null == w && null != d && (w = d),
    ...
    (r = t + a),
      ...
      (i = n.__k[t] =
        ...
        ? ((i.__ = n),
          ...
          null == o || null === o.__v
            ? (-1 == f && a--, "function" != typeof i.type && (i.__u |= 65536))
            : f !== r &&
              (f == r - 1
                ? (a = f - r)
                : f == r + 1
        ...
        : (o = u[r]) &&
          ...
          o.__e &&
          0 == (131072 & o.__u) &&
          (o.__e == n.__d && (n.__d = x(o)), V(o, o, !1), (u[r] = null), s--);
  if (s)
    for (t = 0; t < c; t++)
      null != (o = u[t]) &&
        0 == (131072 & o.__u) &&
        (o.__e == n.__d && (n.__d = x(o)), V(o, o));
}
function I(n, l, u) {
  var t, i;
...
function L(n, l, u, t) {
  var i = n.key,
    ...
    f = u + 1,
    e = l[u];
  if (null === e || (e && i == e.key && o === e.type && 0 == (131072 & e.__u)))
    return u;
...
function T(n, l, u) {
  "-" === l[0]
    ...
    : (n[l] =
        null == u ? "" : "number" != typeof u || v.test(l) ? u : u + "px");
}
  ...
  n: if ("style" === l)
    ...
    (o = l !== (l = l.replace(/(PointerCapture)$|Capture$/i, "$1"))),
      ...
      u
        ? t
          ? (u.u = t.u)
          : ((u.u = e), n.addEventListener(l, o ? s : c, o))
...
function O(n, u, t, i, o, r, f, e, c, s) {
  ...
  n: if ("function" == typeof T)
    try {
      if (
        ((m = u.props),
        (x = "prototype" in T && T.prototype.render),
        (C = (a = T.contextType) && i[a.__c]),
        ...
        x &&
          ...
          d(h.__s, T.getDerivedStateFromProps(m, h.__s))),
        (v = h.props),
        (w = h.state),
        (h.__v = u),
        p)
        ...
        if (
          (x &&
            ...
            h.componentWillReceiveProps(m, M),
          !h.__e &&
            ((null != h.shouldComponentUpdate &&
              !1 === h.shouldComponentUpdate(m, h.__s, M)) ||
              u.__v === t.__v))
        ) {
          for (
            u.__v !== t.__v && ((h.props = m), (h.state = h.__s), (h.__d = !1)),
              u.__e = t.__e,
              u.__k = t.__k,
      ...
      (h.state = h.__s),
        ...
        x &&
          ...
          (_ = h.getSnapshotBeforeUpdate(v, w)),
        S(
          n,
          y(
            (L =
              null != a && a.type === k && null == a.key ? a.props.children : a)
          )
            ? L
            : [L],
          u,
      ...
      if (((u.__v = null), c || null != r)) {
        for (u.__u |= c ? 160 : 32; e && 8 === e.nodeType && e.nextSibling; )
          e = e.nextSibling;
...
function z(l, u, t, i, o, r, f, e, c) {
  ...
  if (null === b) m === k || (e && l.data === k) || (l.data = k);
  else {
    if (((r = r && n.call(l.childNodes)), (m = t.props || h), !e && null != r))
    ...
    if (a)
      e ||
        (p && (a.__html === p.__html || a.__html === l.innerHTML)) ||
...
function V(n, u, t) {
  ...
  if ((i = n.__k))
    for (o = 0; o < i.length; o++)
      i[o] && V(i[o], u, t || "function" != typeof n.type);
...
function E(l, u, t) {
  ...
  return (
    ...
    g(l.type, e, i || l.key, o || l.ref, null)
  );
}
function G(n, l) {
  var u = {
