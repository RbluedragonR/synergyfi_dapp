...
export var FormStore = /*#__PURE__*/ _createClass(function FormStore(
  ...
  _defineProperty(this, "setInitialValues", function (initialValues, init) {
    ...
    if (init) {
      ...
      (_this$prevWithoutPres = _this.prevWithoutPreserves) === null ||
        _this$prevWithoutPres === void 0 ||
  ...
  _defineProperty(this, "getFieldsValue", function (nameList, filterFunc) {
    ...
    fieldEntities.forEach(function (entity) {
      ...
      if (mergedStrict) {
        var _isList, _ref2;
        if (
          (_isList = (_ref2 = entity).isList) !== null &&
          _isList !== void 0 &&
          _isList.call(_ref2)
        ) {
          return;
        ...
        !mergedNameList &&
        (_isListField = (_ref3 = entity).isListField) !== null &&
        _isListField !== void 0 &&
  ...
  _defineProperty(this, "isMergedPreserve", function (fieldPreserve) {
    var mergedPreserve =
      fieldPreserve !== undefined ? fieldPreserve : _this.preserve;
    return mergedPreserve !== null && mergedPreserve !== void 0
      ? mergedPreserve
      : true;
  });
    ...
    _this.getFieldEntities(true).forEach(function (field) {
      ...
      if (
        ...
        var promise = field.validateRules(
          _objectSpread(
            {
              validateMessages: _objectSpread(
                _objectSpread({}, defaultValidateMessages),
        ...
        promiseList.push(
          promise
            ...
            .catch(function (ruleErrors) {
              ...
              var mergedErrors = [];
              var mergedWarnings = [];
              (_ruleErrors$forEach = ruleErrors.forEach) === null ||
