...
function List(_ref) {
  ...
  var fieldContext = React.useMemo(
    function () {
    ...
    /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        Field,
        {
          ...
          isList: true,
          isListField:
            isListField !== null && isListField !== void 0
              ? isListField
              : !!wrapperListContext,
        },
        function (_ref3, meta) {
          ...
          var operations = {
            add: function add(defaultValue, index) {
              ...
              if (index >= 0 && index <= newValue.length) {
                ...
                onChange(
                  [].concat(_toConsumableArray(newValue), [defaultValue])
                );
              }
              keyManager.id += 1;
            },
