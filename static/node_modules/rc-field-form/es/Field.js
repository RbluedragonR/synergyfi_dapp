        ...
        switch (info.type) {
          ...
          case "setField": {
            ...
            if (namePathMatch) {
              ...
              "value" in data &&
              containsNamePath(namePathList, namePath, true)
            ) {
    ...
    _defineProperty(
      ...
      function (options) {
        ...
        var _ref2 = options || {},
          ...
          validateOnly =
            _ref2$validateOnly === void 0 ? false : _ref2$validateOnly;

        // Force change to async to avoid rule OOD under renderProps field
        var rootPromise = Promise.resolve().then(
                  ...
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 2:
                      (_this$props5 = _this.props),
                        ...
                        (validateFirst =
                          _this$props5$validate === void 0
                            ? false
                            : _this$props5$validate),
                        (messageVariables = _this$props5.messageVariables),
                        (validateDebounce = _this$props5.validateDebounce); // Start validate
        ...
        if (process.env.NODE_ENV !== "production" && valueProps) {
          Object.keys(valueProps).forEach(function (key) {
            warning(
              ...
              "It's not recommended to generate dynamic function prop by `getValueProps`. Please pass it to child component directly (prop: ".concat(
                key,
                ")"
              )
            );
...
function WrapperField(_ref6) {
  ...
  var isMergedListField =
    (_restProps$isListFiel = restProps.isListField) !== null &&
    _restProps$isListFiel !== void 0
      ? _restProps$isListFiel
      : !!listContext;
  var key = "keep";
