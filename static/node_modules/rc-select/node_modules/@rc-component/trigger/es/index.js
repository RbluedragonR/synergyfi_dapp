...
export function generateTrigger() {
  var PortalComponent =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Portal;
  var Trigger = /*#__PURE__*/ React.forwardRef(function (props, ref) {
    ...
    var onPopupPointerDown = useWinClick(
      mergedOpen,
      clickToHide,
      targetEle,
      popupEle,
    ...
    // =========================== Render ===========================
    var mergedChildrenProps = _objectSpread(
      _objectSpread({}, originChildProps),
      cloneProps
    );
    ...
    // Child Node
    var triggerNode = /*#__PURE__*/ React.cloneElement(
      child,
      _objectSpread(_objectSpread({}, mergedChildrenProps), passedProps)
    );
    var arrowPos = {
      x: arrowX,
      y: arrowY,
    ...
    var innerArrow = arrow
      ? _objectSpread({}, arrow !== true ? arrow : {})
      : null;
