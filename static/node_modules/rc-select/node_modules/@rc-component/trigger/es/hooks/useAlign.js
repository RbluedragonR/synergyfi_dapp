...
export default function useAlign(
  ...
  var scrollerList = React.useMemo(
    function () {
      if (!popupEle) {
        return [];
      }
  ...
  var onAlign = useEvent(function () {
    if (popupEle && target && open) {
      ...
      // Placement
      var placementInfo = _objectSpread(
        _objectSpread({}, builtinPlacements[placement]),
        popupAlign
      );
      ...
      if (Array.isArray(target)) {
        ...
        rect.x =
          (_rect$x = rect.x) !== null && _rect$x !== void 0
            ? _rect$x
            : rect.left;
        rect.y =
          (_rect$y = rect.y) !== null && _rect$y !== void 0
            ? _rect$y
            : rect.top;
        targetRect = {
          x: rect.x,
      ...
      popupRect.x =
        (_popupRect$x = popupRect.x) !== null && _popupRect$x !== void 0
          ? _popupRect$x
          : popupRect.left;
      popupRect.y =
        (_popupRect$y = popupRect.y) !== null && _popupRect$y !== void 0
          ? _popupRect$y
          : popupRect.top;
