...
function itemKey(value) {
  var _value$key;
  return (_value$key = value.key) !== null && _value$key !== void 0
    ? _value$key
    : value.value;
}
...
var SelectSelector = function SelectSelector(props) {
  ...
  var defaultRenderSelector = function defaultRenderSelector(
    item,
    content,
    itemDisabled,
    closable,
  ...
  var customizeRenderSelector = function customizeRenderSelector(
    value,
    content,
    itemDisabled,
    closable,
  ...
  // >>> Input Node
  var inputNode = /*#__PURE__*/ React.createElement(
    "div",
    {
