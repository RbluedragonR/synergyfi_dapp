...
var OptionList = function OptionList(_, ref) {
  ...
  var memoFlattenOptions = useMemo(
    function () {
  ...
  var overMaxCount = React.useMemo(
    function () {
      return (
        multiple &&
        isValidCount(maxCount) &&
        (rawValues === null || rawValues === void 0
          ? void 0
  ...
  var getEnabledActiveIndex = function getEnabledActiveIndex(index) {
    ...
    for (var i = 0; i < len; i += 1) {
      ...
      if (
        !group &&
        !(data !== null && data !== void 0 && data.disabled) &&
  ...
  var isAriaSelected = React.useCallback(
    function (value) {
      if (mode === "combobox") {
    ...
    function () {
      ...
      if (open) {
        ...
        (_listRef$current2 = listRef.current) === null ||
          ...
          _listRef$current2.scrollTo(undefined);
      }
      return function () {
    ...
    /*#__PURE__*/ React.createElement(
      ...
      function (item, itemIndex) {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.isValidElement(menuItemSelectedIcon) || selected,
          iconVisible &&
            /*#__PURE__*/ React.createElement(
              TransBtn,
              {
