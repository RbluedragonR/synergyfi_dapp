import {
  RELAYER_DEFAULT_PROTOCOL as Et,
  TRANSPORT_TYPES as f,
  EVENT_CLIENT_SESSION_TRACES as C,
  EVENT_CLIENT_SESSION_ERRORS as F,
  EVENT_CLIENT_AUTHENTICATE_TRACES as Q,
  EVENT_CLIENT_AUTHENTICATE_ERRORS as se,
  EVENT_CLIENT_PAIRING_ERRORS as Rt,
  EVENT_CLIENT_PAIRING_TRACES as St,
  RELAYER_EVENTS as Ue,
  VERIFY_SERVER as It,
  EXPIRER_EVENTS as ft,
  PAIRING_EVENTS as Ge,
  Store as H,
  Core as vt,
} from "@walletconnect/core";
import {
  pino as qt,
  getDefaultLoggerOptions as Tt,
  generateChildLogger as Nt,
  getLoggerContext as Pt,
} from "@walletconnect/logger";
import { IEngine as Ot, ISignClient as At } from "@walletconnect/types";
import {
  getInternalError as u,
  calcExpiry as A,
  createDelayedPromise as Y,
  engineEvent as g,
  getSdkError as P,
  getDeepLink as bt,
  handleDeeplinkRedirect as Ct,
  isSessionCompatible as Dt,
  hashKey as Te,
  parseChainId as Ne,
  createEncodedRecap as Lt,
  getRecapFromResources as Pe,
  mergeEncodedRecaps as Vt,
  TYPE_2 as xt,
  BASE64URL as ie,
  getLinkModeURL as he,
  validateSignedCacao as je,
  getNamespacedDidChainId as Fe,
  getDidAddress as Qe,
  getMethodsFromRecap as ze,
  getChainsFromRecap as He,
  buildNamespacesFromAuth as Ye,
  formatMessage as Mt,
  BASE64 as de,
  hashMessage as X,
  isExpired as J,
  ...
  isValidRelays as kt,
  isValidObject as Xe,
  isValidRequiredNamespaces as $t,
  isValidNamespaces as Oe,
  isConformingNamespaces as Je,
  isValidString as k,
  isValidErrorReason as Kt,
  isValidRelay as Ut,
  isValidController as Gt,
  isValidNamespacesChainId as Be,
  isValidRequest as jt,
  isValidNamespacesRequest as Ft,
  isValidRequestExpiry as Qt,
  isValidResponse as zt,
  isValidEvent as Ht,
  isValidNamespacesEvent as Yt,
  getSearchParamFromURL as We,
  isReactNative as Xt,
  parseExpirerTarget as Jt,
  isValidId as Bt,
  TYPE_1 as Ae,
  getAppMetadata as Wt,
} from "@walletconnect/utils";
import Zt, { EventEmitter as es } from "events";
import {
  THIRTY_DAYS as ts,
  SEVEN_DAYS as Ze,
  FIVE_MINUTES as b,
...
import {
  payloadId as B,
  getBigIntRpcId as ue,
  isJsonRpcResult as K,
  isJsonRpcError as U,
  formatJsonRpcRequest as ge,
  formatJsonRpcResult as is,
  formatJsonRpcError as rs,
  isJsonRpcRequest as ns,
  isJsonRpcResponse as os,
...
const be = "wc",
  ...
  v = {
    wc_sessionPropose: {
      req: { ttl: b, prompt: !0, tag: 1100 },
      res: { ttl: b, prompt: !1, tag: 1101 },
      reject: { ttl: b, prompt: !1, tag: 1120 },
      autoReject: { ttl: b, prompt: !1, tag: 1121 },
    },
    wc_sessionSettle: {
      req: { ttl: b, prompt: !1, tag: 1102 },
      res: { ttl: b, prompt: !1, tag: 1103 },
    },
    wc_sessionUpdate: {
      req: { ttl: $, prompt: !1, tag: 1104 },
      res: { ttl: $, prompt: !1, tag: 1105 },
    },
    wc_sessionExtend: {
      req: { ttl: $, prompt: !1, tag: 1106 },
      res: { ttl: $, prompt: !1, tag: 1107 },
    },
    wc_sessionRequest: {
      req: { ttl: b, prompt: !0, tag: 1108 },
      res: { ttl: b, prompt: !1, tag: 1109 },
    },
    wc_sessionEvent: {
      req: { ttl: b, prompt: !0, tag: 1110 },
      res: { ttl: b, prompt: !1, tag: 1111 },
    },
    wc_sessionDelete: {
      req: { ttl: $, prompt: !1, tag: 1112 },
      res: { ttl: $, prompt: !1, tag: 1113 },
    },
    wc_sessionPing: {
      req: { ttl: $, prompt: !1, tag: 1114 },
      res: { ttl: $, prompt: !1, tag: 1115 },
    },
    wc_sessionAuthenticate: {
      req: { ttl: et, prompt: !0, tag: 1116 },
      res: { ttl: et, prompt: !1, tag: 1117 },
      reject: { ttl: b, prompt: !1, tag: 1118 },
      autoReject: { ttl: b, prompt: !1, tag: 1119 },
    },
  },
  me = { min: b, max: Ze },
  L = { idle: "IDLE", active: "ACTIVE" },
  ot = "request",
  at = [
    "wc_sessionPropose",
    "wc_sessionRequest",
...
var gs = Object.defineProperty,
  ...
  gt = (q, o, e) =>
    o in q
      ? gs(q, o, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (q[o] = e),
  I = (q, o) => {
    for (var e in o || (o = {})) ms.call(o, e) && gt(q, e, o[e]);
    if (ut) for (var e of ut(o)) _s.call(o, e) && gt(q, e, o[e]);
    return q;
  },
  V = (q, o) => ys(q, ws(o));
class Es extends Ot {
  constructor(o) {
    super(o),
      ...
      (this.events = new Zt()),
      (this.initialized = !1),
      (this.requestQueue = { state: L.idle, queue: [] }),
      (this.sessionRequestQueue = { state: L.idle, queue: [] }),
      (this.requestQueueDelay = ss),
      ...
      (this.init = async () => {
        this.initialized ||
          ...
          this.client.core.pairing.register({ methods: Object.keys(v) }),
          (this.initialized = !0),
          setTimeout(() => {
      ...
      (this.connect = async (e) => {
        ...
        const d = await this.client.core.crypto.generateKeyPair(),
          ...
          { reject: y, resolve: _, done: R } = Y(l, it);
        this.events.once(
          g("session_connect"),
        ...
        const x = await this.sendRequest({
          topic: c,
        ...
        return (
          await this.setProposal(x, I({ id: x }, m)), { uri: h, approval: R }
        );
      }),
      (this.pair = async (e) => {
        this.isInitialized(), await this.confirmOnlineStateOrThrow();
      ...
      (this.approve = async (e) => {
        ...
        try {
          ...
          throw (
            ...
            r.setError(F.proposal_not_found),
            N)
          );
        }
        try {
          ...
          throw (
            ...
            r.setError(F.session_approve_namespace_validation_failure),
            N)
          );
        }
        const {
            ...
            (i = this.client.core.eventClient) == null
              ...
              : i.createEvent({
                  ...
                  properties: {
                    topic: l,
                    trace: [
                      C.session_approve_started,
                      C.session_namespaces_validation_success,
                    ],
                  },
                }));
            ...
            I(
              {
                ...
                namespaces: c,
                controller: { publicKey: R, metadata: this.client.metadata },
                expiry: A(z),
              },
        ...
        try {
          _.addTrace(C.publishing_session_settle),
            ...
            _.addTrace(C.session_settle_publish_success),
            _.addTrace(C.publishing_session_approve),
          ...
          throw (
            ...
            this.client.session.delete(E, P("USER_DISCONNECTED")),
        ...
        return (
          ...
          await this.client.proposal.delete(n, P("USER_DISCONNECTED")),
      ...
      (this.reject = async (e) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(`reject() -> proposal.get(${t}) failed`),
            r)
          );
        }
        i &&
      ...
      (this.update = async (e) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error("update() -> isValidUpdate() failed"), p)
          );
        }
        const { topic: t, namespaces: s } = e,
          { done: i, resolve: r, reject: n } = Y(),
          a = B(),
          c = ue().toString(),
          h = this.client.session.get(t).namespaces;
        return (
          this.events.once(g("session_update", a), ({ error: p }) => {
            p ? n(p) : r();
          }),
          ...
          await this.sendRequest({
            ...
            this.client.logger.error(p),
              this.client.session.update(t, { namespaces: h }),
              n(p);
          }),
          { acknowledged: i }
        );
      ...
      (this.request = async (e) => {
        ...
        this.events.once(g("session_request", a), ({ error: w, result: m }) => {
          w ? d(w) : p(m);
        });
        ...
        return l
          ? (await this.sendRequest({
              ...
              params: {
                request: V(I({}, s), { expiryTimestamp: A(r) }),
                chainId: t,
              },
              expiry: r,
              throwOnFailedPublish: !0,
          ...
          : await Promise.all([
              ...
              new Promise(async (w) => {
                ...
                if (!((m = n.sessionConfig) != null && m.disableDeepLink)) {
                  const y = await bt(this.client.core.storage, Le);
                  Ct({ id: a, topic: i, wcDeepLink: y });
                }
                w();
              }),
              h(),
      ...
      (this.find = (e) => (
        this.isInitialized(),
        this.client.session.getAll().filter((t) => Dt(t, e))
      )),
      ...
      (this.authenticate = async (e, t) => {
        ...
        const {
          ...
          _ = [...(e.resources || [])],
          { topic: R, uri: x } = await this.client.core.pairing.create({
            methods: ["wc_sessionAuthenticate"],
            transportType: r,
          });
        this.client.logger.info({
          message: "Generated new pairing",
          pairing: { topic: R, uri: x },
        });
        ...
        if (
          ...
          const { namespace: O } = Ne(n[0]);
          let T = Lt(O, "request", m);
          Pe(_) && (T = Vt(T, _.pop())), _.push(T);
        }
        const M =
            y && y > v.wc_sessionAuthenticate.req.ttl
              ? y
              : v.wc_sessionAuthenticate.req.ttl,
          W = {
            authPayload: {
              type: d ?? "caip122",
              chains: n,
          ...
          { done: wt, resolve: xe, reject: Ee } = Y(M, "Request expired"),
          ce = async ({ error: O, session: T }) => {
            if ((this.events.off(g("session_request", G), Re), O)) Ee(O);
            else if (T) {
              (T.self.publicKey = E),
          ...
          Re = async (O) => {
            ...
            if (
              ...
              return O.error.code === te.code
                ? void 0
                : (this.events.off(g("session_connect"), ce),
                  Ee(O.error.message));
            }
            ...
            Ie.length > 0 &&
              ...
              (T = this.client.metadata.redirect) != null &&
                ...
                this.client.session.update(ee, { transportType: f.link_mode })),
              xe({ auths: ke, session: pe });
          },
          G = B(),
          Z = B();
        this.events.once(g("session_connect"), ce),
          this.events.once(g("session_request", G), Re);
        let Se;
        try {
          if (i) {
          ...
          throw (
            (this.events.off(g("session_connect"), ce),
            this.events.off(g("session_request", G), Re),
            O)
          );
        }
        return (
          await this.setProposal(Z, I({ id: Z }, Ve)),
          await this.setAuthRequest(G, {
            request: V(I({}, W), { verifyContext: {} }),
            pairingTopic: R,
            transportType: r,
          }),
      ...
      (this.approveSessionAuthenticate = async (e) => {
        ...
        if (!r)
          throw (
            (i.setError(se.authenticated_session_pending_request_not_found),
            new Error(`Could not find pending auth request with id ${t}`))
          );
        ...
        const a = r.requester.publicKey,
          ...
          h = Te(a),
          p = { type: Ae, receiverPublicKey: a, senderPublicKey: c },
          d = [],
          l = [];
        for (const y of s) {
          if (
            !(await je({ cacao: y, projectId: this.client.core.projectId }))
          ) {
        ...
        if (d?.length > 0) {
          ...
          try {
            ...
            throw (
              (i.setError(se.subscribe_authenticated_session_topic_failure), y)
            );
          }
          i.addTrace(Q.subscribe_authenticated_session_topic_success),
            await this.client.session.set(w, m),
            i.addTrace(Q.store_authenticated_session),
            await this.client.core.pairing.updateMetadata({
        ...
        try {
          ...
          throw (
            (i.setError(se.authenticated_session_approve_publish_failure), y)
          );
        }
        return (
      ...
      (this.rejectSessionAuthenticate = async (e) => {
        ...
        const r = i.requester.publicKey,
          ...
          a = Te(r),
          c = { type: Ae, receiverPublicKey: r, senderPublicKey: n };
        await this.sendError({
          id: t,
          topic: a,
          error: s,
            ...
            const t = this.client.core.pairing.pairings.get(e.pairingTopic),
              s = this.client.core.pairing.pairings.getAll().filter((i) => {
                ...
                return (
                  ...
                  ((n = i.peerMetadata) == null ? void 0 : n.url) ===
                    e.peer.metadata.url &&
                  i.topic &&
                  i.topic !== t.topic
                );
      ...
      (this.deleteSession = async (e) => {
        ...
        await this.client.core.relayer.unsubscribe(s),
          await this.client.session.delete(s, P("USER_DISCONNECTED")),
          ...
          this.getPendingSessionRequests().forEach((c) => {
            c.topic === s &&
              this.deletePendingSessionRequest(c.id, P("USER_DISCONNECTED"));
          }),
          s ===
            ((t = this.sessionRequestQueue.queue[0]) == null
              ? void 0
              : t.topic) && (this.sessionRequestQueue.state = L.idle),
      ...
      (this.deleteProposal = async (e, t) => {
        ...
        await Promise.all([
          this.client.proposal.delete(e, P("USER_DISCONNECTED")),
      ...
      (this.deletePendingSessionRequest = async (e, t, s = !1) => {
        await Promise.all([
          ...
          (this.sessionRequestQueue.queue =
            this.sessionRequestQueue.queue.filter((i) => i.id !== e)),
          s &&
            ((this.sessionRequestQueue.state = L.idle),
      ...
      (this.setProposal = async (e, t) => {
        this.client.core.expirer.set(e, A(v.wc_sessionPropose.req.ttl)),
          await this.client.proposal.set(e, t);
      }),
      (this.setAuthRequest = async (e, t) => {
        const { request: s, pairingTopic: i, transportType: r = f.relay } = t;
      ...
      (this.sendRequest = async (e) => {
        ...
        if (
          ...
          r && (y.ttl = r),
            n && (y.id = n),
            c
              ? ((y.internal = V(I({}, y.internal), {
                  throwOnFailedPublish: !0,
                })),
                await this.client.core.relayer.publish(t, d, y))
      ...
      (this.sendResult = async (e) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(
              `sendResult() -> history.get(${s}, ${t}) failed`
            ),
            l)
          );
        }
        if (p) {
          ...
          r
            ? ((l.internal = V(I({}, l.internal), {
                throwOnFailedPublish: !0,
              })),
              await this.client.core.relayer.publish(s, h, l))
            : this.client.core.relayer
                .publish(s, h, l)
      ...
      (this.sendError = async (e) => {
        ...
        try {
          ...
          throw (
            (this.client.logger.error(
              `sendError() -> history.get(${s}, ${t}) failed`
            ),
            l)
          );
        }
      ...
      (this.onSessionProposeRequest = async (e) => {
        ...
        try {
          ...
          const h = n.expiryTimestamp || A(v.wc_sessionPropose.req.ttl),
            p = I({ id: a, pairingTopic: t, expiryTimestamp: h }, n);
          ...
          this.client.events.listenerCount("session_proposal") === 0 &&
            ...
            c?.setError(Rt.proposal_listener_not_found)),
            c?.addTrace(St.emit_session_proposal),
      ...
      (this.onSessionProposeResponse = async (e, t, s) => {
        ...
        if (K(t)) {
          ...
          this.events.emit(g("session_connect"), { error: t.error });
        }
      }),
      (this.onSessionSettleRequest = async (e, t) => {
        ...
        try {
          ...
          this.events.emit(g("session_connect"), { session: d }),
            await this.sendResult({
              id: t.id,
              topic: e,
              result: !0,
      ...
      (this.onSessionSettleResponse = async (e, t) => {
        ...
        K(t)
          ...
          : U(t) &&
            (await this.client.session.delete(e, P("USER_DISCONNECTED")),
            this.events.emit(g("session_approve", s), { error: t.error }));
      }),
      (this.onSessionUpdateRequest = async (e, t) => {
        ...
        try {
          ...
          await this.sendError({ id: i, topic: e, error: r }),
            this.client.logger.error(r);
        }
      }),
      ...
      (this.onSessionUpdateResponse = (e, t) => {
        ...
        K(t)
          ...
          : U(t) &&
            this.events.emit(g("session_update", s), { error: t.error });
      }),
      (this.onSessionExtendRequest = async (e, t) => {
        ...
        try {
          ...
          await this.sendError({ id: s, topic: e, error: i }),
      ...
      (this.onSessionExtendResponse = (e, t) => {
        ...
        K(t)
          ...
          : U(t) &&
            this.events.emit(g("session_extend", s), { error: t.error });
      }),
      ...
      (this.onSessionPingResponse = (e, t) => {
        ...
        setTimeout(() => {
          K(t)
            ...
            : U(t) &&
              this.events.emit(g("session_ping", s), { error: t.error });
        }, 500);
      }),
        ...
        try {
          ...
          await this.setPendingSessionRequest(m),
            h === f.link_mode &&
              ...
              t.universal &&
              this.client.core.addLinkModeSupportedApp(
                (s = l.peer.metadata.redirect) == null ? void 0 : s.universal
              ),
          ...
          await this.sendError({ id: p, topic: r, error: l }),
      ...
      (this.onSessionRequestResponse = (e, t) => {
        ...
        if (this.events.listenerCount(i) === 0)
          throw new Error(`emitting ${i} without any listeners`);
        K(t)
          ? this.events.emit(g("session_request", s), { result: t.result })
          : U(t) &&
            this.events.emit(g("session_request", s), { error: t.error });
      }),
      ...
      (this.onSessionAuthenticateRequest = async (e) => {
        ...
        try {
          ...
          const h = i.params.requester.publicKey,
            ...
            l = { type: Ae, receiverPublicKey: h, senderPublicKey: p };
          await this.sendError({
            id: i.id,
            topic: s,
            error: c,
      ...
      (this.cleanupPendingSentRequestsForTopic = ({ topic: e, error: t }) => {
        ...
        s.length > 0 &&
          s
            .filter(
              (i) => i.topic === e && i.request.method === "wc_sessionRequest"
            )
            .forEach((i) => {
      ...
      (this.processSessionRequestQueue = () => {
        ...
        try {
          (this.sessionRequestQueue.state = L.active),
      ...
      (this.isValidApprove = async (e) => {
        if (!D(e))
          throw new Error(
            u("MISSING_OR_INVALID", `approve() params: ${e}`).message
          );
        const {
          id: t,
          namespaces: s,
      ...
      (this.isValidSessionSettleRequest = (e) => {
        ...
        if (a) throw new Error(a.message);
        if (J(r)) {
          const { message: c } = u("EXPIRED", "onSessionSettleRequest()");
          throw new Error(c);
        }
      }),
      ...
      (this.isValidRequest = async (e) => {
        ...
        if (r && !Qt(r, me)) {
          const { message: a } = u(
            "MISSING_OR_INVALID",
            `request() expiry: ${r}. Expiry must be a number (in seconds) between ${me.min} and ${me.max}`
          );
          throw new Error(a);
        }
      }),
      (this.isValidRespond = async (e) => {
        ...
        try {
          ...
          throw (
            ((t = e?.response) != null && t.id && this.cleanupAfterResponse(e),
            r)
          );
        }
        if (!zt(i)) {
      ...
      (this.isValidPing = async (e) => {
        if (!D(e)) {
          const { message: s } = u("MISSING_OR_INVALID", `ping() params: ${e}`);
          throw new Error(s);
        }
        const { topic: t } = e;
      ...
      (this.isValidEmit = async (e) => {
        if (!D(e)) {
          const { message: n } = u("MISSING_OR_INVALID", `emit() params: ${e}`);
          throw new Error(n);
        }
        const { topic: t, event: s, chainId: i } = e;
      ...
      (this.isValidAuthenticate = (e) => {
        ...
        if ([...new Set(t.map((a) => Ne(a).namespace))].length > 1)
          throw new Error(
            "Multi-namespace requests are not supported. Please request single namespace only."
          );
        const { namespace: n } = Ne(t[0]);
        if (n !== "eip155")
          throw new Error(
      ...
      (this.getVerifyContext = async (e) => {
        ...
        try {
          if (n === f.link_mode) {
            ...
            return (
              (a.verified.validation =
                h && new URL(h).origin === new URL(r.url).origin
                  ? "VALID"
                  : "INVALID"),
              a
            );
          ...
          c &&
            ...
            (a.verified.validation =
              c.origin === new URL(r.url).origin ? "VALID" : "INVALID"));
        } catch (c) {
          this.client.logger.warn(c);
        }
        return (
          this.client.logger.debug(`Verify context: ${JSON.stringify(a)}`), a
        );
      }),
      ...
      (this.isLinkModeEnabled = (e, t) => {
        ...
        return !e || t !== f.link_mode
          ? !1
          : ((i = (s = this.client.metadata) == null ? void 0 : s.redirect) ==
            null
              ? void 0
              : i.linkMode) === !0 &&
              ((n = (r = this.client.metadata) == null ? void 0 : r.redirect) ==
              null
                ? void 0
                : n.universal) !== void 0 &&
              ((c = (a = this.client.metadata) == null ? void 0 : a.redirect) ==
              null
                ? void 0
                : c.universal) !== "" &&
      ...
      (this.handleLinkModeMessage = ({ url: e }) => {
        ...
        i && this.client.session.update(t, { transportType: f.link_mode }),
      ...
      (this.registerLinkModeListeners = async () => {
        var e;
        if (
          (typeof process < "u" && process.env.IS_VITEST) ||
          (Xt() && (e = this.client.metadata.redirect) != null && e.linkMode)
        ) {
  ...
  isInitialized() {
    if (!this.initialized) {
      const { message: o } = u("NOT_INITIALIZED", this.name);
      throw new Error(o);
    }
  }
  ...
  registerRelayerEvents() {
    this.client.core.relayer.on(Ue.message, (o) => {
      !this.initialized || this.relayMessageCache.length > 0
        ...
        : this.onRelayMessage(o);
    });
  }
  async onRelayMessage(o) {
    const { topic: e, message: t, attestation: s, transportType: i } = o,
      { publicKey: r } = this.client.auth.authKeys.keys.includes(ae)
        ? this.client.auth.authKeys.get(ae)
  ...
  registerExpirerEvents() {
    this.client.core.expirer.on(ft.expired, async (o) => {
      const { topic: e, id: t } = Jt(o.target);
      if (t && this.client.pendingRequest.keys.includes(t))
        return await this.deletePendingSessionRequest(t, u("EXPIRED"), !0);
      if (t && this.client.auth.requests.keys.includes(t))
        return await this.deletePendingAuthRequest(t, u("EXPIRED"), !0);
      e
        ? this.client.session.keys.includes(e) &&
          (await this.deleteSession({ topic: e, expirerHasDeleted: !0 }),
          this.client.events.emit("session_expire", { topic: e }))
        : t &&
          (await this.deleteProposal(t, !0),
          this.client.events.emit("proposal_expire", { id: t }));
    });
  }
  registerPairingEvents() {
    this.client.core.pairing.events.on(Ge.create, (o) =>
      this.onPairingCreated(o)
    ),
      this.client.core.pairing.events.on(Ge.delete, (o) => {
  ...
  isValidPairingTopic(o) {
    ...
    if (J(this.client.core.pairing.pairings.get(o).expiry)) {
      const { message: e } = u("EXPIRED", `pairing topic: ${o}`);
      throw new Error(e);
    }
  }
  async isValidSessionTopic(o) {
    ...
    if (J(this.client.session.get(o).expiry)) {
      ...
      const { message: e } = u("EXPIRED", `session topic: ${o}`);
      throw new Error(e);
    }
  ...
  async isValidProposalId(o) {
    ...
    if (J(this.client.proposal.get(o).expiryTimestamp)) {
      ...
      const { message: e } = u("EXPIRED", `proposal id: ${o}`);
      throw new Error(e);
    }
  }
}
...
class _e extends At {
  constructor(o) {
    super(o),
      ...
      (this.name = o?.name || we.name),
      (this.metadata = o?.metadata || Wt()),
      (this.signConfig = o?.signConfig);
    const e =
      typeof o?.logger < "u" && typeof o?.logger != "string"
        ? o.logger
        : qt(Tt({ level: o?.logger || we.logger }));
    (this.core = o?.core || new vt(o)),
      (this.logger = Nt(e, this.name)),
      (this.session = new yt(this.core, this.logger)),
...
export {
  lt as AUTH_CONTEXT,
  pt as AUTH_KEYS_CONTEXT,
  ht as AUTH_PAIRING_TOPIC_CONTEXT,
  ct as AUTH_PROTOCOL,
  ae as AUTH_PUBLIC_KEY_NAME,
  dt as AUTH_REQUEST_CONTEXT,
  oe as AUTH_STORAGE_PREFIX,
  us as AUTH_VERSION,
  nt as ENGINE_CONTEXT,
  L as ENGINE_QUEUE_STATES,
  v as ENGINE_RPC_OPTS,
  ps as HISTORY_CONTEXT,
  ls as HISTORY_EVENTS,
  hs as HISTORY_STORAGE_VERSION,
  at as METHODS_TO_VERIFY,
  st as PROPOSAL_CONTEXT,
  ds as PROPOSAL_EXPIRY,
  it as PROPOSAL_EXPIRY_MESSAGE,
  ot as REQUEST_CONTEXT,
  rt as SESSION_CONTEXT,
  z as SESSION_EXPIRY,
  me as SESSION_REQUEST_EXPIRY_BOUNDARIES,
  De as SIGN_CLIENT_CONTEXT,
  we as SIGN_CLIENT_DEFAULT,
  as as SIGN_CLIENT_EVENTS,
  be as SIGN_CLIENT_PROTOCOL,
  cs as SIGN_CLIENT_STORAGE_OPTIONS,
  ye as SIGN_CLIENT_STORAGE_PREFIX,
  Ce as SIGN_CLIENT_VERSION,
  Ts as SessionStore,
  Ns as SignClient,
  Le as WALLETCONNECT_DEEPLINK_CHOICE,
  _e as default,
};
