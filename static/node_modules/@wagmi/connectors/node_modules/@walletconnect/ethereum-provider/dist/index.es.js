...
var q = Object.defineProperty,
  ...
  O = (r, t, s) =>
    t in r
      ? q(r, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
      : (r[t] = s),
  p = (r, t) => {
...
class C {
    ...
    try {
      const i = await new Promise(async (n, o) => {
          ...
          this.rpc.showQrModal &&
            ...
            await this.signer
              .authenticate(E(p({}, t), { chains: this.rpc.chains }), s)
              .then((a) => {
                n(a);
              })
              .catch((a) => {
  ...
  getRpcConfig(t) {
    ...
    const c = e.length ? t?.methods || u : [],
      a = e.length ? t?.events || g : [],
      h = t?.optionalMethods || [],
      d = t?.optionalEvents || [],
