import qg, { PROPOSAL_EXPIRY_MESSAGE as Ug } from "@walletconnect/sign-client";
import {
  isValidObject as Fg,
...
import { JsonRpcProvider as Wt } from "@walletconnect/jsonrpc-provider";
...
const ya = "error",
  ...
  Kn = "generic",
  Tt = { DEFAULT_CHAIN_CHANGED: "default_chain_changed" };
var _e =
    typeof globalThis < "u"
      ? globalThis
      : typeof window < "u"
 ...
 */ (function (P, s) {
  (function () {
    ...
    function Dr(h, g, d) {
      for (var A = -1, R = h == null ? 0 : h.length; ++A < R; )
        if (d(g, h[A])) return !0;
      return !1;
    }
    function z(h, g) {
      for (var d = -1, A = h == null ? 0 : h.length, R = Array(A); ++d < A; )
        R[d] = g(h[d], d, h);
      return R;
    }
    function rn(h, g) {
    ...
    function Oe(h, g, d, A) {
      for (var R = h.length, q = d + (A ? 1 : -1); A ? q-- : ++q < R; )
        if (g(h[q], q, h)) return q;
      return -1;
    }
    function Ln(h, g, d) {
    ...
    var Rf = function h(g) {
        ...
        function Fc(t) {
          ...
          var n = pe(t),
            e = [];
          for (var r in t)
            (r == "constructor" && (n || !W.call(t, r))) || e.push(r);
          return e;
        }
        function ni(t, n) {
          return t < n;
        ...
        function ei(t, n, e, r) {
          ...
          for (t === n && (n = ut(n)), e && (c = z(t, ht(e))); ++o < f; )
            for (
              ...
              c !== t && qe.call(c, l, 1), qe.call(t, l, 1);
          return t;
        }
        function su(t, n) {
        ...
        function ui(t, n) {
          return (
            (n = fn(n, t)), (t = $u(t, n)), t == null || delete t[Ft(It(n))]
          );
        }
        function fu(t, n, e, r) {
        ...
        function Ve(t, n, e, r, u, o, f, c, l, v) {
          var _ = n & Bt,
            ...
            L = C ? i : le(t);
          function S() {
            for (var D = arguments.length, $ = d(D), dt = D; dt--; )
              $[dt] = arguments[dt];
            if (I)
              var st = Bn(S),
                gt = gf($, st);
        ...
        function li(t) {
          ...
          return function (e, r) {
            if (
              ((e = xt(e)), (r = r == null ? 0 : nt(T(r), 292)), r && Us(e))
            ) {
              var u = (U(e) + "e").split("e"),
                o = n(u[0] + "e" + (+u[1] + r));
        ...
        function nr(t) {
          for (
            var n = t.name + "", e = Un[n], r = W.call(Un, n) ? e.length : 0;
            r--;
...
`
        ...
        function it(t, n, e) {
          ...
          var r = typeof n;
          return (
            r == "number" ? at(e) && Xt(n, e.length) : r == "string" && n in e
          )
            ? Rt(e[n], t)
            : !1;
        }
        function mi(t, n) {
          ...
          return e == "number" ||
            ...
            pt(t)
            ? !0
            : co.test(t) || !fo.test(t) || (n != null && t in M(n));
        }
        function vh(t) {
          var n = typeof t;
          return n == "string" ||
        ...
        function Ph(t, n) {
          var e = t[1],
            ...
            f =
              (r == Bt && e == Dt) ||
              (r == Bt && e == Yn && t[7].length <= n[8]) ||
              (r == (Bt | Yn) && n[7].length <= n[8] && e == Dt);
          if (!(o || f)) return t;
        ...
        var ll = H(function (t) {
          ...
          dl = H(function (t) {
            var n = It(t);
            return (
              (n = typeof n == "function" ? n : i), on(tt(t, 1, Y, !0), i, n)
            );
          });
        function gl(t) {
        ...
        var ud = Iu(function (t, n, e) {
            n != null && typeof n.toString != "function" && (n = He.call(n)),
              (t[n] = e);
          }, Ti(ft)),
          ad = Iu(function (t, n, e) {
            n != null && typeof n.toString != "function" && (n = He.call(n)),
              W.call(t, n) ? t[n].push(e) : (t[n] = [e]);
          }, E),
          od = H(fe);
        function V(t) {
        ...
        function $d(t, n, e) {
          return (
            e || n == null ? (n = 0) : n && (n = +n),
            Gf(U(t).replace(yr, ""), n || 0)
          );
        }
        function qd(t, n, e) {
          return (
            (e ? it(t, n, e) : n === i) ? (n = 1) : (n = T(n)), ii(U(t), n)
          );
        }
        function Ud() {
          var t = arguments,
          ...
          if ((f && (c += l.length - c), Si(u))) {
            if (t.slice(c).search(u)) {
              var v,
                _ = l;
              for (
                u.global || (u = Gr(u.source, U(Qi.exec(u)) + "g")),
                  u.lastIndex = 0;
                (v = u.exec(_));
...
function Ta(P) {
  ...
  for (const [O, k] of Object.entries(P)) {
    const tn = Aa(O) ? [O] : k.chains,
      Jn = k.methods || [],
      xn = k.events || [],
      Ht = k.rpcMap || {},
      Mt = ve(O);
    x[Mt] = tv(lr(lr({}, x[Mt]), k), {
      chains: qi(tn, (s = x[Mt]) == null ? void 0 : s.chains),
      methods: qi(Jn, (i = x[Mt]) == null ? void 0 : i.methods),
      events: qi(xn, (p = x[Mt]) == null ? void 0 : p.events),
...
class rv {
  ...
  setDefaultChain(s, i) {
    this.httpProviders[s] || this.setHttpProvider(s, i),
      (this.chainId = s),
      this.events.emit(Tt.DEFAULT_CHAIN_CHANGED, `${this.name}:${s}`);
  }
  getAccounts() {
  ...
  createHttpProvider(s, i) {
    ...
    return new Wt(new jt(p, F("disableProviderPing")));
  }
}
...
class fv {
  ...
  createHttpProvider(s, i) {
    const p =
      i || Lt(`${this.name}:${s}`, this.namespace, this.client.core.projectId);
    if (!p) throw new Error(`No RPC url provided for chainId: ${s}`);
    return new Wt(new Bg(p, F("disableProviderPing")));
  }
  setHttpProvider(s, i) {
    const p = this.createHttpProvider(s, i);
    p && (this.httpProviders[s] = p);
...
class lv {
  ...
  setDefaultChain(s, i) {
    if (!this.httpProviders[s]) {
      const p =
        i ||
        Lt(`${this.name}:${s}`, this.namespace, this.client.core.projectId);
      if (!p) throw new Error(`No RPC url provided for chainId: ${s}`);
  ...
  createHttpProvider(s, i) {
    ...
    return typeof p > "u"
      ? void 0
      : new Wt(new jt(p, F("disableProviderPing")));
  }
}
class pv {
  constructor(s) {
...
var mv = Object.defineProperty,
  ...
  Fa = (P, s, i) =>
    s in P
      ? mv(P, s, { enumerable: !0, configurable: !0, writable: !0, value: i })
      : (P[s] = i),
  pr = (P, s) => {
...
class dr {
  ...
  async authenticate(s, i) {
    ...
    if (((this.session = x.session), this.session)) {
      ...
      (this.namespaces = Fi(this.namespaces, O)),
        ...
        switch (i) {
          ...
          default:
            this.rpcProviders[Kn]
              ? this.rpcProviders[Kn].updateNamespace(O)
              : (this.rpcProviders[Kn] = new _v({ namespace: O }));
        }
      });
  }
...
const Iv = dr;
export { Iv as UniversalProvider, dr as default };
