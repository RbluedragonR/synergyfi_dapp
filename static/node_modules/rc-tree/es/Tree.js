  ...
  function Tree() {
    ...
    _defineProperty(
      ...
      function (event, node) {
        ...
        var abstractDropNodeProps = _objectSpread(
          _objectSpread(
            {},
          ...
          {
            active:
              ((_this$getActiveItem = _this.getActiveItem()) === null ||
              _this$getActiveItem === void 0
                ? void 0
        ...
        var dropResult = {
          ...
          dragNode: _this.dragNode
            ? convertNodePropsToEventData(_this.dragNode.props)
            : null,
      ...
      function (e, treeNode, checked) {
        ...
        if (checkStrictly) {
          ...
          var _conductCheck = conductCheck(
              [].concat(_toConsumableArray(oriCheckedKeys), [key]),
              true,
              keyEntities
            ),
    ...
    _defineProperty(
      ...
      function (treeNode) {
        ...
        if (
          entity !== null &&
          entity !== void 0 &&
          (_entity$children = entity.children) !== null &&
          _entity$children !== void 0 &&
    ...
    _defineProperty(
      ...
      function (newActiveKey) {
        ...
        var _this$props9 = _this.props,
          ...
          itemScrollOffset =
            _this$props9$itemScro === void 0 ? 0 : _this$props9$itemScro;
      ...
      function (state) {
        ...
        if (!_this.destroyed) {
          ...
          if (needSync && (!atomic || allPassed)) {
            _this.setState(
              _objectSpread(_objectSpread({}, newState), forceState)
            );
          }
        }
      }
      ...
      },
      {
        ...
        value: function onUpdated() {
          var _this$props11 = this.props,
            ...
            itemScrollOffset =
              _this$props11$itemScr === void 0 ? 0 : _this$props11$itemScr;
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props12 = this.props,
            ...
            tabIndex =
              _this$props12$tabInde === void 0 ? 0 : _this$props12$tabInde,
        ...
        value: function getDerivedStateFromProps(props, prevState) {
          ...
          if (treeData) {
            ...
            newState.keyEntities = _objectSpread(
              _defineProperty({}, MOTION_KEY, MotionEntity),
