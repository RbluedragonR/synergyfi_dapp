...
class SimulateModule {
  ...
  _simulateOrder(instrument, amm, targetPrice, baseSize, leverage) {
    ...
    const minMargin = (0, math_1.getMinOrderMargin)(
      targetPrice,
      markPrice,
      baseSize,
      instrument.setting.initialMarginRatio
  ...
  async simulateImpermanentLoss(params, overrides) {
    ...
    for (let i = tickLower; i < tickUpper; i += constants_1.ORDER_SPACING) {
      ...
      const removedBalance = (0, utils_1.rangeToPosition)(
        simulationRange,
        amm
      ).balance;
      result.push({
        ...
        impermanentLoss:
          Number((0, utils_2.formatEther)(removedBalance)) /
            Number((0, utils_2.formatEther)(margin)) -
          1,
      });
    }
    return result;
